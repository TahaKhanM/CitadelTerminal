...
**Why this matters**: the user's memory file `memory/v13_mirror_ceiling.md` and the M2 post-mortem in `oracle_pure_M1Lite_upload/CONTEXT_HANDOFF.md §16` both describe how seemingly-isolated changes silently broke other algos. The other session may have made similar discoveries you do not yet see. Worktree isolation guarantees your work and theirs do not collide until the user merges them deliberately.
...
1. Read CLAUDE.md, AGENTS.md, [docs/UNITS_REFERENCE.md](docs/UNITS_REFERENCE.md), [docs/STRATEGY_GUIDE.md](docs/STRATEGY_GUIDE.md), [docs/TARGETING_AND_PATHING.md](docs/TARGETING_AND_PATHING.md), [docs/GAME_RULES.md](docs/GAME_RULES.md) end-to-end. These are the rules of the game.
...
6. Read memory/winning_architecture.md and memory/finalist_corpus.md — synthesized findings from 8+ public top-tier algos.
