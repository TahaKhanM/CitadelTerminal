...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config):
        ...
        # Eagerly load sim_rs at game start so the first turn's beam
        # search isn't paying the import cost. Silent on failure —
        # evaluate_action_phase falls through to vendored pysim if
        # sim_rs is unavailable.
        try:
            try:
