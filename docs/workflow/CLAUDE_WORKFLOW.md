...
This doc describes the end-to-end loop for using Claude Code to build, iterate on, and ship winning algos. It's the "how we actually work" companion to the reference material in `docs/` and the skills in `.agents/skills/`.
