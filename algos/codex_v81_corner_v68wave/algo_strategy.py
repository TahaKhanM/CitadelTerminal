"""codex_v81_corner_v68wave: v79 defence with v68 kill-wave cadence.

Variant that keeps v79's anti-corner defence but restores v68's center
Demolisher/Scout kill-wave cadence, which was the local anti-lattice weapon.
"""
import gamelib
