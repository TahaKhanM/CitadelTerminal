"""codex_v65_edge_caravan_wave16_patchdeep: deep patch with 16-MP waves.

Variant of codex_v63 with a 16-MP saved-wave threshold.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 16 * scout_cost:
        ...
        elif t >= 25 and mp >= 20 * scout_cost:
