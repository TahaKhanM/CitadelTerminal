"""codex_v55_edge_caravan_patchdeep_early: patchplus with earlier deep turrets.

Variant of codex_v50 that builds the [8,5]/[19,5] deep leak pair earlier than
v54 to see whether the extra SP timing is affordable.
"""
import gamelib
