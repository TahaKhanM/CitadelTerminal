...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config):
        ...
        # chimera_v2 = apex_v2 deltas + caravan_v2 supports + side rotation.
        DEMOLISHER_TRIGGER_STRENGTH = 25
        ATTACK_MP_THRESHOLD = 13
        DEMOLISHER_MIN_MP = 15
    ...
    def evaluate_next_turn_strategy(self, game_state):
        ...
        if self.my_MP < ATTACK_MP_THRESHOLD:
            ...
            return
        # chimera_v2: side rotation to confuse opponent reactive defense.
        # If we've attacked the same side 3 times in a row, force-switch.
        ...
        # chimera_v2: relaxed HP gate (apex_v2 delta).
        losing_hp_race = self.my_HP <= self.enemy_HP
