"""codex_v38_edge_caravan: replay-derived edge caravan pressure.

Promoted from the `v21_loss_1` live-loss opponent pattern after it became the
first local strategy to reliably punish the v21/v25/v34 edge weakness:
