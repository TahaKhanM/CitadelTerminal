"""codex_v51_edge_caravan_patchwalls: big-wave caravan with protected edge patch.

Variant of codex_v48 that adds small wall caps near the low-edge turret pair
after the turrets are online.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 26:
            gs.attempt_spawn(WALL, [[8, 7], [19, 7], [6, 6], [21, 6]])
            if t >= 30:
                gs.attempt_upgrade([[8, 7], [19, 7]])
