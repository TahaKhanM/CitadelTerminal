"""codex_v64_edge_caravan_wave12_nodemo: deep patch with Scout-only waves.

Variant of codex_v59 that removes scheduled Demolishers and spends all MP on
saved Scout waves.
"""
import gamelib
