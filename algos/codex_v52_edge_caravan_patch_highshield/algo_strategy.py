"""codex_v52_edge_caravan_patch_highshield: edge-patched caravan with higher supports.

Variant of codex_v48 that revisits the higher-y Support anchors now that the
low-edge turrets handle the lanes that punished v39.
"""
import gamelib
