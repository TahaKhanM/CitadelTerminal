"""v21_quadrant_adaptive_support: v21 + quadrant-burden-adaptive Support placement
(INVENTION #3). Parent: v21_temporal_phase_gate. Tag: "quadrant-adaptive-support".
Hypothesis: static Support placement (every finalist uses fixed coords) is suboptimal
vs asymmetric opponents; adaptive placement to highest-burden quadrant adds shield
where it matters most. No public finalist adapts Support position per opponent layout.
"""
import gamelib
import json
