"""codex_v69_edge_caravan_wave28_patchdeep: deep patch with 28-MP waves.

Variant of codex_v68 that extends the Demolisher-first window before the kill
Scout wave.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 28 * scout_cost:
        ...
        elif t >= 25 and mp >= 32 * scout_cost:
