"""codex_v41_edge_caravan_bigwave: edge caravan with larger saved waves.

Variant of codex_v38 that saves to 10-MP Scout waves instead of 8-MP waves,
testing whether v38's advantage comes from the exact burst size rather than
the structure shell.
"""
import gamelib
