"""v13 second-ring + reactive-defense fix.

Addresses §5.2 and §5.6 of REPLAY_ANALYSIS_2026-04-23_v12.md:
  §5.2 Second-ring Turrets at [11,5]/[16,5] upgraded by T10 — covers
       dominant breach tiles (18,4)=39, (9,4)=22, (19,5)=10, (11,2)=8
       which lay OUTSIDE the range-3.5 coverage of v12's [7,9]/[20,9].
  §5.6 Reactive defense: try backing tiles (x,y+1), (x±1,y+1), (x±1,y)
       in preference order instead of clamping to the breach tile itself.

§5.3 (early outer corners) was explored but caused re-routing of enemy
Scouts to (7,6) on BOTTOM_LEFT edge (uncovered until [7,9] upgrades at
T2). Reverted. Outer corners remain deferred to _build_defense T10.

Preserved from v12: T0 opening, deep sidelane [7,9]/[20,9], _best_spawn
path-damage scorer, _pressure_response interceptor-plug.
"""
import gamelib
import json
