"""codex_v62_edge_caravan_wave14_patchdeep: deep patch with 14-MP waves.

Variant of codex_v59 with a more delayed 14-MP saved-wave threshold.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 14 * scout_cost:
