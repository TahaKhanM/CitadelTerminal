"""codex_v59_edge_caravan_wave12_patchdeep: deep patch with 12-MP waves.

Variant of codex_v54 that tests whether deeper defence can support an even
slower 12-MP saved-wave race.
"""
import gamelib
