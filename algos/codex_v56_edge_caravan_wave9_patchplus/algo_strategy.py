"""codex_v56_edge_caravan_wave9_patchplus: patchplus with 9-MP waves.

Variant of codex_v50 that retests the 9-MP cadence after the second edge patch.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 9 * scout_cost:
        ...
        elif t >= 25 and mp >= 13 * scout_cost:
