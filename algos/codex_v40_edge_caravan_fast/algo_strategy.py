"""codex_v40_edge_caravan_fast: faster edge caravan pressure.

Variant of codex_v38 that lowers the Scout launch threshold and starts pressure
two turns earlier. This probes whether v38 is winning because of cadence or
because of the specific saved 8-MP wave size.
"""
import gamelib
