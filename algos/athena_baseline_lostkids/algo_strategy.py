# Adapted from research/finalist_repos/Terminal-Lostkids/python-2l-aet/algo_strategy.py for local-baseline use.
# Original: Terminal-Lostkids public finalist algo. This port retains the strategy
# logic; gamelib is replaced with the starter-kit gamelib vendored under ./gamelib/.
# Citadel-rule deltas are addressed in CITADEL_DELTA_AUDIT.md and corresponding
# constant patches inline.
import gamelib
import random
import math
import warnings
