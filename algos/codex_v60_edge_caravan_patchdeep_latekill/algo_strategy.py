"""codex_v60_edge_caravan_patchdeep_latekill: deep patch with larger late kill.

Variant of codex_v54 that keeps 10-MP regular launches but waits for a larger
fallback wave after turn 25.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        elif t >= 25 and mp >= 18 * scout_cost:
