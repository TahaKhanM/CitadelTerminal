...
fn empty_arena_returns_empty_list() {
    ...
    assert_eq!(arena.mobiles_in_range((13, 10), 16.0), Vec::<String>::new());
...
fn mobiles_in_range_insertion_order() {
    ...
    arena.insert_mobile("M1".to_string(), (13, 10));
    arena.insert_mobile("M2".to_string(), (15, 12));
    arena.insert_mobile("M3".to_string(), (20, 20));
    arena.insert_mobile("M4".to_string(), (10, 10));
    arena.insert_mobile("M5".to_string(), (17, 10));
...
fn mobile_remove_preserves_surviving_order() {
    ...
    let mut arena = ProximityArena::new();
    arena.insert_mobile("M1".to_string(), (13, 10));
    arena.insert_mobile("M2".to_string(), (14, 10));
    arena.insert_mobile("M3".to_string(), (15, 10));
...
fn structures_insert_and_remove() {
    let mut arena = ProximityArena::new();
    arena.insert_structure((5, 5), "S1".to_string());
    arena.insert_structure((6, 6), "S2".to_string());
...
fn structures_in_range_insertion_order() {
    ...
    let mut arena = ProximityArena::new();
    arena.insert_structure((13, 10), "S1".to_string());
    arena.insert_structure((20, 20), "S2".to_string());
    arena.insert_structure((12, 11), "S3".to_string());
    arena.insert_structure((13, 13), "S4".to_string());
...
fn structure_remove_absent_is_noop() {
    let mut arena = ProximityArena::new();
    arena.insert_structure((1, 1), "A".to_string());
...
fn mobile_reinsert_updates_position() {
    ...
    let mut arena = ProximityArena::new();
    arena.insert_mobile("M1".to_string(), (0, 0));
    arena.insert_mobile("M1".to_string(), (13, 10));
    ...
    assert_eq!(arena.mobiles_in_range((0, 0), 1.0), Vec::<String>::new());
}
