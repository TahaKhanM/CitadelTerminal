"""codex_v29_support_scout: v25, but stop demo-spamming into Support engines.

Parent: v21_quadrant_adaptive_support / v21_temporal_phase_gate.
Tag: "quadrant-adaptive-support".
Hypothesis: the edge-caravan loss is partly self-inflicted: enemy_front>=10
keeps forcing Demolishers, so our shielded Scout burst never fires. Once the
opponent has a Support engine online, spend MP on Scouts instead.
"""
import gamelib
import json
