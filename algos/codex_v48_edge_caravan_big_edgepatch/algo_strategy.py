"""codex_v48_edge_caravan_big_edgepatch: big-wave caravan with lower edge patch.

Variant of codex_v41 that adds low edge turrets only after the main shell and
initial support plan are online.
"""
import gamelib
