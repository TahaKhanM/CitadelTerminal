"""Replay-derived high-shield lattice + Demolisher pressure from v21_loss_03.

This approximates the ranked opponent as a bottom-player algo. The key traits
from the official replay were a diagonal turret/wall lattice, a mid-board
Support farm, early trickle Scouts, and sustained Demolisher pressure that
eventually opened the far corner.
"""
import gamelib
