"""codex_v79_pyv8_cornerlock: pyv8-style pressure with early corner lock.

Variant of v78 after it lost to the v21_loss_03-style lattice at (26,12).
The corner turrets move from a too-late turn-44 reaction to an early permanent
lock while preserving the ranked Demolisher/Interceptor pressure pattern.
"""
import gamelib
