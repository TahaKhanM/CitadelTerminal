"""v21_temporal_phase_gate: v13 + temporal opponent-MP tracking (INVENTION #2).
Parent: v13_second_ring. Tag: "temporal-phase-gate".
Hypothesis: opponent MP dips => they attacked => we defer our attack, reinforce defense,
then counter-attack when they're low-resource. No public finalist tracks this.
"""
import gamelib
import json
