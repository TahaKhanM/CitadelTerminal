# v5_edgearmor — fork of v4_smartdemo that targets the side-edge & deep-edge
# breach hot-tiles seen in 4 v4_smartdemo ranked losses.
#
# Failure analysis (4 ranked losses, replays/Ranked Replays/v4_smartdemo/):
#   - Hot breach tiles (count): (6,7) x52, (2,11) x42, (15,1) x18, (16,2) x9,
#     (8,5) x8, (19,5) x8, (7,6) x10, (24,10) x7, (25,11) x9, (26,12) x13.
#   - All of these tiles fall outside canonical Lostkids turret coverage
#     (Y=8-13 turrets at corners + middle leave Y=2-12 side rows uncovered).
#   - v4_smartdemo scored 0 breaches in 3/4 losses — its scout offense was
#     fine in principle but it died on HP race because edges were leaky.
#
# Spec changes vs v4_smartdemo (purely additive — offense untouched):
#   1. NEW Phase 2 (between original Phase 1 and Phase 2): side-edge turrets
#      at (5,9) and (22,9), spawn + upgrade. Covers the (4,9)/(5,8)/(6,7)/(3,10)
#      and (22,8)/(23,9)/(24,10)/(25,11) breach hotspots that the canonical
#      Lostkids build leaves uncovered. Both tiles verified open
#      (between Phase-3 walls (4,11)/(6,9) and (21,9)/(23,11)).
#   2. NEW Phase 9 (after original Phase 7): deep-edge turrets at (11,4)
#      and (16,4), spawn + upgrade. Covers (10,3)/(11,2)/(12,1)/(8,5) and
#      (15,1)/(16,2)/(17,3)/(19,5) — the deep BL/BR breach tiles.
#   3. Offensive engine intact: every-3rd-attack demo cadence kept; support
#      placements (Y=5/6) unchanged. Defense is added; nothing is removed.
#
# v4_smartdemo docstring (preserved for inheritance context) follows.
#
