# v6_hybrid — combines v5_antiinterceptor (early-game interceptor defense at
# (13,0) T0-T4 + central turret at (13,11) in Phase 2) with v5_deepedge's
# Phase 8 deep-edge breach coverage (turrets at (11,4) and (16,4) +
# upgrades). Goal: keep the antiinterceptor anti-rush dominance vs lostkids
# variants while patching the deep-edge breach leakage v5_deepedge addressed.
#
