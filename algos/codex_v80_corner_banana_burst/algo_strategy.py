"""codex_v80_corner_banana_burst: corner lock with banana side bursts.

Variant of v79 that switches from pyv8 Demolisher pressure into the banana
1926 side burst: 3 Demolishers at [2,11] plus a large Scout wave at [3,10].
This specifically targets high-shield lattices that survive pure Demolishers.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def _attack(self, gs):
        ...
        if t >= 25 and (t % 3 == 0 or mp >= 18) and mp >= 3 * demo_cost:
