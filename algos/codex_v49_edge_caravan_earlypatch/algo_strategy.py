"""codex_v49_edge_caravan_earlypatch: big-wave caravan with earlier edge patch.

Variant of codex_v48 that starts the [7,6]/[20,6] turret patch six turns
earlier to catch the first edge leak window.
"""
import gamelib
