"""codex_v50_edge_caravan_patchplus: big-wave caravan with second edge patch.

Variant of codex_v48 that adds a second low-edge turret pair after the primary
[7,6]/[20,6] patch, covering reroutes through [6,7]/[21,7].
"""
import gamelib
