"""codex_v70_edge_caravan_wave32_patchdeep: deep patch with 32-MP waves.

Variant of codex_v68 with a very long Demolisher-first window.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 32 * scout_cost:
        ...
        elif t >= 25 and mp >= 36 * scout_cost:
