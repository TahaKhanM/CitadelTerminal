"""codex_v26_edge_keep: v25 burst cadence plus explicit edge keeps.
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def _edge_keep(self, gs):
        ...
        edge_core = [[7, 6], [20, 6], [6, 7], [21, 7]]
        edge_outer = [[4, 9], [23, 9]]
        edge_walls = [[5, 8], [22, 8], [8, 7], [19, 7]]

        gs.attempt_spawn(TURRET, edge_core)
        if t >= 11:
            gs.attempt_upgrade(edge_core)
