"""codex_v66_edge_caravan_wave18_patchdeep: deep patch with 18-MP waves.

Variant of codex_v63 with a more delayed 18-MP saved-wave threshold.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 18 * scout_cost:
        ...
        elif t >= 25 and mp >= 22 * scout_cost:
