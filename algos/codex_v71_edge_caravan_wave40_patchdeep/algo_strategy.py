"""codex_v71_edge_caravan_wave40_patchdeep: deep patch with 40-MP waves.

Variant of codex_v68 that stress-tests excessive hoarding.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 40 * scout_cost:
        ...
        elif t >= 25 and mp >= 44 * scout_cost:
