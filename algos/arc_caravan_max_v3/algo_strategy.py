...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config):
        ...
        # arc_caravan_max_v3: ladder-loss-driven fixes.
        # Lowered ATTACK_MP_THRESHOLD: don't sit on MP while opponent rushes
        # us with shielded scouts (loss replays show idle MP T11-15 cost us).
        DEMOLISHER_TRIGGER_STRENGTH = 10
        ATTACK_MP_THRESHOLD = 9
        DEMOLISHER_MIN_MP = 9
