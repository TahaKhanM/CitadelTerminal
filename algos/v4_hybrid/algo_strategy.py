# v4_hybrid — combines two v4 variants found by parallel testing:
#   - v4_caravan (Y=13 back-row supports → 70% vs baseline LK)
#   - v4_demoaggro (every-3rd-demo → 90% vs baseline LK)
# Both v4 variants lose 0-10 to v13_second_ring (interceptor+demolisher class).
# v4_hybrid takes the offensive enhancement that does NOT sacrifice v13 wins:
#
#   1. Caravan supports: Phase 5 places 4 upgraded SUPPORTs along the BACK
#      ROW Y=13 at (12,13), (13,13), (14,13), (15,13). These are SP-expensive
#      anchors but at Y=13 a Scout walking the full vertical bar of the diamond
#      passes inside their range 7 zone for the entire transit, gaining heavy
#      shields. No overlap with corner turrets at (2,13), (3,13), (4,13),
#      (23,13), (24,13), (25,13) — the center is empty.
#   2. Phase 7 SUPPORTs moved from (10,5)/(17,5) to (13,12)/(14,12) — second
#      back-row tier reinforcing the shield bubble.
#   3. Demolisher cadence stays as v3's BACKSTOP (scout-success-tracking +
#      MP>=18 + edge_strength>=35), NOT a periodic schedule. Better-shielded
#      scouts should fail less often -> demos fire only as true emergency.
#      Avoids the interceptor-vs-demo class mismatch that sinks every-3rd-demo
#      scheduling against v13_second_ring.
#   4. KEEPS lostkids_v3's Phase 6 turret upgrades (9,9)/(18,9)/(6,10)/(21,10)
#      + (12,8)/(15,8) spawn+upgrades, Phase 2 side-gap turrets (5,9)/(22,9),
#      anti-demo hardening, reactive scaffolding — all v13-relevant defense
#      remains intact.
#
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def evaluate_next_turn_strategy(self, game_state):
        ...
        if scouts_failing and losing_hp_race and self.my_MP >= DEMOLISHER_MIN_MP:
