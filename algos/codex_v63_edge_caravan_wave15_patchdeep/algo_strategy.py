"""codex_v63_edge_caravan_wave15_patchdeep: deep patch with 15-MP waves.

Variant of codex_v59 that pushes saved-wave size to the edge of late-race risk.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 15 * scout_cost:
        ...
        elif t >= 25 and mp >= 19 * scout_cost:
