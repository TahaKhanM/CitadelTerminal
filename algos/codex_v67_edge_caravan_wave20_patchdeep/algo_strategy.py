"""codex_v67_edge_caravan_wave20_patchdeep: deep patch with 20-MP waves.

Variant of codex_v63 that tests a very delayed 20-MP saved-wave threshold.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 20 * scout_cost:
        ...
        elif t >= 25 and mp >= 24 * scout_cost:
