...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config):
        ...
        # apex_v2 deltas vs lostkids_v3:
        #   - ATTACK_MP_THRESHOLD 17 → 13: 4 fewer turns to wait between waves.
        #     At MP_income=3 (turns 9-13) that's 1 extra attack per 3 turns.
        #   - DEMOLISHER_MIN_MP 18 → 15: align with new attack threshold.
        #   - DEMOLISHER_TRIGGER_STRENGTH 35 → 25: switch to demos sooner if
        #     opponent has any meaningful corner defense.
        #   - SCOUT_FAIL_LOOKBACK 3 → 1: pivot to demos after a SINGLE
        #     failed scout wave (HP gate still applies — only when behind).
    ...
    def evaluate_next_turn_strategy(self, game_state):
        ...
        # apex_v2: relaxed HP gate. Tied/behind triggers demo (was: behind by 5+).
