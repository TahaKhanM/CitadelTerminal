# v4_caravan — variant #2 of 4 v4 attempts targeting the lostkids_v3 ladder
# weakness via the support-stacked Scout caravan archetype (docs/STRATEGY_GUIDE.md
# § 3.4).
#
# Hypothesis: lostkids_v3 has supports at Y=5/6 (~4-5 shield/scout) but loses
# ladder games where scouts can't break opp's defense. Stacking 4 upgraded
# supports at back-row Y=13 yields 1 + 0.7*13 = 10.1 shield/scout each, ~40
# shield total — turning 15-HP scouts into ~55-HP tanks. Phase 7 then adds 2
# more Y=12 supports for the second wave.
#
# Build-order deltas vs lostkids_v3 (Phases 1-4 + Phase 6 unchanged):
#   - Phase 5: SUPPORT (4) at (12,13), (13,13), (14,13), (15,13) — back-row,
#     all upgraded. Tiles confirmed open: Phase 1 occupies (2,13), (25,13);
#     Phase 4 occupies (3,13), (4,13), (23,13), (24,13); x=12-15 at y=13 free.
#   - Phase 7: SUPPORT (2) at (13,12), (14,12) upgraded — replaces the old Y=5
#     pair. Sits behind the existing (12,9)..(15,9) wall row — no path collision.
#
# Original lostkids_v3 context (carried over): targets failure modes observed
# in 6 LostKidsv2 ranked games (replays/LostKidsv2_vs_*.replay):
#
