"""codex_v47_edge_caravan_big_counter: big-wave caravan with early intercept.

Variant of codex_v41 that spends one early Interceptor around the first enemy
8-MP wave, aiming to reduce the T10 leak while preserving the big-wave race.
"""
import gamelib
