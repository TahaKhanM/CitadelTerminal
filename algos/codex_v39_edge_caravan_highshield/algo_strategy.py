"""codex_v39_edge_caravan_highshield: edge caravan with higher shield anchors.

Variant of codex_v38 that keeps the same pressure cadence but moves Supports
up to y=9-10, where upgraded Supports provide materially more shielding while
remaining behind the main turret/wall shell.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        supports = [[11, 10], [16, 10], [12, 9], [15, 9]]
        if t >= 12:
