# v5b_protected_caravan — fork of v4_smartdemo with caravan supports placed
# in PROTECTED Y=11/Y=12 positions (behind Phase 1/Phase 3 wall bands).
#
# v5_smartcaravan (parent experiment) used Y=13 supports for max shield
# (10.1 per scout) but lost 0-10 vs v13_second_ring because Y=13 supports
# are in the front row, base 1-HP, and got killed before they generated
# value. v5b moves the same 6 supports back to Y=11/Y=12 where the front
# wall band shields them. Per-support shield drops to 8.7-9.4 (Y=11/12)
# but the supports actually survive long enough to matter.
#
# Phase 5 (4 upgraded supports): (13,12), (14,12), (12,11), (15,11).
# Phase 7 (+2 upgraded supports): (11,11), (16,11).
# Phase 1/3 wall bands cover x<12 / x>15 at Y=11/12, so the middle
# x=11..16 strip at Y=11/12 is the open caravan slot.
#
# Original v4_smartdemo header follows.
