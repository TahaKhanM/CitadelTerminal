"""codex_v61_edge_caravan_wave13_patchdeep: deep patch with 13-MP waves.

Variant of codex_v59 with a slightly larger saved-wave threshold.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 13 * scout_cost:
        ...
        elif t >= 25 and mp >= 17 * scout_cost:
