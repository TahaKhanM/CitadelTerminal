"""codex_v58_edge_caravan_wave11_patchdeep: deep patch with 11-MP waves.

Variant of codex_v54 that retests the 11-MP cadence with the deep leak pair.
"""
import gamelib
...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_turn(self, turn_state):
        ...
        if t >= 10 and t % 2 == 0 and mp >= 11 * scout_cost:
        ...
        elif t >= 25 and mp >= 15 * scout_cost:
