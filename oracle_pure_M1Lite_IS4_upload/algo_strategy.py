    ...
    def on_turn(self, turn_state):
        ...
        try:
            ...
            result = search(
                ...
                do_depth2=True,
                depth2_top_n=3,
                # IS4: keep max_plans = 2500 (matching VF). Bumping it
                # caused snorkeldink regression (VF wins 2/2 → IS4 lost 0/2)
                # via tie-breaking shifts when more candidates compete for
                # top-30 phase-2 slots. The cap acts as a stable filter.
                max_plans=2500,
