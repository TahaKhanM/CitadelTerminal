...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def build_defences(self, game_state):
        ...
        # Wang Defense Formation 2
        destructor_locations = [[3, 11], [24, 11], [6, 10], [21, 10], [9, 9], [18, 9], [12, 8], [15, 8]]
        filter_locations = [[3, 12], [24, 12], [6, 11], [21, 11], [9, 10], [18, 10], [12, 9], [15, 9]]
        game_state.attempt_spawn(DESTRUCTOR, destructor_locations)
        game_state.attempt_spawn(FILTER, filter_locations)

        destructor_locations = [[2, 12], [25, 12], [7, 10], [20, 10]]
        filter_locations = [[0, 13], [1, 13], [26, 13], [27, 13]]
        game_state.attempt_spawn(DESTRUCTOR, destructor_locations)
        game_state.attempt_spawn(FILTER, filter_locations)

        destructor_locations = [[1, 12], [26, 12], [4, 11], [23, 11], [10, 9], [17, 9], [13, 8], [14, 8]]
        game_state.attempt_spawn(DESTRUCTOR, destructor_locations)
        
        filter_locations = [[2, 13], [25, 13]]
        destructor_locations = [[2, 11], [25, 11]]
        encryptor_locations = [[5, 11], [22, 11], [8, 10], [19, 10]]
        game_state.attempt_spawn(FILTER, filter_locations)
        game_state.attempt_spawn(DESTRUCTOR, destructor_locations)
        game_state.attempt_spawn(ENCRYPTOR, encryptor_locations)

        encryptors_locations = [[9, 8], [10, 8], [17, 8], [18, 8], [10, 7], [12, 7], [15, 7], [17, 7], [12, 6], [15, 6], [12, 5], [15, 5]]
        destructor_locations = [[5, 10], [22, 10]]
        game_state.attempt_spawn(DESTRUCTOR, destructor_locations)
        game_state.attempt_spawn(ENCRYPTOR, encryptors_locations)

        filter_locations = [[4, 12], [23, 12], [7, 11], [20, 11], [10, 10], [17, 10], [13, 9], [14, 9]]
        destructor_locations = [[13, 7], [14, 7]]
        game_state.attempt_spawn(DESTRUCTOR, destructor_locations)
        game_state.attempt_spawn(FILTER, filter_locations)
