...
Sink {
    ...
    public Stream<String> lines(ProcessLogger var1);
    ...
    public Stream<String> lines_$bang(ProcessLogger var1);
    ...
    public static interface Sink {
        ...
        public ProcessBuilder $hash$less(File var1);

        public ProcessBuilder $hash$less(URL var1);

        public ProcessBuilder $hash$less(Function0<InputStream> var1);

        public ProcessBuilder $hash$less(ProcessBuilder var1);
    }

    public static interface Source {
        public ProcessBuilder toSource();

        public ProcessBuilder $hash$greater(File var1);

        public ProcessBuilder $hash$greater$greater(File var1);

        public ProcessBuilder $hash$greater(Function0<OutputStream> var1);

        public ProcessBuilder $hash$greater(ProcessBuilder var1);
