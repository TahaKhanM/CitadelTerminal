...
public interface ProcessImplicits {
    public <T> Seq<ProcessBuilder.Source> buildersToProcess(Seq<T> var1, Function1<T, ProcessBuilder.Source> var2);

    public ProcessBuilder builderToProcess(java.lang.ProcessBuilder var1);

    public ProcessBuilder.FileBuilder fileToProcess(File var1);

    public ProcessBuilder.URLBuilder urlToProcess(URL var1);

    public ProcessBuilder stringToProcess(String var1);

    public ProcessBuilder stringSeqToProcess(Seq<String> var1);
}
