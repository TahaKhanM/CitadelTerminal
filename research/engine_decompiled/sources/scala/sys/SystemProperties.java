...
extends AbstractMap<String, String> {
    ...
    public static String help(String string2) {
        return SystemProperties$.MODULE$.help(string2);
    }
    ...
    public /* synthetic */ boolean scala$sys$SystemProperties$$super$contains(String key) {
    ...
    public Iterator<Tuple2<String, String>> iterator() {
        Option<Iterator<Tuple2<String, String>>> option = this.wrapAccess((Function0)((Object)new Serializable(this){
        ...
        return option.isEmpty() ? Iterator$.MODULE$.empty() : option.get();
    }

    @Override
    public Option<String> get(String key) {
        Option<Option<String>> option = this.wrapAccess((Function0)((Object)new Serializable(this, key){
            public static final long serialVersionUID = 0L;
        ...
        return option.isEmpty() ? None$.MODULE$ : option.get();
    }

    @Override
    public boolean contains(String key) {
        Option<Object> option = this.wrapAccess((Function0)((Object)new Serializable(this, key){
            public static final long serialVersionUID = 0L;
        ...
        return !option.isEmpty() && BoxesRunTime.unboxToBoolean(option.get());
    }

    public SystemProperties $minus$eq(String key) {
        this.wrapAccess((Function0)((Object)new Serializable(this, key){
            public static final long serialVersionUID = 0L;
    ...
    public SystemProperties $plus$eq(Tuple2<String, String> kv) {
        this.wrapAccess((Function0)((Object)new Serializable(this, kv){
            public static final long serialVersionUID = 0L;
    ...
    public <T> Option<T> wrapAccess(Function0<T> body2) {
        Option option;
        try {
            option = new Some<T>(body2.apply());
        }
