...
Serializable {
    ...
    public final <B> B getOrElse(Function0<B> function0) {
        return (B)(this.isEmpty() ? function0.apply() : this.get());
    }

    public final <A1> A1 orNull(Predef$.less.colon.less<Null$, A1> ev) {
        return (A1)this.getOrElse((Function0)((Object)new Serializable(this, ev){
    ...
    public final <B> Option<B> map(Function1<A, B> f) {
        return this.isEmpty() ? None$.MODULE$ : new Some<B>(f.apply(this.get()));
    }
    ...
    public final <B> Option<B> flatMap(Function1<A, Option<B>> f) {
        return this.isEmpty() ? None$.MODULE$ : f.apply(this.get());
    }

    public <B> Option<B> flatten(Predef$.less.colon.less<A, Option<B>> ev) {
        return this.isEmpty() ? None$.MODULE$ : (Option)ev.apply(this.get());
    }

    public final Option<A> filter(Function1<A, Object> p) {
        return this.isEmpty() || BoxesRunTime.unboxToBoolean(p.apply(this.get())) ? this : None$.MODULE$;
    }

    public final Option<A> filterNot(Function1<A, Object> p) {
        return !this.isEmpty() && BoxesRunTime.unboxToBoolean(p.apply(this.get())) ? None$.MODULE$ : this;
    }
    ...
    public final <A1> boolean contains(A1 elem) {
        A a;
        return !this.isEmpty() && ((a = this.get()) == elem ? true : (a == null ? false : (a instanceof Number ? BoxesRunTime.equalsNumObject((Number)a, elem) : (a instanceof Character ? BoxesRunTime.equalsCharObject((Character)a, elem) : a.equals(elem)))));
    }
    ...
    public final <B> Option<B> collect(PartialFunction<A, B> pf) {
        return this.isEmpty() ? None$.MODULE$ : pf.lift().apply(this.get());
    }

    public final <B> Option<B> orElse(Function0<Option<B>> alternative) {
        return this.isEmpty() ? alternative.apply() : this;
    }

    public Iterator<A> iterator() {
        return this.isEmpty() ? Iterator$.MODULE$.empty() : Iterator$.MODULE$.single(this.get());
    }

    public List<A> toList() {
        return this.isEmpty() ? Nil$.MODULE$ : new $colon$colon<Nothing$>((Nothing$)this.get(), Nil$.MODULE$);
    }

    public final <X> Product toRight(Function0<X> left) {
        return this.isEmpty() ? package$.MODULE$.Left().apply(left.apply()) : package$.MODULE$.Right().apply(this.get());
    }

    public final <X> Product toLeft(Function0<X> right) {
        return this.isEmpty() ? package$.MODULE$.Right().apply(right.apply()) : package$.MODULE$.Left().apply(this.get());
    }
    ...
    public class WithFilter {
        ...
        public <B> Option<B> map(Function1<A, B> f) {
            Function1 function1 = this.scala$Option$WithFilter$$p;
            Option option = this.scala$Option$WithFilter$$$outer();
            Option option2 = option.isEmpty() || BoxesRunTime.unboxToBoolean(function1.apply(option.get())) ? option : None$.MODULE$;
            return option2.isEmpty() ? None$.MODULE$ : new Some<B>(f.apply(option2.get()));
        }
        ...
        public <B> Option<B> flatMap(Function1<A, Option<B>> f) {
            ...
            Option option = this.scala$Option$WithFilter$$$outer();
            Option option2 = option.isEmpty() || BoxesRunTime.unboxToBoolean(function1.apply(option.get())) ? option : None$.MODULE$;
            return option2.isEmpty() ? None$.MODULE$ : f.apply(option2.get());
        }
        ...
        public WithFilter withFilter(Function1<A, Object> q) {
            return new WithFilter(this.scala$Option$WithFilter$$$outer(), new Serializable(this, q){
                public static final long serialVersionUID = 0L;
                private final /* synthetic */ WithFilter $outer;
                private final Function1 q$1;

                public final boolean apply(A x) {
                    return BoxesRunTime.unboxToBoolean(this.$outer.scala$Option$WithFilter$$p.apply(x)) && BoxesRunTime.unboxToBoolean(this.q$1.apply(x));
                }
                {
                    if ($outer == null) {
                        throw null;
        ...
        public WithFilter(Option<A> $outer, Function1<A, Object> p) {
            this.scala$Option$WithFilter$$p = p;
            if ($outer == null) {
                throw null;
            }
            this.$outer = $outer;
