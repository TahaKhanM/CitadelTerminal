...
Serializable {
    ...
    public Object productElement(int n) throws IndexOutOfBoundsException {
        return Product5$class.productElement(this, n);
    }
    ...
    public String toString() {
        return new StringBuilder().append((Object)"(").append(this._1()).append((Object)",").append(this._2()).append((Object)",").append(this._3()).append((Object)",").append(this._4()).append((Object)",").append(this._5()).append((Object)")").toString();
    }
    ...
    public boolean equals(Object x$1) {
        ...
        if (!(x$1 instanceof Tuple5)) return false;
        boolean bl6 = true;
        if (!bl6) return false;
        ...
        if (T12 == T1) {
            ...
            bl5 = T12 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T12, T1) : (T12 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T12, T1) : T12.equals(T1));
        }
        if (!bl5) return false;
        T2 T2 = tuple5._2();
        T2 T22 = this._2();
        if (T22 == T2) {
            ...
            bl4 = T22 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T22, T2) : (T22 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T22, T2) : T22.equals(T2));
        }
        if (!bl4) return false;
        T3 T3 = tuple5._3();
        T3 T32 = this._3();
        if (T32 == T3) {
            ...
            bl3 = T32 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T32, T3) : (T32 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T32, T3) : T32.equals(T3));
        }
        if (!bl3) return false;
        T4 T4 = tuple5._4();
        T4 T42 = this._4();
        if (T42 == T4) {
            ...
            bl2 = T42 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T42, T4) : (T42 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T42, T4) : T42.equals(T4));
        }
        if (!bl2) return false;
        T5 T5 = tuple5._5();
        T5 T52 = this._5();
        if (T52 == T5) {
            ...
            bl = T52 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T52, T5) : (T52 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T52, T5) : T52.equals(T5));
        }
        if (!bl) return false;
        if (!tuple5.canEqual(this)) return false;
        return true;
    }
