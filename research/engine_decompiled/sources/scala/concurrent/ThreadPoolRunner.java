...
extends FutureTaskRunner {
    @Override
    public <S> Callable<S> functionAsTask(Function0<S> var1);

    public <S> Function0<S> futureAsFunction(Future<S> var1);

    public ExecutorService executor();

    public <S> Future<S> submit(Callable<S> var1);

    public <S> void execute(Callable<S> var1);

    @Override
    public void managedBlock(ManagedBlocker var1);

    public class RunCallable<S>
    implements Runnable,
    Callable<S> {
