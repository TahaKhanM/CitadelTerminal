...
public final class Future {
    ...
    public static class PromiseCompletingRunnable<T>
    implements Runnable {
        private final Function0<T> body;
        private final Promise.DefaultPromise<T> promise;
        ...
        @Override
        public void run() {
            this.promise().complete(this.liftedTree1$1());
        }

        private final Try liftedTree1$1() {
            Try try_;
            try {
                try_ = new Success<T>(this.body.apply());
            }
        ...
        public PromiseCompletingRunnable(Function0<T> body2) {
            this.body = body2;
            this.promise = new Promise.DefaultPromise();
        }
    }
}
