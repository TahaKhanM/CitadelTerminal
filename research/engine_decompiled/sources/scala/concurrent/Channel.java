...
public class Channel<A> {
    private LinkedList<A> written = new LinkedList(this);
    ...
    public synchronized void write(A x) {
        ...
        this.lastWritten().next_$eq(new LinkedList(this));
    ...
    public static class LinkedList<A> {
        ...
        public LinkedList(Channel<A> $outer) {
            if ($outer == null) {
                throw null;
            }
            this.$outer = $outer;
