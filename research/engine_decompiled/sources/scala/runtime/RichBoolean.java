...
implements OrderedProxy<Object> {
    private final boolean self;

    public static boolean equals$extension(boolean bl, Object object) {
        return RichBoolean$.MODULE$.equals$extension(bl, object);
    }

    public static int hashCode$extension(boolean bl) {
        return RichBoolean$.MODULE$.hashCode$extension(bl);
    }

    public static Ordering$Boolean$ ord$extension(boolean bl) {
        return RichBoolean$.MODULE$.ord$extension(bl);
    }
    ...
    public Ordering$Boolean$ ord() {
        return RichBoolean$.MODULE$.ord$extension(this.self());
    }

    @Override
    public int hashCode() {
        return RichBoolean$.MODULE$.hashCode$extension(this.self());
    }
