...
public interface RangedProxy<T>
extends Proxy.Typed<T> {
    public Object until(T var1);

    public IndexedSeq<T> until(T var1, T var2);

    public Object to(T var1);

    public IndexedSeq<T> to(T var1, T var2);
}
