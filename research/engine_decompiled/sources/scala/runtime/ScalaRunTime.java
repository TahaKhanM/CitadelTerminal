...
public final class ScalaRunTime {
    ...
    public static <T> Class<?> box(Class<T> clazz) {
        return ScalaRunTime$.MODULE$.box(clazz);
    }
    ...
    public static int hash(boolean bl) {
        return ScalaRunTime$.MODULE$.hash(bl);
    }
    ...
    public static int hash(byte by2) {
        return ScalaRunTime$.MODULE$.hash(by2);
    }

    public static int hash(short s2) {
        return ScalaRunTime$.MODULE$.hash(s2);
    }

    public static int hash(int n) {
        return ScalaRunTime$.MODULE$.hash(n);
    }
    ...
    public static int hash(long l) {
        return ScalaRunTime$.MODULE$.hash(l);
    }
    ...
    public static boolean _equals(Product product2, Object object) {
        return ScalaRunTime$.MODULE$._equals(product2, object);
    }

    public static boolean inlinedEquals(Object object, Object object2) {
        return ScalaRunTime$.MODULE$.inlinedEquals(object, object2);
    }

    public static <T> Iterator<T> typedProductIterator(Product product2) {
        return ScalaRunTime$.MODULE$.typedProductIterator(product2);
    }

    public static int _hashCode(Product product2) {
        return ScalaRunTime$.MODULE$._hashCode(product2);
    }

    public static String _toString(Product product2) {
        return ScalaRunTime$.MODULE$._toString(product2);
    }

    public static <T> T checkInitialized(T t) {
        return ScalaRunTime$.MODULE$.checkInitialized(t);
    }
    ...
    public static Class<?> arrayElementClass(Object object) {
        return ScalaRunTime$.MODULE$.arrayElementClass(object);
    }
    ...
    public static boolean isAnyVal(Object object) {
        return ScalaRunTime$.MODULE$.isAnyVal(object);
    }

    public static boolean isTuple(Object object) {
        return ScalaRunTime$.MODULE$.isTuple(object);
    }

    public static boolean isValueClass(Class<?> clazz) {
        return ScalaRunTime$.MODULE$.isValueClass(clazz);
    }
