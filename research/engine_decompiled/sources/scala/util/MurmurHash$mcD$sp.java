...
implements Function1$mcVD$sp {
    ...
    public void apply$mcD$sp(double t) {
        this.scala$util$MurmurHash$$h_$eq(MurmurHash$.MODULE$.extendHash(this.scala$util$MurmurHash$$h(), ScalaRunTime$.MODULE$.hash((Object)BoxesRunTime.boxToDouble(t)), this.scala$util$MurmurHash$$c(), this.scala$util$MurmurHash$$k()));
