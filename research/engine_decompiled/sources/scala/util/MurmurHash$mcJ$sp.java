...
implements Function1$mcVJ$sp {
    ...
    public void apply$mcJ$sp(long t) {
        this.scala$util$MurmurHash$$h_$eq(MurmurHash$.MODULE$.extendHash(this.scala$util$MurmurHash$$h(), ScalaRunTime$.MODULE$.hash((Object)BoxesRunTime.boxToLong(t)), this.scala$util$MurmurHash$$c(), this.scala$util$MurmurHash$$k()));
