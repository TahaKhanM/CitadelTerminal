...
implements Serializable {
    ...
    public String nextString(int length) {
        return ((TraversableOnce)List$.MODULE$.fill(length, new Serializable(this){
    ...
    public char nextPrintableChar() {
        return (char)(this.self().nextInt(127 - 33) + 33);
    }
    ...
    public <T, CC extends TraversableOnce<Object>> CC shuffle(CC xs, CanBuildFrom<CC, T, CC> bf) {
        ...
        Range range2 = new Range.Inclusive(n, 2, 1).by(-1);
        if (range2.isEmpty()) return (CC)((TraversableOnce)((Builder)bf.apply(xs).$plus$plus$eq(buf)).result());
        int i1 = range2.start();
        while (true) {
            int k1 = this.nextInt(i1);
            this.scala$util$Random$$swap$1(i1 - 1, k1, (ArrayBuffer)buf);
    ...
    public Stream<Object> alphanumeric() {
        return Stream$.MODULE$.continually(new Serializable(this){
            public static final long serialVersionUID = 0L;
            public final /* synthetic */ Random $outer;

            public final char apply() {
                return this.$outer.scala$util$Random$$nextAlphaNum$1();
            }
    ...
    public final char scala$util$Random$$safeChar$1() {
        int res = this.nextInt(55296 - 1) + 1;
        return (char)res;
    }
    ...
    public final char scala$util$Random$$nextAlphaNum$1() {
        return "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(this.self().nextInt("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".length()));
    }
