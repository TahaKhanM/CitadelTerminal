...
Serializable {
    ...
    public <U> Try<U> recoverWith(PartialFunction<Throwable, Try<U>> f) {
        Try try_;
        try {
            try_ = f.isDefinedAt(this.exception()) ? (Try)f.apply(this.exception()) : this;
        }
    ...
    public <U> Try<U> recover(PartialFunction<Throwable, U> rescueException) {
        Try try_;
        try {
            try_ = rescueException.isDefinedAt(this.exception()) ? Try$.MODULE$.apply(new Serializable(this, rescueException){
                ...
                }
                {
                    ...
                    this.$outer = $outer;
                    this.rescueException$1 = rescueException$1;
                }
            }) : this;
        }
        catch (Throwable throwable) {
    ...
    public boolean equals(Object x$1) {
        ...
        if (!(x$1 instanceof Failure)) return false;
        boolean bl = true;
        if (!bl) return false;
