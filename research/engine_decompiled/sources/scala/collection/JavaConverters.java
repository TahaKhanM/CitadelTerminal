...
public final class JavaConverters {
    public static <A, B> Decorators.AsJava<ConcurrentMap<A, B>> mapAsJavaConcurrentMapConverter(scala.collection.concurrent.Map<A, B> map2) {
        return JavaConverters$.MODULE$.mapAsJavaConcurrentMapConverter(map2);
    }

    public static <A, B> Decorators.AsJava<java.util.Map<A, B>> mapAsJavaMapConverter(Map<A, B> map2) {
        return JavaConverters$.MODULE$.mapAsJavaMapConverter(map2);
    }

    public static <A, B> Decorators.AsJavaDictionary<A, B> asJavaDictionaryConverter(scala.collection.mutable.Map<A, B> map2) {
        return JavaConverters$.MODULE$.asJavaDictionaryConverter(map2);
    }

    public static <A, B> Decorators.AsJava<java.util.Map<A, B>> mutableMapAsJavaMapConverter(scala.collection.mutable.Map<A, B> map2) {
        return JavaConverters$.MODULE$.mutableMapAsJavaMapConverter(map2);
    }
    ...
    public static <A, B> Decorators.AsScala<scala.collection.mutable.Map<A, B>> mapAsScalaMapConverter(java.util.Map<A, B> map2) {
        return JavaConverters$.MODULE$.mapAsScalaMapConverter(map2);
    }
    ...
    public static <A> Decorators.AsScala<Buffer<A>> asScalaBufferConverter(List<A> list2) {
        return JavaConverters$.MODULE$.asScalaBufferConverter(list2);
    }
