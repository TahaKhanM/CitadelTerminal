...
extends AbstractIterator<A> {
    ...
    public A next() {
        ...
        if (this.isEmpty()) {
            ...
            this.these_$eq(new LazyCell(this, new Serializable(this, cur){
    ...
    public Stream<A> toStream() {
        ...
        this.these_$eq(new LazyCell(this, new Serializable(this){
            public static final long serialVersionUID = 0L;
    ...
    public StreamIterator(Stream<A> self) {
        this();
        super.these_$eq(new LazyCell(this, new Serializable(this, self){
            public static final long serialVersionUID = 0L;
    ...
    public class LazyCell {
        ...
        private Stream v$lzycompute() {
            LazyCell lazyCell = this;
            synchronized (lazyCell) {
                if (!this.bitmap$0) {
        ...
        public Stream<A> v() {
            return this.bitmap$0 ? this.v : this.v$lzycompute();
        }
        ...
        public LazyCell(StreamIterator<A> $outer, Function0<Stream<A>> st) {
            this.st = st;
            if ($outer == null) {
                throw null;
            }
