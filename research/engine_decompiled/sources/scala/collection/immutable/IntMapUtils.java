...
public final class IntMapUtils {
    ...
    public static int highestOneBit(int n) {
        return IntMapUtils$.MODULE$.highestOneBit(n);
    }

    public static String bitString(int n, String string2) {
        return IntMapUtils$.MODULE$.bitString(n, string2);
    }

    public static IndexedSeq<Object> bits(int n) {
        return IntMapUtils$.MODULE$.bits(n);
    }

    public static int complement(int n) {
        return IntMapUtils$.MODULE$.complement(n);
    }

    public static boolean shorter(int n, int n2) {
        return IntMapUtils$.MODULE$.shorter(n, n2);
    }

    public static boolean unsignedCompare(int n, int n2) {
        return IntMapUtils$.MODULE$.unsignedCompare(n, n2);
    }

    public static boolean hasMatch(int n, int n2, int n3) {
        return IntMapUtils$.MODULE$.hasMatch(n, n2, n3);
    }

    public static int mask(int n, int n2) {
        return IntMapUtils$.MODULE$.mask(n, n2);
    }

    public static boolean zero(int n, int n2) {
        return IntMapUtils$.MODULE$.zero(n, n2);
    }

    public static <T> IntMap<T> bin(int n, int n2, IntMap<T> intMap, IntMap<T> intMap2) {
        return IntMapUtils$.MODULE$.bin(n, n2, intMap, intMap2);
    }

    public static <T> IntMap<T> join(int n, IntMap<T> intMap, int n2, IntMap<T> intMap2) {
        return IntMapUtils$.MODULE$.join(n, intMap, n2, intMap2);
    }

    public static int branchMask(int n, int n2) {
        return IntMapUtils$.MODULE$.branchMask(n, n2);
    }
}
