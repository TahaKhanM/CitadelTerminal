...
Ordered<String> {
    ...
    public String stripPrefix(String var1);

    public String stripSuffix(String var1);

    public String replaceAllLiterally(String var1, String var2);

    public String stripMargin(char var1);

    public String stripMargin();

    public String[] split(char var1);

    public String[] split(char[] var1) throws PatternSyntaxException;

    public Regex r();

    public Regex r(Seq<String> var1);
    ...
    public String format(Seq<Object> var1);

    public String formatLocal(Locale var1, Seq<Object> var2);
}
