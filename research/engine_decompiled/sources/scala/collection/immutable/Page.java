...
public class Page<T> {
    ...
    public final Page<T> addMore(Function3<Object, Object, Object, Object> more) {
        ...
        int count2 = BoxesRunTime.unboxToInt(more.apply(this_.data(), BoxesRunTime.boxToInteger(this_.filled()), BoxesRunTime.boxToInteger(4096 - this_.filled())));
        if (count2 < 0) {
            this_.isLast_$eq(true);
        } else {
            this_.filled_$eq(this_.filled() + count2);
        }
        return this_;
    }
