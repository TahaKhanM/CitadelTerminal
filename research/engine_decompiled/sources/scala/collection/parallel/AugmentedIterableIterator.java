...
extends RemainsIterator<T> {
    @Override
    public int count(Function1<T, Object> var1);

    @Override
    public <U> U reduce(Function2<U, U, U> var1);

    @Override
    public <U> U fold(U var1, Function2<U, U, U> var2);

    @Override
    public <U> U sum(Numeric<U> var1);

    @Override
    public <U> U product(Numeric<U> var1);

    @Override
    public <U> T min(Ordering<U> var1);

    @Override
    public <U> T max(Ordering<U> var1);

    @Override
    public <U> void copyToArray(Object var1, int var2, int var3);

    public <U> U reduceLeft(int var1, Function2<U, U, U> var2);

    public <S, That> Combiner<S, That> map2combiner(Function1<T, S> var1, Combiner<S, That> var2);

    public <S, That> Combiner<S, That> collect2combiner(PartialFunction<T, S> var1, Combiner<S, That> var2);

    public <S, That> Combiner<S, That> flatmap2combiner(Function1<T, GenTraversableOnce<S>> var1, Combiner<S, That> var2);

    public <U, Coll, Bld extends Builder<U, Coll>> Bld copy2builder(Bld var1);

    public <U, This> Combiner<U, This> filter2combiner(Function1<T, Object> var1, Combiner<U, This> var2);

    public <U, This> Combiner<U, This> filterNot2combiner(Function1<T, Object> var1, Combiner<U, This> var2);

    public <U, This> Tuple2<Combiner<U, This>, Combiner<U, This>> partition2combiners(Function1<T, Object> var1, Combiner<U, This> var2, Combiner<U, This> var3);

    public <U, This> Combiner<U, This> take2combiner(int var1, Combiner<U, This> var2);

    public <U, This> Combiner<U, This> drop2combiner(int var1, Combiner<U, This> var2);

    public <U, This> Combiner<U, This> slice2combiner(int var1, int var2, Combiner<U, This> var3);

    public <U, This> Tuple2<Combiner<U, This>, Combiner<U, This>> splitAt2combiners(int var1, Combiner<U, This> var2, Combiner<U, This> var3);

    public <U, This> Tuple2<Combiner<U, This>, Object> takeWhile2combiner(Function1<T, Object> var1, Combiner<U, This> var2);

    public <U, This> Tuple2<Combiner<U, This>, Combiner<U, This>> span2combiners(Function1<T, Object> var1, Combiner<U, This> var2, Combiner<U, This> var3);

    public <U, A> void scanToArray(U var1, Function2<U, U, U> var2, Object var3, int var4);

    public <U, That> Combiner<U, That> scanToCombiner(U var1, Function2<U, U, U> var2, Combiner<U, That> var3);

    public <U, That> Combiner<U, That> scanToCombiner(int var1, U var2, Function2<U, U, U> var3, Combiner<U, That> var4);

    public <U, S, That> Combiner<Tuple2<U, S>, That> zip2combiner(RemainsIterator<S> var1, Combiner<Tuple2<U, S>, That> var2);

    public <U, S, That> Combiner<Tuple2<U, S>, That> zipAll2combiner(RemainsIterator<S> var1, U var2, S var3, Combiner<Tuple2<U, S>, That> var4);
}
