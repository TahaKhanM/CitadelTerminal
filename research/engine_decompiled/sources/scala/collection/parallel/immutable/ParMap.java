...
ParIterable<Tuple2<K, V>> {
    ...
    @Override
    public <P, Q> ParMap<P, Q> toMap(Predef$.less.colon.less<Tuple2<K, V>, Tuple2<P, Q>> var1);
    ...
    public <U> ParMap<K, U> withDefault(Function1<K, U> var1);

    public <U> ParMap<K, U> withDefaultValue(U var1);
