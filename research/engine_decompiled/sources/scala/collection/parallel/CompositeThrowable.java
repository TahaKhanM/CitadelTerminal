...
Serializable {
    ...
    public boolean equals(Object x$1) {
        ...
        if (!(x$1 instanceof CompositeThrowable)) return false;
        boolean bl = true;
        if (!bl) return false;
    ...
    public CompositeThrowable(Set<Throwable> throwables) {
        ...
        super(new StringBuilder().append((Object)"Multiple exceptions thrown during a parallel computation: ").append((Object)((TraversableOnce)throwables.map(new Serializable(){
            public static final long serialVersionUID = 0L;

            public final String apply(Throwable t) {
                Predef$ predef$ = Predef$.MODULE$;
                return new StringBuilder().append((Object)Predef$any2stringadd$.MODULE$.$plus$extension(Predef$.MODULE$.any2stringadd(t), "\n")).append((Object)Predef$.MODULE$.genericArrayOps(Predef$.MODULE$.refArrayOps((Object[])Predef$.MODULE$.refArrayOps((Object[])t.getStackTrace()).take(10)).$plus$plus(new StringOps("..."), Array$.MODULE$.canBuildFrom(ClassTag$.MODULE$.Any()))).mkString("\n")).toString();
            }
