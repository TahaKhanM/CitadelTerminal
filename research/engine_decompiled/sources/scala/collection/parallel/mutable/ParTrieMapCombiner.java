...
public interface ParTrieMapCombiner<K, V>
extends Combiner<Tuple2<K, V>, ParTrieMap<K, V>> {
    @Override
    public <N extends Tuple2<K, V>, NewTo> Combiner<N, NewTo> combine(Combiner<N, NewTo> var1);
