...
Serializable {
    ...
    extends ArrayBuilder<T> {
        ...
        private void ensureSize(int size2) {
            if (this.capacity() < size2 || this.capacity() == 0) {
                int newsize;
        ...
        public ofRef<T> $plus$plus$eq(TraversableOnce<T> xs) {
            ...
            if (xs instanceof WrappedArray.ofRef) {
                ...
                ofRef2 = (ofRef)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofRef2;
        }
    ...
    extends ArrayBuilder<Object> {
        ...
        public ofInt $plus$plus$eq(TraversableOnce<Object> xs) {
            ...
            if (xs instanceof WrappedArray.ofInt) {
                ...
                ofInt2 = (ofInt)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofInt2;
        }
    ...
    extends ArrayBuilder<Object> {
        ...
        public ofByte $plus$plus$eq(TraversableOnce<Object> xs) {
            ...
            if (xs instanceof WrappedArray.ofByte) {
                ...
                ofByte2 = (ofByte)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofByte2;
        }
    ...
    extends ArrayBuilder<Object> {
        ...
        public ofChar $plus$plus$eq(TraversableOnce<Object> xs) {
            ...
            if (xs instanceof WrappedArray.ofChar) {
                ...
                ofChar2 = (ofChar)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofChar2;
        }
    ...
    extends ArrayBuilder<Object> {
        ...
        public ofLong $plus$plus$eq(TraversableOnce<Object> xs) {
            ...
            if (xs instanceof WrappedArray.ofLong) {
                ...
                ofLong2 = (ofLong)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofLong2;
        }
    ...
    extends ArrayBuilder<BoxedUnit> {
        ...
        public ofUnit $plus$plus$eq(TraversableOnce<BoxedUnit> xs) {
            ...
            if (xs instanceof WrappedArray.ofUnit) {
                WrappedArray.ofUnit ofUnit3 = (WrappedArray.ofUnit)xs;
                this.ensureSize(this.size() + ofUnit3.length());
                Array$.MODULE$.copy(ofUnit3.array(), 0, this.elems(), this.size(), ofUnit3.length());
                this.size_$eq(this.size() + ofUnit3.length());
                ofUnit2 = this;
            } else {
                ofUnit2 = (ofUnit)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofUnit2;
        }
        ...
        public BoxedUnit[] result() {
            ...
            if (this.capacity() != 0 && this.capacity() == this.size()) {
                this.capacity_$eq(0);
                boxedUnitArray = this.elems();
            } else {
                boxedUnitArray = this.mkArray(this.size());
            }
        ...
        public boolean equals(Object other) {
            ...
            if (other instanceof ofUnit) {
                ...
                bl = this.size() == ofUnit2.size() && this.elems() == ofUnit2.elems();
            } else {
                bl = false;
            }
            return bl;
    ...
    extends ArrayBuilder<Object> {
        ...
        public ofShort $plus$plus$eq(TraversableOnce<Object> xs) {
            ...
            if (xs instanceof WrappedArray.ofShort) {
                ...
                ofShort2 = (ofShort)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofShort2;
        }
    ...
    extends ArrayBuilder<Object> {
        ...
        public ofFloat $plus$plus$eq(TraversableOnce<Object> xs) {
            ...
            if (xs instanceof WrappedArray.ofFloat) {
                ...
                ofFloat2 = (ofFloat)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofFloat2;
        }
    ...
    extends ArrayBuilder<Object> {
        ...
        public ofDouble $plus$plus$eq(TraversableOnce<Object> xs) {
            ...
            if (xs instanceof WrappedArray.ofDouble) {
                ...
                ofDouble2 = (ofDouble)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofDouble2;
        }
    ...
    extends ArrayBuilder<Object> {
        ...
        public ofBoolean $plus$plus$eq(TraversableOnce<Object> xs) {
            ...
            if (xs instanceof WrappedArray.ofBoolean) {
                ...
                ofBoolean2 = (ofBoolean)Growable$class.$plus$plus$eq(this, xs);
            }
            return ofBoolean2;
        }
