...
extends Proxy {
    ...
    public StackProxy<A> $plus$eq(A var1);

    public StackProxy<A> pushAll(TraversableOnce<A> var1);

    public StackProxy<A> push(A var1, A var2, Seq<A> var3);

    public StackProxy<A> push(A var1);
