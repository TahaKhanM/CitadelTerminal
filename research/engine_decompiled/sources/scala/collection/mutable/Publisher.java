...
public interface Publisher<Evt> {
    ...
    public void scala$collection$mutable$Publisher$_setter_$scala$collection$mutable$Publisher$$filters_$eq(HashMap var1);

    public void scala$collection$mutable$Publisher$_setter_$scala$collection$mutable$Publisher$$suspended_$eq(HashSet var1);
    ...
    public void subscribe(Subscriber<Evt, Publisher> var1);

    public void subscribe(Subscriber<Evt, Publisher> var1, Function1<Evt, Object> var2);

    public void suspendSubscription(Subscriber<Evt, Publisher> var1);

    public void activateSubscription(Subscriber<Evt, Publisher> var1);

    public void removeSubscription(Subscriber<Evt, Publisher> var1);

    public void removeSubscriptions();

    public void publish(Evt var1);
