...
extends AbstractMap<Key, Value> {
    ...
    private void scala$collection$mutable$OpenHashMap$$table_$eq(OpenEntry<Key, Value>[] x$1) {
        this.scala$collection$mutable$OpenHashMap$$table = x$1;
    }
    ...
    public void scala$collection$mutable$OpenHashMap$$size_$eq(int s2) {
        this._size_$eq(s2);
    }

    public int hashOf(Key key) {
        int h = ScalaRunTime$.MODULE$.hash(key);
        h ^= h >>> 20 ^ h >>> 12;
        return h ^ h >>> 7 ^ h >>> 4;
    }
    ...
    private void growTable() {
        ...
        this.scala$collection$mutable$OpenHashMap$$table_$eq(new OpenEntry[newSize]);
        this.scala$collection$mutable$OpenHashMap$$mask_$eq(newSize - 1);
        Predef$.MODULE$.refArrayOps((Object[])oldTable).foreach(new Serializable(this){
            public static final long serialVersionUID = 0L;
            private final /* synthetic */ OpenHashMap $outer;

            public final void apply(OpenEntry<Key, Value> entry) {
                if (entry != null) {
                    Option<Value> option = entry.value();
                    None$ none$ = None$.MODULE$;
                    if (option == null || !option.equals(none$)) {
                        this.$outer.scala$collection$mutable$OpenHashMap$$addEntry(entry);
                    }
                }
            }
            {
    ...
    private int findIndex(Key key) {
        return this.findIndex(key, this.hashOf(key));
    }
    ...
    private int findIndex(Key key, int hash) {
        ...
        boolean j = false;
        Key Key2;
        while (!(this.scala$collection$mutable$OpenHashMap$$table()[index] == null || this.scala$collection$mutable$OpenHashMap$$table()[index].hash() == hash && ((Key2 = this.scala$collection$mutable$OpenHashMap$$table()[index].key()) == key ? true : (Key2 == null ? false : (Key2 instanceof Number ? BoxesRunTime.equalsNumObject((Number)Key2, key) : (Key2 instanceof Character ? BoxesRunTime.equalsCharObject((Character)Key2, key) : Key2.equals(key))))))) {
            void var4_4;
            int n;
            n = n + ++var4_4 & this.scala$collection$mutable$OpenHashMap$$mask();
        }
        return index;
    }

    public void scala$collection$mutable$OpenHashMap$$addEntry(OpenEntry<Key, Value> entry) {
        if (entry != null) {
    ...
    public void update(Key key, Value value) {
        this.scala$collection$mutable$OpenHashMap$$put(key, this.hashOf(key), value);
    }
    ...
    public Option<Value> put(Key key, Value value) {
        return this.scala$collection$mutable$OpenHashMap$$put(key, this.hashOf(key), value);
    }

    public Option<Value> scala$collection$mutable$OpenHashMap$$put(Key key, int hash, Value value) {
        None$ none$;
    ...
    public Option<Value> remove(Key key) {
        ...
        block3: {
            block2: {
                ...
                if (this.scala$collection$mutable$OpenHashMap$$table()[index] == null) break block2;
                Option<Value> option2 = this.scala$collection$mutable$OpenHashMap$$table()[index].value();
                None$ none$ = None$.MODULE$;
                if (option2 == null || !option2.equals(none$)) break block3;
            }
            option = None$.MODULE$;
            return option;
        }
        Option<Value> res = this.scala$collection$mutable$OpenHashMap$$table()[index].value();
        this.scala$collection$mutable$OpenHashMap$$table()[index].value_$eq(None$.MODULE$);
        this.scala$collection$mutable$OpenHashMap$$size_$eq(this.size() - 1);
        this.scala$collection$mutable$OpenHashMap$$deleted_$eq(this.scala$collection$mutable$OpenHashMap$$deleted() + 1);
        option = res;
        return option;
    ...
    public Option<Value> get(Key key) {
        ...
        while (entry != null) {
            ...
            Object Key2;
            void var2_2;
            OpenEntry<Key, Value> openEntry;
            if (openEntry.hash() == var2_2 && ((Key2 = openEntry.key()) == key ? true : (Key2 == null ? false : (Key2 instanceof Number ? BoxesRunTime.equalsNumObject((Number)Key2, key) : (Key2 instanceof Character ? BoxesRunTime.equalsCharObject((Character)Key2, key) : Key2.equals(key)))))) {
                return openEntry.value();
            }
            n = n + ++var4_5 & this.scala$collection$mutable$OpenHashMap$$mask();
            openEntry = this.scala$collection$mutable$OpenHashMap$$table()[n];
        }
        return None$.MODULE$;
    }
            ...
            private void advance() {
                ...
                while (this.index() <= this.$outer.scala$collection$mutable$OpenHashMap$$mask()) {
                    if (this.$outer.scala$collection$mutable$OpenHashMap$$table()[this.index()] != null) {
                        ...
                        None$ none$ = None$.MODULE$;
                        if (option == null || !option.equals(none$)) break;
                    }
    ...
    public OpenHashMap<Key, Value> clone() {
        void var1_1;
        OpenHashMap<Key, Value> it = new OpenHashMap<Key, Value>();
        this.foreachUndeletedEntry((Function1<OpenEntry<Key, Value>, BoxedUnit>)((Object)new Serializable(this, it){
            public static final long serialVersionUID = 0L;
            private final OpenHashMap it$1;

            public final void apply(OpenEntry<Key, Value> entry) {
                this.it$1.scala$collection$mutable$OpenHashMap$$put(entry.key(), entry.hash(), entry.value().get());
            }
            {
                this.it$1 = it$1;
            }
    ...
    public <U> void foreach(Function1<Tuple2<Key, Value>, U> f) {
        ...
        this.foreachUndeletedEntry((Function1<OpenEntry<Key, Value>, BoxedUnit>)((Object)new Serializable(this, f, startModCount){
            public static final long serialVersionUID = 0L;
            private final /* synthetic */ OpenHashMap $outer;
            ...
            public final void apply(OpenEntry<Key, Value> entry) {
                ...
                this.f$2.apply(new Tuple2<Key, Value>(entry.key(), entry.value().get()));
            }
            {
                if ($outer == null) {
                    throw null;
                ...
                this.$outer = $outer;
                this.f$2 = f$2;
                this.startModCount$1 = startModCount$1;
            }
        }));
    }

    private void foreachUndeletedEntry(Function1<OpenEntry<Key, Value>, BoxedUnit> f) {
        Predef$.MODULE$.refArrayOps((Object[])this.scala$collection$mutable$OpenHashMap$$table()).foreach(new Serializable(this, f){
            public static final long serialVersionUID = 0L;
    ...
    public OpenHashMap<Key, Value> transform(Function2<Key, Value, Value> f) {
        this.foreachUndeletedEntry((Function1<OpenEntry<Key, Value>, BoxedUnit>)((Object)new Serializable(this, f){
            public static final long serialVersionUID = 0L;
            private final Function2 f$3;

            public final void apply(OpenEntry<Key, Value> entry) {
                entry.value_$eq(new Some<R>(this.f$3.apply(entry.key(), entry.value().get())));
            }
            {
                this.f$3 = f$3;
            }
    ...
    public OpenHashMap<Key, Value> retain(Function2<Key, Value, Object> f) {
        this.foreachUndeletedEntry((Function1<OpenEntry<Key, Value>, BoxedUnit>)((Object)new Serializable(this, f){
            ...
            public final void apply(OpenEntry<Key, Value> entry) {
                if (!BoxesRunTime.unboxToBoolean(this.f$4.apply(entry.key(), entry.value().get()))) {
    ...
    public OpenHashMap(int initialSize) {
        this.actualInitialSize = OpenHashMap$.MODULE$.nextPositivePowerOfTwo(initialSize);
    ...
    implements HashEntry<Key, OpenEntry<Key, Value>> {
