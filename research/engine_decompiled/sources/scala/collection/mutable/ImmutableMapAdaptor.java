...
implements Serializable {
    ...
    public ImmutableMapAdaptor<A, B> retain(Function2<A, B, Object> p) {
        this.imap_$eq((Map)this.imap().filter((Function1<A, Object>)((Object)new Serializable(this, p){
            public static final long serialVersionUID = 0L;
            private final Function2 p$1;

            public final boolean apply(Tuple2<A, B> xy) {
