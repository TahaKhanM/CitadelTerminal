...
Serializable {
    ...
    public String chainString() {
        return new StringBuilder().append((Object)"(kv: ").append(this.key()).append((Object)", ").append(this.value()).append((Object)")").append((Object)(this.next() == null ? "" : new StringBuilder().append((Object)" -> ").append((Object)((DefaultEntry)this.next()).toString()).toString())).toString();
    }
