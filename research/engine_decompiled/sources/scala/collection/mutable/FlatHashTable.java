...
extends HashUtils<A> {
    ...
    public void init(ObjectInputStream var1, Function1<A, BoxedUnit> var2);

    public void serializeTo(ObjectOutputStream var1);

    public Option<A> findEntry(A var1);

    public boolean containsElem(A var1);

    public boolean addElem(A var1);

    public boolean addEntry(Object var1);

    public boolean removeElem(A var1);
    ...
    public void initWithContents(Contents<A> var1);
    ...
    public static interface HashUtils<A> {
        ...
        public Object elemToEntry(A var1);

        public A entryToElem(Object var1);
    }
}
