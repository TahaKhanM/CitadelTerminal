...
extends HashUtils<A> {
    ...
    public void init(ObjectInputStream var1, Function0<Entry> var2);

    public void serializeTo(ObjectOutputStream var1, Function1<Entry, BoxedUnit> var2);

    public Entry findEntry(A var1);

    public void addEntry(Entry var1);

    public <B> Entry findOrAddEntry(A var1, B var2);

    public <B> Entry createNewEntry(A var1, B var2);

    public Entry removeEntry(A var1);

    public Iterator<Entry> entriesIterator();

    public <U> void foreachEntry(Function1<Entry, U> var1);

    public void clearTable();

    public void nnSizeMapAdd(int var1);

    public void nnSizeMapRemove(int var1);

    public void nnSizeMapReset(int var1);

    public int totalSizeMapBuckets();

    public int calcSizeMapSize(int var1);

    public void sizeMapInit(int var1);
    ...
    public boolean elemEquals(A var1, A var2);

    public int index(int var1);

    public void initWithContents(Contents<A, Entry> var1);
        ...
        public String debugInformation() {
            return DebugUtils$.MODULE$.buildString((Function1<Function1<Object, BoxedUnit>, BoxedUnit>)((Object)new Serializable(this){
                ...
                public final void apply(Function1<Object, BoxedUnit> append2) {
                    append2.apply("Hash table contents");
                    append2.apply("-------------------");
                    append2.apply(new StringBuilder().append((Object)"Table: [").append((Object)DebugUtils$.MODULE$.arrayString(this.$outer.table(), 0, this.$outer.table().length)).append((Object)"]").toString());
                    append2.apply(new StringBuilder().append((Object)"Table size: ").append(BoxesRunTime.boxToInteger(this.$outer.tableSize())).toString());
                    append2.apply(new StringBuilder().append((Object)"Load factor: ").append(BoxesRunTime.boxToInteger(this.$outer.loadFactor())).toString());
                    append2.apply(new StringBuilder().append((Object)"Seedvalue: ").append(BoxesRunTime.boxToInteger(this.$outer.seedvalue())).toString());
                    append2.apply(new StringBuilder().append((Object)"Threshold: ").append(BoxesRunTime.boxToInteger(this.$outer.threshold())).toString());
                    append2.apply(new StringBuilder().append((Object)"Sizemap: [").append((Object)DebugUtils$.MODULE$.arrayString(this.$outer.sizemap(), 0, this.$outer.sizemap().length)).append((Object)"]").toString());
                }
                {
                    if ($outer == null) {
                        throw null;
    ...
    public static interface HashUtils<KeyType> {
        public int sizeMapBucketBitSize();

        public int sizeMapBucketSize();

        public int elemHashCode(KeyType var1);

        public int improve(int var1, int var2);
    }
}
