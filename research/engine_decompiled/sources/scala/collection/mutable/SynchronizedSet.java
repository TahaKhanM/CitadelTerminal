...
extends Set<A> {
    ...
    @Override
    public SynchronizedSet<A> $plus$eq(A var1);

    @Override
    public SynchronizedSet<A> $plus$plus$eq(TraversableOnce<A> var1);

    @Override
    public SynchronizedSet<A> $minus$eq(A var1);

    @Override
    public SynchronizedSet<A> $minus$minus$eq(TraversableOnce<A> var1);

    @Override
    public void update(A var1, boolean var2);

    @Override
    public boolean add(A var1);

    @Override
    public boolean remove(A var1);

    @Override
    public Set<A> intersect(GenSet<A> var1);
    ...
    @Override
    public void retain(Function1<A, Object> var1);
