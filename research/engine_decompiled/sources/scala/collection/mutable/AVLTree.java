...
extends Serializable {
    ...
    public <B> boolean contains(B var1, Ordering<B> var2);

    public <B> AVLTree<B> insert(B var1, Ordering<B> var2);

    public <B> AVLTree<A> remove(B var1, Ordering<B> var2);
