...
extends Growable<Elem> {
    ...
    public void sizeHint(TraversableLike<?, ?> var1);

    public void sizeHint(TraversableLike<?, ?> var1, int var2);

    public void sizeHintBounded(int var1, TraversableLike<?, ?> var2);

    public <NewTo> Builder<Elem, NewTo> mapResult(Function1<To, NewTo> var1);
}
