...
import scala.collection.generic.GenericClassTagTraversableTemplate$class;
...
Serializable {
    ...
    public <B> Builder<B, UnrolledBuffer<B>> genericClassTagBuilder(ClassTag<B> tag) {
        return GenericClassTagTraversableTemplate$class.genericClassTagBuilder(this, tag);
    }

    @Override
    public GenericClassTagCompanion<UnrolledBuffer> classManifestCompanion() {
        return GenericClassTagTraversableTemplate$class.classManifestCompanion(this);
    }

    @Override
    public <B> Builder<B, UnrolledBuffer<B>> genericClassManifestBuilder(ClassTag<B> manifest) {
        return GenericClassTagTraversableTemplate$class.genericClassManifestBuilder(this, manifest);
    }
    ...
    public void headPtr_$eq(Unrolled<T> head2) {
        this.scala$collection$mutable$UnrolledBuffer$$headptr_$eq(head2);
    }
    ...
    public void lastPtr_$eq(Unrolled<T> last2) {
        this.lastptr_$eq(last2);
    }

    public void size_$eq(int s2) {
        this.sz_$eq(s2);
    }
    ...
    private void writeObject(ObjectOutputStream out) {
        ...
        this.foreach((Function1)((Object)new Serializable(this, out){
            public static final long serialVersionUID = 0L;
            private final ObjectOutputStream out$1;

            public final void apply(T elem) {
                this.out$1.writeObject(elem);
            }
            {
                this.out$1 = out$1;
            }
    ...
    public UnrolledBuffer(ClassTag<T> tag) {
        this.tag = tag;
        GenericClassTagTraversableTemplate$class.$init$(this);
    ...
    public static class Unrolled<T> {
        ...
        private int nextlength() {
            return this.buff() == null ? UnrolledBuffer$.MODULE$.unrolledlength() : this.buff().calcNextLength(ScalaRunTime$.MODULE$.array_length(this.array()));
        }
            ...
            while (true) {
                block10: {
                    block9: {
                        BoxedUnit boxedUnit;
                        block8: {
                            if (idx >= this_.size()) break block8;
                            ...
                            this_.size_$eq(idx);
                            this_.next_$eq(null);
                            ObjectRef<Unrolled<T>> curr = ObjectRef.create(this_);
                            t.foreach(new Serializable(this_, curr){
                                public static final long serialVersionUID = 0L;
                                private final ObjectRef curr$1;

                                public final void apply(T elem) {
                                    this.curr$1.elem = ((Unrolled)this.curr$1.elem).append(elem);
                                }
                                {
                                    this.curr$1 = curr$1;
                                }
                        ...
                        if (idx != this_.size() && this_.next() != null) break block10;
                        ObjectRef<Unrolled> curr = ObjectRef.create(this_);
                        t.foreach(new Serializable((Unrolled)this_, curr){
                            public static final long serialVersionUID = 0L;
                            private final ObjectRef curr$2;

                            public final void apply(T elem) {
                                this.curr$2.elem = ((Unrolled)this.curr$2.elem).append(elem);
                            }
                            {
                                this.curr$2 = curr$2;
                            }
        ...
        private void nullout(int from2, int until2) {
        ...
        public String toString() {
            ...
            return new StringBuilder().append((Object)Predef$.MODULE$.genericArrayOps(Predef$.MODULE$.genericArrayOps(this.array()).take(this.size())).mkString(new StringBuilder().append((Object)new StringOps("Unrolled@%08x").format(Predef$.MODULE$.genericWrapArray(new Object[]{BoxesRunTime.boxToInteger(System.identityHashCode(this))}))).append((Object)"[").append(BoxesRunTime.boxToInteger(this.size())).append((Object)"/").append(BoxesRunTime.boxToInteger(ScalaRunTime$.MODULE$.array_length(this.array()))).append((Object)"](").toString(), ", ", ")")).append((Object)" -> ").append((Object)(this.next() != null ? this.next().toString() : "")).toString();
        }

        public Unrolled(int size2, Object array, Unrolled<T> next2, UnrolledBuffer<T> buff, ClassTag<T> evidence$1) {
            this.size = size2;
            this.array = array;
            this.next = next2;
            this.buff = buff;
