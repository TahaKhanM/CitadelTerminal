...
Cloneable<This> {
    ...
    public MapLike<A, B, This> $plus$eq(Tuple2<A, B> var1);
    ...
    public MapLike<A, B, This> $minus$eq(A var1);
    ...
    public MapLike<A, B, This> transform(Function2<A, B, B> var1);

    public MapLike<A, B, This> retain(Function2<A, B, Object> var1);
    ...
    @Override
    public This $minus(A var1, A var2, Seq<A> var3);

    @Override
    public This $minus$minus(GenTraversableOnce<A> var1);
}
