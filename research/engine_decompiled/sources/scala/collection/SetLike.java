...
Subtractable<A, This> {
    ...
    public This $plus(A var1, A var2, Seq<A> var3);

    public This $plus$plus(GenTraversableOnce<A> var1);
    ...
    @Override
    public This union(GenSet<A> var1);

    @Override
    public This diff(GenSet<A> var1);

    public Iterator<This> subsets(int var1);

    public Iterator<This> subsets();
    ...
    extends AbstractIterator<This> {
        ...
        public This next() {
            ...
            int[] nArray = this.scala$collection$SetLike$SubsetsItr$$idxs();
            Predef$ predef$ = Predef$.MODULE$;
            int n = this.len;
            int[] nArray2 = (int[])IndexedSeqOptimized$class.slice(new ArrayOps.ofInt(nArray), 0, n);
            Predef$ predef$2 = Predef$.MODULE$;
            IndexedSeqOptimized$class.foreach(new ArrayOps.ofInt(nArray2), (Function1)((Object)new Serializable(this, buf){
                public static final long serialVersionUID = 0L;
                private final /* synthetic */ SubsetsItr $outer;
            ...
            for (i = this.len - 1; i >= 0 && this.scala$collection$SetLike$SubsetsItr$$idxs()[i] == this.scala$collection$SetLike$SubsetsItr$$idxs()[i + 1] - 1; --i) {
            }
            if (i < 0) {
                this._hasNext_$eq(false);
                return result2;
            }
            this.scala$collection$SetLike$SubsetsItr$$idxs()[i] = this.scala$collection$SetLike$SubsetsItr$$idxs()[i] + 1;
            int n2 = i + 1;
            Predef$ predef$3 = Predef$.MODULE$;
            int n3 = this.len;
            Range$ range$ = Range$.MODULE$;
            Range range2 = new Range(n2, n3, 1);
            if (range2.isEmpty()) return result2;
            int i1 = range2.start();
            while (true) {
                this.scala$collection$SetLike$SubsetsItr$$idxs()[i1] = this.scala$collection$SetLike$SubsetsItr$$idxs()[i1 - 1] + 1;
        ...
        public SubsetsItr(SetLike<A, This> $outer, IndexedSeq<A> elms, int len) {
            this.scala$collection$SetLike$SubsetsItr$$elms = elms;
            this.len = len;
            if ($outer == null) {
                throw null;
            }
            this.$outer = $outer;
            this.scala$collection$SetLike$SubsetsItr$$idxs = Array$.MODULE$.range(0, len + 1);
            this._hasNext = true;
            this.scala$collection$SetLike$SubsetsItr$$idxs()[len] = elms.size();
        }
    }
}
