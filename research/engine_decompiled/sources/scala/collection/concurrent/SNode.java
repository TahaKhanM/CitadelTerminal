...
implements KVNode<K, V> {
    ...
    public final String string(int lev) {
        ...
        return new StringBuilder().append((Object)new StringOps("  ").$times(lev)).append((Object)new StringOps("SNode(%s, %s, %x)").format(Predef$.MODULE$.genericWrapArray(new Object[]{this.k(), this.v(), BoxesRunTime.boxToInteger(this.hc())}))).toString();
    }
