...
extends CNodeBase<K, V> {
    ...
    public String string(int lev) {
        ...
        return new StringOps("CNode %x\n%s").format(Predef$.MODULE$.genericWrapArray(new Object[]{BoxesRunTime.boxToInteger(this.bitmap()), Predef$.MODULE$.refArrayOps((Object[])Predef$.MODULE$.refArrayOps((Object[])this.array()).map(new Serializable(this, lev){
            public static final long serialVersionUID = 0L;
            private final int lev$3;

            public final String apply(BasicNode x$2) {
                return x$2.string(this.lev$3 + 1);
            }
            {
                this.lev$3 = lev$3;
            }
    ...
    public Seq<Tuple2<K, V>> scala$collection$concurrent$CNode$$collectElems() {
        return Predef$.MODULE$.refArrayOps((Object[])this.array()).flatMap(new Serializable(this){
            public static final long serialVersionUID = 0L;
                        ...
                        block3: {
                            ...
                            block6: {
                                block7: {
                                    block5: {
                                        block2: {
                                            if (!(x0$1 instanceof SNode)) break block2;
                                            SNode sNode = (SNode)x0$1;
                                            iterable = Option$.MODULE$.option2Iterable(new Some<Tuple2<K, V>>(sNode.kvPair()));
                                            break block3;
                                        }
                                        if (!(x0$1 instanceof INode)) break block4;
                                        INode iNode = (INode)x0$1;
                                        mainNode = iNode.mainnode;
                                        if (!(mainNode instanceof TNode)) break block5;
                                        TNode tNode = (TNode)mainNode;
                                        iterable2 = Option$.MODULE$.option2Iterable(new Some<Tuple2<K, V>>(tNode.kvPair()));
                                        break block6;
                                    }
                                    if (!(mainNode instanceof LNode)) break block7;
                                    LNode lNode = (LNode)mainNode;
                                    iterable2 = lNode.listmap().toList();
                                    break block6;
                                }
                                if (!(mainNode instanceof CNode)) break block8;
                                CNode cNode = (CNode)mainNode;
                                iterable2 = cNode.scala$collection$concurrent$CNode$$collectElems();
                            }
                            iterable = iterable2;
                        }
                        return iterable;
        ...
        return Predef$.MODULE$.refArrayOps((Object[])this.array()).flatMap(new Serializable(this){
            ...
            public final Iterable<String> apply(BasicNode x0$2) {
                block4: {
                    ...
                    block3: {
                        block2: {
                            if (!(x0$2 instanceof SNode)) break block2;
                            SNode sNode = (SNode)x0$2;
                            iterable = Option$.MODULE$.option2Iterable(new Some<String>(sNode.kvPair()._2().toString()));
                            break block3;
                        }
                        if (!(x0$2 instanceof INode)) break block4;
                        INode iNode = (INode)x0$2;
                        String string2 = iNode.toString();
                        Predef$ predef$ = Predef$.MODULE$;
                        iterable = Option$.MODULE$.option2Iterable(new Some<String>(new StringBuilder().append((Object)((String)new StringOps(string2).drop(14))).append((Object)"(").append(iNode.gen).append((Object)")").toString()));
                    }
                    return iterable;
                }
    ...
    public String toString() {
        ...
        Predef$ predef$ = Predef$.MODULE$;
        return new StringOps("CNode(sz: %d; %s)").format(Predef$.MODULE$.genericWrapArray(new Object[]{BoxesRunTime.boxToInteger(elems.size()), ((TraversableOnce)elems.sorted(Ordering$String$.MODULE$)).mkString(", ")}));
    }
