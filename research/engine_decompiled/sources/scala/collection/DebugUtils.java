...
public final class DebugUtils {
    ...
    public static Nothing$ illegalArgument(String string2) {
        return DebugUtils$.MODULE$.illegalArgument(string2);
    }
    ...
    public static Nothing$ noSuchElement(String string2) {
        return DebugUtils$.MODULE$.noSuchElement(string2);
    }

    public static Nothing$ unsupported(String string2) {
        return DebugUtils$.MODULE$.unsupported(string2);
    }
}
