...
public interface WrapAsScala {
    public <A> Iterator<A> asScalaIterator(java.util.Iterator<A> var1);

    public <A> Iterator<A> enumerationAsScalaIterator(Enumeration<A> var1);

    public <A> Iterable<A> iterableAsScalaIterable(java.lang.Iterable<A> var1);

    public <A> Iterable<A> collectionAsScalaIterable(Collection<A> var1);

    public <A> Buffer<A> asScalaBuffer(List<A> var1);

    public <A> scala.collection.mutable.Set<A> asScalaSet(Set<A> var1);

    public <A, B> scala.collection.mutable.Map<A, B> mapAsScalaMap(java.util.Map<A, B> var1);

    public <A, B> Map<A, B> mapAsScalaConcurrentMap(ConcurrentMap<A, B> var1);

    public <A, B> scala.collection.mutable.Map<A, B> dictionaryAsScalaMap(Dictionary<A, B> var1);

    public scala.collection.mutable.Map<String, String> propertiesAsScalaMap(Properties var1);
}
