...
public interface DecorateAsJava {
    public <A> Decorators.AsJava<java.util.Iterator<A>> asJavaIteratorConverter(Iterator<A> var1);

    public <A> Decorators.AsJavaEnumeration<A> asJavaEnumerationConverter(Iterator<A> var1);

    public <A> Decorators.AsJava<java.lang.Iterable<A>> asJavaIterableConverter(Iterable<A> var1);

    public <A> Decorators.AsJavaCollection<A> asJavaCollectionConverter(Iterable<A> var1);

    public <A> Decorators.AsJava<List<A>> bufferAsJavaListConverter(Buffer<A> var1);

    public <A> Decorators.AsJava<List<A>> mutableSeqAsJavaListConverter(scala.collection.mutable.Seq<A> var1);

    public <A> Decorators.AsJava<List<A>> seqAsJavaListConverter(Seq<A> var1);

    public <A> Decorators.AsJava<java.util.Set<A>> mutableSetAsJavaSetConverter(scala.collection.mutable.Set<A> var1);

    public <A> Decorators.AsJava<java.util.Set<A>> setAsJavaSetConverter(Set<A> var1);

    public <A, B> Decorators.AsJava<java.util.Map<A, B>> mutableMapAsJavaMapConverter(scala.collection.mutable.Map<A, B> var1);

    public <A, B> Decorators.AsJavaDictionary<A, B> asJavaDictionaryConverter(scala.collection.mutable.Map<A, B> var1);

    public <A, B> Decorators.AsJava<java.util.Map<A, B>> mapAsJavaMapConverter(Map<A, B> var1);

    public <A, B> Decorators.AsJava<ConcurrentMap<A, B>> mapAsJavaConcurrentMapConverter(scala.collection.concurrent.Map<A, B> var1);
}
