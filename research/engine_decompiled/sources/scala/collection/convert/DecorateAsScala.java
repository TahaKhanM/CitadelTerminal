...
public interface DecorateAsScala {
    public <A> Decorators.AsScala<Iterator<A>> asScalaIteratorConverter(java.util.Iterator<A> var1);

    public <A> Decorators.AsScala<Iterator<A>> enumerationAsScalaIteratorConverter(Enumeration<A> var1);

    public <A> Decorators.AsScala<Iterable<A>> iterableAsScalaIterableConverter(java.lang.Iterable<A> var1);

    public <A> Decorators.AsScala<Iterable<A>> collectionAsScalaIterableConverter(Collection<A> var1);

    public <A> Decorators.AsScala<Buffer<A>> asScalaBufferConverter(List<A> var1);

    public <A> Decorators.AsScala<scala.collection.mutable.Set<A>> asScalaSetConverter(Set<A> var1);

    public <A, B> Decorators.AsScala<scala.collection.mutable.Map<A, B>> mapAsScalaMapConverter(java.util.Map<A, B> var1);

    public <A, B> Decorators.AsScala<Map<A, B>> mapAsScalaConcurrentMapConverter(ConcurrentMap<A, B> var1);

    public <A, B> Decorators.AsScala<scala.collection.mutable.Map<A, B>> dictionaryAsScalaMapConverter(Dictionary<A, B> var1);

    public Decorators.AsScala<scala.collection.mutable.Map<String, String>> propertiesAsScalaMapConverter(Properties var1);
}
