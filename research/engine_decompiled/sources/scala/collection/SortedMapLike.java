...
MapLike<A, B, This> {
    ...
    implements SortedSet<A> {
        ...
        @Override
        public SortedSet<A> from(A from2) {
            return SortedSetLike$class.from(this, from2);
        }

        @Override
        public SortedSet<A> until(A until2) {
            return SortedSetLike$class.until(this, until2);
        }

        @Override
        public SortedSet<A> range(A from2, A until2) {
        ...
        public SortedSet<A> rangeImpl(Option<A> from2, Option<A> until2) {
            Object map2 = this.scala$collection$SortedMapLike$DefaultKeySortedSet$$$outer().rangeImpl(from2, until2);
