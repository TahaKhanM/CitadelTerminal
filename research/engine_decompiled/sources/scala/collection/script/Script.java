...
implements Message<A> {
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            if (i > 1) {
                res = new StringBuilder().append((Object)res).append((Object)", ").toString();
            }
            res = new StringBuilder().append((Object)res).append((Object)"[").append(BoxesRunTime.boxToInteger(i)).append((Object)"] ").append(it.next()).toString();
            ++i;
        }
        return new StringBuilder().append((Object)res).append((Object)")").toString();
    }
}
