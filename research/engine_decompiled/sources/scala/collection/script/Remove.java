...
Serializable {
    ...
    public <A> Remove<A> copy(Location location, A elem) {
    ...
    public boolean equals(Object x$1) {
        ...
        if (!(x$1 instanceof Remove)) return false;
        boolean bl2 = true;
        if (!bl2) return false;
        Remove remove = (Remove)x$1;
        Location location = this.location();
        Location location2 = remove.location();
        if (location == null) {
            if (location2 != null) {
                return false;
            }
        ...
        if (!bl) return false;
        if (!remove.canEqual(this)) return false;
        return true;
    }

    public Remove(Location location, A elem) {
        this.location = location;
        this.elem = elem;
        Product$class.$init$(this);
    }

    public Remove(A elem) {
