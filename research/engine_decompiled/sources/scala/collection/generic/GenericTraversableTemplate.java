...
extends HasNewBuilder<A, CC> {
    ...
    public <B> Builder<B, CC> genericBuilder();

    public <A1, A2> Tuple2<CC, CC> unzip(Function1<A, Tuple2<A1, A2>> var1);

    public <A1, A2, A3> Tuple3<CC, CC, CC> unzip3(Function1<A, Tuple3<A1, A2, A3>> var1);

    public <B> CC flatten(Function1<A, GenTraversableOnce<B>> var1);

    public <B> CC transpose(Function1<A, GenTraversableOnce<B>> var1);
}
