...
extends GenericClassTagCompanion<CC> {
    ...
    implements CanBuildFrom<CC, A, CC> {
        ...
        public Builder<A, CC> apply(CC from2) {
            return ((GenericClassTagTraversableTemplate)from2).genericClassTagBuilder(this.tag);
        }
        ...
        public GenericCanBuildFrom(ClassTagTraversableFactory<CC> $outer, ClassTag<A> tag) {
            this.tag = tag;
            if ($outer == null) {
                throw null;
            }
