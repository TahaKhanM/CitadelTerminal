...
public final class IdleSignalling {
    ...
    public static void setIndexFlagIfLesser(int n) {
        IdleSignalling$.MODULE$.setIndexFlagIfLesser(n);
    }

    public static void setIndexFlagIfGreater(int n) {
        IdleSignalling$.MODULE$.setIndexFlagIfGreater(n);
    }

    public static void setIndexFlag(int n) {
        IdleSignalling$.MODULE$.setIndexFlag(n);
    }
