...
public final class BitOperations {
    ...
    public static interface Int {
        public boolean zero(int var1, int var2);

        public int mask(int var1, int var2);

        public boolean hasMatch(int var1, int var2, int var3);

        public boolean unsignedCompare(int var1, int var2);

        public boolean shorter(int var1, int var2);

        public int complement(int var1);

        public IndexedSeq<Object> bits(int var1);

        public String bitString(int var1, String var2);

        public String bitString$default$2();

        public int highestOneBit(int var1);
    }

    public static interface Long {
        public boolean zero(long var1, long var3);

        public long mask(long var1, long var3);

        public boolean hasMatch(long var1, long var3, long var5);

        public boolean unsignedCompare(long var1, long var3);

        public boolean shorter(long var1, long var3);

        public long complement(long var1);

        public IndexedSeq<Object> bits(long var1);

        public String bitString(long var1, String var3);

        public String bitString$default$2();

        public long highestOneBit(long var1);
    }
}
