...
extends HasNewBuilder<A, CC> {
    ...
    public <B> Builder<B, CC> genericClassTagBuilder(ClassTag<B> var1);

    public GenericClassTagCompanion<CC> classManifestCompanion();

    public <B> Builder<B, CC> genericClassManifestBuilder(ClassTag<B> var1);
}
