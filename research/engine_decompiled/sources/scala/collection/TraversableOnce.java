...
extends GenTraversableOnce<A> {
    ...
    public <B> Option<B> collectFirst(PartialFunction<A, B> var1);
    ...
    public static class FlattenOps<A> {
        ...
        public Iterator<A> flatten() {
            return new AbstractIterator<A>(this){
                ...
                public A next() {
                    return (A)(this.hasNext() ? this.it().next() : Iterator$.MODULE$.empty().next());
                }
                {
    ...
    implements CanBuildFrom<CC, A, CC> {
        ...
        public Builder<A, CC> newIterator() {
            return new ArrayBuffer().mapResult(new Serializable(this){
                public static final long serialVersionUID = 0L;
                private final /* synthetic */ BufferedCanBuildFrom $outer;

                public final CC apply(ArrayBuffer<A> buff) {
                    return this.$outer.bufferToColl(buff);
                }
                {
                    if ($outer == null) {
                        throw null;
        ...
        public Builder<A, CC> apply(CC from2) {
            Builder<Object, Object> builder = from2 instanceof GenericTraversableTemplate ? ((GenericTraversableTemplate)from2).genericBuilder().mapResult(new Serializable(this){
                public static final long serialVersionUID = 0L;
                private final /* synthetic */ BufferedCanBuildFrom $outer;

                public final CC apply(Traversable<A> x0$1) {
                    return this.$outer.traversableToColl(x0$1);
                }
                {
                    if ($outer == null) {
                        throw null;
