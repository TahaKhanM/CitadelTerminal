...
extends OptManifest<T> {
    ...
    public boolean $less$colon$less(ClassTag<?> var1);

    public boolean $greater$colon$greater(ClassTag<?> var1);

    public boolean canEqual(Object var1);

    public <T> Class<Object> arrayClass(Class<?> var1);

    public ClassTag<Object> arrayManifest();

    public Object newArray(int var1);

    public Object[] newArray2(int var1);

    public Object[][] newArray3(int var1);

    public Object[][][] newArray4(int var1);

    public Object[][][][] newArray5(int var1);

    public WrappedArray<T> newWrappedArray(int var1);
