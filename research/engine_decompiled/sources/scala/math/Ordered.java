...
public interface Ordered<A>
extends Comparable<A> {
    public int compare(A var1);

    public boolean $less(A var1);

    public boolean $greater(A var1);

    public boolean $less$eq(A var1);

    public boolean $greater$eq(A var1);

    @Override
    public int compareTo(A var1);
}
