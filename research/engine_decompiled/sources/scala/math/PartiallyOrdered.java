...
public interface PartiallyOrdered<A> {
    ...
    public <B> boolean $less(B var1, Function1<B, PartiallyOrdered<B>> var2);

    public <B> boolean $greater(B var1, Function1<B, PartiallyOrdered<B>> var2);

    public <B> boolean $less$eq(B var1, Function1<B, PartiallyOrdered<B>> var2);

    public <B> boolean $greater$eq(B var1, Function1<B, PartiallyOrdered<B>> var2);
}
