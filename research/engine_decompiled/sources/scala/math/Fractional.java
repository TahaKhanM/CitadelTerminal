...
extends Numeric<T> {
    ...
    @Override
    public FractionalOps mkNumericOps(T var1);
    ...
    extends Numeric.Ops {
        ...
        public FractionalOps(Fractional<T> $outer, T lhs) {
            this.lhs = lhs;
            super($outer, lhs);
        }
    }
    ...
    public static interface ExtraImplicits {
        public <T> FractionalOps infixFractionalOps(T var1, Fractional<T> var2);
    }
}
