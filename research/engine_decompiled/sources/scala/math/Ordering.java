...
PartialOrdering<T> {
    public Some<Object> tryCompare(T var1, T var2);
    ...
    public <U> Ordering<U> on(Function1<U, T> var1);

    public Ops mkOrderingOps(T var1);
    ...
    public class Ops {
        ...
        public boolean $less(T rhs) {
            return this.scala$math$Ordering$Ops$$$outer().lt(this.lhs, rhs);
        }

        public boolean $less$eq(T rhs) {
            return this.scala$math$Ordering$Ops$$$outer().lteq(this.lhs, rhs);
        }

        public boolean $greater(T rhs) {
            return this.scala$math$Ordering$Ops$$$outer().gt(this.lhs, rhs);
        }

        public boolean $greater$eq(T rhs) {
            return this.scala$math$Ordering$Ops$$$outer().gteq(this.lhs, rhs);
        }

        public boolean equiv(T rhs) {
            return this.scala$math$Ordering$Ops$$$outer().equiv(this.lhs, rhs);
        }

        public T max(T rhs) {
            return this.scala$math$Ordering$Ops$$$outer().max(this.lhs, rhs);
        }

        public T min(T rhs) {
            return this.scala$math$Ordering$Ops$$$outer().min(this.lhs, rhs);
        }
        ...
        public Ops(Ordering<T> $outer, T lhs) {
            this.lhs = lhs;
            if ($outer == null) {
                throw null;
            }
    ...
    public static interface UnitOrdering
    extends Ordering<BoxedUnit> {
        @Override
        public int compare(BoxedUnit var1, BoxedUnit var2);
    }
    ...
    public static interface FloatOrdering
    extends Ordering<Object> {
        @Override
        public int compare(float var1, float var2);

        @Override
        public boolean lteq(float var1, float var2);

        @Override
        public boolean gteq(float var1, float var2);

        @Override
        public boolean lt(float var1, float var2);

        @Override
        public boolean gt(float var1, float var2);

        @Override
        public boolean equiv(float var1, float var2);
    ...
    public static interface ExtraImplicits {
        public <CC extends Seq<Object>, T> Ordering<CC> seqDerivedOrdering(Ordering<T> var1);

        public <T> Ops infixOrderingOps(T var1, Ordering<T> var2);
    }

    public static interface DoubleOrdering
    extends Ordering<Object> {
        @Override
        public int compare(double var1, double var3);

        @Override
        public boolean lteq(double var1, double var3);

        @Override
        public boolean gteq(double var1, double var3);

        @Override
        public boolean lt(double var1, double var3);

        @Override
        public boolean gt(double var1, double var3);

        @Override
        public boolean equiv(double var1, double var3);
    ...
    public static interface BigIntOrdering
    extends Ordering<BigInt> {
        @Override
        public int compare(BigInt var1, BigInt var2);
    }
    ...
    extends Ordering<Option<T>> {
        ...
        @Override
        public int compare(Option<T> var1, Option<T> var2);
    }
    ...
    public static interface BigDecimalOrdering
