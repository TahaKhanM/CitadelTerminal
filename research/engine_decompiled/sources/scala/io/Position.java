...
public abstract class Position {
    ...
    public final int encode(int line, int column) {
        ...
        return line >= 1048575 ? 2147481600 : line << 11 | package$.MODULE$.min(2047, column);
    }
    ...
    public String toString(int pos) {
        return new StringBuilder().append(this.line(pos)).append((Object)":").append(BoxesRunTime.boxToInteger(this.column(pos))).toString();
    }
}
