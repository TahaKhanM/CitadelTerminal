...
implements Product12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>,
Serializable {
    private final T1 _1;
    private final T2 _2;
    private final T3 _3;
    ...
    public int productArity() {
        return Product12$class.productArity(this);
    }

    @Override
    public Object productElement(int n) throws IndexOutOfBoundsException {
        return Product12$class.productElement(this, n);
    }
    ...
    public String toString() {
        return new StringBuilder().append((Object)"(").append(this._1()).append((Object)",").append(this._2()).append((Object)",").append(this._3()).append((Object)",").append(this._4()).append((Object)",").append(this._5()).append((Object)",").append(this._6()).append((Object)",").append(this._7()).append((Object)",").append(this._8()).append((Object)",").append(this._9()).append((Object)",").append(this._10()).append((Object)",").append(this._11()).append((Object)",").append(this._12()).append((Object)")").toString();
    }

    public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> copy(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6, T7 _7, T8 _8, T9 _9, T10 _10, T11 _11, T12 _12) {
    ...
    public boolean equals(Object x$1) {
        ...
        if (!(x$1 instanceof Tuple12)) return false;
        boolean bl13 = true;
        if (!bl13) return false;
        Tuple12 tuple12 = (Tuple12)x$1;
        T1 T1 = tuple12._1();
        T1 T12 = this._1();
        if (T12 == T1) {
            bl12 = true;
            ...
            bl12 = T12 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T12, T1) : (T12 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T12, T1) : T12.equals(T1));
        }
        ...
        if (T22 == T2) {
            ...
            bl11 = T22 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T22, T2) : (T22 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T22, T2) : T22.equals(T2));
        }
        ...
        if (T32 == T3) {
            ...
            bl10 = T32 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T32, T3) : (T32 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T32, T3) : T32.equals(T3));
        }
        ...
        if (T42 == T4) {
            ...
            bl9 = T42 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T42, T4) : (T42 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T42, T4) : T42.equals(T4));
        }
        if (!bl9) return false;
        T5 T5 = tuple12._5();
        T5 T52 = this._5();
        if (T52 == T5) {
            ...
            bl8 = T52 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T52, T5) : (T52 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T52, T5) : T52.equals(T5));
        }
        if (!bl8) return false;
        T6 T6 = tuple12._6();
        T6 T62 = this._6();
        if (T62 == T6) {
            ...
            bl7 = T62 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T62, T6) : (T62 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T62, T6) : T62.equals(T6));
        }
        if (!bl7) return false;
        T7 T7 = tuple12._7();
        T7 T72 = this._7();
        if (T72 == T7) {
            ...
            bl6 = T72 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T72, T7) : (T72 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T72, T7) : T72.equals(T7));
        }
        if (!bl6) return false;
        T8 T8 = tuple12._8();
        T8 T82 = this._8();
        if (T82 == T8) {
            ...
            bl5 = T82 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T82, T8) : (T82 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T82, T8) : T82.equals(T8));
        }
        if (!bl5) return false;
        T9 T9 = tuple12._9();
        T9 T92 = this._9();
        if (T92 == T9) {
            ...
            bl4 = T92 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T92, T9) : (T92 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T92, T9) : T92.equals(T9));
        }
        if (!bl4) return false;
        T10 T10 = tuple12._10();
        T10 T102 = this._10();
        if (T102 == T10) {
            ...
            bl3 = T102 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T102, T10) : (T102 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T102, T10) : T102.equals(T10));
        }
        if (!bl3) return false;
        T11 T11 = tuple12._11();
        T11 T112 = this._11();
        if (T112 == T11) {
            ...
            bl2 = T112 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T112, T11) : (T112 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T112, T11) : T112.equals(T11));
        }
        if (!bl2) return false;
        T12 T122 = tuple12._12();
        T12 T123 = this._12();
        if (T123 == T122) {
            bl = true;
        } else {
            ...
            bl = T123 instanceof Number ? BoxesRunTime.equalsNumObject((Number)T123, T122) : (T123 instanceof Character ? BoxesRunTime.equalsCharObject((Character)T123, T122) : T123.equals(T122));
        }
        if (!bl) return false;
        if (!tuple12.canEqual(this)) return false;
        return true;
    }
