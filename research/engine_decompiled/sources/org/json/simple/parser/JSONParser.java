...
public class JSONParser {
    ...
    public Object parse(String s2) throws ParseException {
        return this.parse(s2, (ContainerFactory)null);
    }

    public Object parse(String s2, ContainerFactory containerFactory) throws ParseException {
    ...
    public void parse(String s2, ContentHandler contentHandler) throws ParseException {
        this.parse(s2, contentHandler, false);
    }

    public void parse(String s2, ContentHandler contentHandler, boolean isResume) throws ParseException {
        StringReader in = new StringReader(s2);
        try {
