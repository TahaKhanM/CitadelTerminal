...
implements Framedata {
    ...
    public String toString() {
        return "Framedata{ optcode:" + String.valueOf((Object)this.getOpcode()) + ", fin:" + this.isFin() + ", rsv1:" + this.isRSV1() + ", rsv2:" + this.isRSV2() + ", rsv3:" + this.isRSV3() + ", payloadlength:[pos:" + this.unmaskedpayload.position() + ", len:" + this.unmaskedpayload.remaining() + "], payload:" + (this.unmaskedpayload.remaining() > 1000 ? "(too big to display)" : new String(this.unmaskedpayload.array())) + "}";
    }
    ...
    public int hashCode() {
        int result2 = this.fin ? 1 : 0;
        result2 = 31 * result2 + this.optcode.hashCode();
        result2 = 31 * result2 + (this.unmaskedpayload != null ? this.unmaskedpayload.hashCode() : 0);
        result2 = 31 * result2 + (this.transferemasked ? 1 : 0);
        result2 = 31 * result2 + (this.rsv1 ? 1 : 0);
        result2 = 31 * result2 + (this.rsv2 ? 1 : 0);
        result2 = 31 * result2 + (this.rsv3 ? 1 : 0);
        return result2;
    }
}
