...
extends Draft {
    ...
    public Draft copyInstance() {
        ...
        for (IExtension iExtension : this.getKnownExtensions()) {
    ...
    private TranslatedPayloadMetaData translateSingleFramePayloadLength(ByteBuffer buffer, Opcode optcode, int oldPayloadlength, int maxpacketsize, int oldRealpacketsize) throws InvalidFrameException, IncompleteException, LimitExceededException {
        ...
        if (payloadlength == 126) {
            ...
            long length = new BigInteger(bytes2).longValue();
    ...
    private void clearBufferList() {
        List<ByteBuffer> list2 = this.byteBufferList;
        synchronized (list2) {
    ...
    public String toString() {
        Object result2 = super.toString();
        if (this.getExtension() != null) {
            result2 = (String)result2 + " extension: " + this.getExtension().toString();
        }
        if (this.getProtocol() != null) {
            result2 = (String)result2 + " protocol: " + this.getProtocol().toString();
        }
        result2 = (String)result2 + " max frame size: " + this.maxFrameSize;
        return result2;
    }
    ...
    public int hashCode() {
        int result2 = this.extension != null ? this.extension.hashCode() : 0;
        result2 = 31 * result2 + (this.protocol != null ? this.protocol.hashCode() : 0);
        result2 = 31 * result2 + (this.maxFrameSize ^ this.maxFrameSize >>> 32);
        return result2;
    }
