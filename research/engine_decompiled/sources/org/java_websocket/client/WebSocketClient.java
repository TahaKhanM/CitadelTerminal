...
WebSocket {
    ...
    private void sendHandshake() throws InvalidHandshakeException {
        ...
        String host = this.uri.getHost() + (String)(port != 80 && port != 443 ? ":" + port : "");
    ...
    public final void onWebsocketClose(WebSocket conn, int code, String reason, boolean remote2) {
        ...
        this.onClose(code, reason, remote2);
        this.connectLatch.countDown();
    ...
    public void onWebsocketClosing(WebSocket conn, int code, String reason, boolean remote2) {
        this.onClosing(code, reason, remote2);
    }

    public void onCloseInitiated(int code, String reason) {
    }

    public void onClosing(int code, String reason, boolean remote2) {
    }
