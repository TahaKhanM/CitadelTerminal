...
Serializable {
    ...
    @FromString
    public static LocalDate parse(String string2) {
        return LocalDate.parse(string2, ISODateTimeFormat.localDateParser());
    }

    public static LocalDate parse(String string2, DateTimeFormatter dateTimeFormatter) {
        return dateTimeFormatter.parseLocalDate(string2);
    }
