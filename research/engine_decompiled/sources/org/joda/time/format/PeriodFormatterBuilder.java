...
public class PeriodFormatterBuilder {
    ...
    private PeriodFormatterBuilder appendSeparator(String string2, String string3, String[] stringArray, boolean bl, boolean bl2) {
        if (string2 == null || string3 == null) {
            throw new IllegalArgumentException();
        }
        this.clearPrefix();
        ...
        if (list2.size() == 0) {
            if (bl2 && !bl) {
                Separator separator = new Separator(string2, string3, stringArray, Literal.EMPTY, Literal.EMPTY, bl, bl2);
        ...
        int n = list2.size();
        while (--n >= 0) {
            if (list2.get(n) instanceof Separator) {
                separator = (Separator)list2.get(n);
        ...
        Object[] objectArray = PeriodFormatterBuilder.createComposite(list2);
        list2.clear();
        Separator separator2 = new Separator(string2, string3, stringArray, (PeriodPrinter)objectArray[0], (PeriodParser)objectArray[1], bl, bl2);
        list2.add(separator2);
        list2.add(separator2);
        return this;
    }
    ...
    private static PeriodFormatter toFormatter(List<Object> list2, boolean bl, boolean bl2) {
        Object object;
        if (bl && bl2) {
            throw new IllegalStateException("Builder has created neither a printer nor a parser");
        }
        int n = list2.size();
        if (n >= 2 && list2.get(0) instanceof Separator && ((Separator)(object = (Separator)list2.get(0))).iAfterParser == null && ((Separator)object).iAfterPrinter == null) {
            PeriodFormatter periodFormatter = PeriodFormatterBuilder.toFormatter(list2.subList(2, n), bl, bl2);
        ...
        object = PeriodFormatterBuilder.createComposite(list2);
        if (bl) {
    ...
    private static Object[] createComposite(List<Object> list2) {
        switch (list2.size()) {
            case 0: {
                return new Object[]{Literal.EMPTY, Literal.EMPTY};
            }
            case 1: {
                return new Object[]{list2.get(0), list2.get(1)};
            }
        }
        Composite composite = new Composite(list2);
    ...
    PeriodParser {
        ...
        Composite(List<Object> list2) {
            ArrayList<Object> arrayList = new ArrayList<Object>();
            ArrayList<Object> arrayList2 = new ArrayList<Object>();
            this.decompose(list2, arrayList, arrayList2);
        ...
        @Override
        public int parseInto(ReadWritablePeriod readWritablePeriod, String string2, int n, Locale locale) {
            ...
            for (int i = 0; i < n2 && n >= 0; ++i) {
                n = periodParserArray[i].parseInto(readWritablePeriod, string2, n, locale);
            }
            return n;
        }

        private void decompose(List<Object> list2, List<Object> list3, List<Object> list4) {
            int n = list2.size();
            for (int i = 0; i < n; i += 2) {
                Object object = list2.get(i);
                if (object instanceof PeriodPrinter) {
                    if (object instanceof Composite) {
                        this.addArrayToList(list3, ((Composite)object).iPrinters);
                    } else {
                        list3.add(object);
                    }
                }
                if (!((object = list2.get(i + 1)) instanceof PeriodParser)) continue;
                if (object instanceof Composite) {
                    this.addArrayToList(list4, ((Composite)object).iParsers);
                    continue;
                }
                list4.add(object);
            }
        ...
        private void addArrayToList(List<Object> list2, Object[] objectArray) {
            if (objectArray != null) {
    ...
    PeriodParser {
        ...
        Separator(String string2, String string3, String[] stringArray, PeriodPrinter periodPrinter, PeriodParser periodParser, boolean bl, boolean bl2) {
            this.iText = string2;
        ...
        public int parseInto(ReadWritablePeriod readWritablePeriod, String string2, int n, Locale locale) {
            int n2 = n;
            if ((n = this.iBeforeParser.parseInto(readWritablePeriod, string2, n, locale)) < 0) {
                return n;
            }
            boolean bl = false;
            int n3 = -1;
            if (n > n2) {
                for (String string3 : this.iParsedForms) {
                    if (string3 != null && string3.length() != 0 && !string2.regionMatches(true, n, string3, 0, string3.length())) continue;
            ...
            n2 = n;
            if ((n = this.iAfterParser.parseInto(readWritablePeriod, string2, n, locale)) < 0) {
                return n;
            }
            if (bl && n == n2 && n3 > 0) {
                return ~n2;
    ...
    PeriodParser {
        ...
        public int parseInto(ReadWritablePeriod readWritablePeriod, String string2, int n, Locale locale) {
            if (string2.regionMatches(true, n, this.iText, 0, this.iText.length())) {
    ...
    PeriodParser {
        ...
        public int parseInto(ReadWritablePeriod readWritablePeriod, String string2, int n, Locale locale) {
            ...
            if (this.iPrefix != null) {
                if ((n = this.iPrefix.parse(string2, n)) >= 0) {
                    bl = true;
                } else {
                    if (!bl) {
                        return ~n;
            ...
            if (this.iSuffix != null && !bl) {
                n3 = this.iSuffix.scan(string2, n);
                if (n3 >= 0) {
                    bl = true;
                } else {
                    if (!bl) {
            ...
            int n4 = n3 > 0 ? Math.min(this.iMaxParsedDigits, n3 - n) : Math.min(this.iMaxParsedDigits, string2.length() - n);
            int n5 = 0;
            int n6 = -1;
            boolean bl3 = false;
            boolean bl4 = false;
            while (n5 < n4) {
                n2 = string2.charAt(n + n5);
                if (!(n5 != 0 || n2 != 45 && n2 != 43 || this.iRejectSignedValues)) {
                    boolean bl5 = bl4 = n2 == 45;
                    if (n5 + 1 >= n4) break;
                    char c = string2.charAt(n + n5 + 1);
                    n2 = c;
                    if (c < '0' || n2 > 57) break;
                    if (bl4) {
                        ++n5;
                    ...
                    n4 = Math.min(n4 + 1, string2.length() - n);
                    continue;
                }
                if (n2 >= 48 && n2 <= 57) {
                    bl3 = true;
            ...
            if (this.iFieldType != 8 && this.iFieldType != 9) {
                this.setFieldValue(readWritablePeriod, this.iFieldType, this.parseInt(string2, n, n5));
            } else if (n6 < 0) {
                this.setFieldValue(readWritablePeriod, 6, this.parseInt(string2, n, n5));
                this.setFieldValue(readWritablePeriod, 7, 0);
            } else {
                int n7;
                n2 = this.parseInt(string2, n, n6 - n - 1);
                ...
                if (n8 <= 0) {
                    ...
                    if (n8 >= 3) {
                        n7 = this.parseInt(string2, n6, 3);
                    } else {
                        n7 = this.parseInt(string2, n6, n8);
            ...
            if ((n += n5) >= 0 && this.iSuffix != null) {
                n = this.iSuffix.parse(string2, n);
            }
            return n;
        }

        private int parseInt(String string2, int n, int n2) {
            boolean bl;
            if (n2 >= 10) {
                return Integer.parseInt(string2.substring(n, n + n2));
            }
            if (n2 <= 0) {
                return 0;
            }
            ...
            n3 -= 48;
            while (n2-- > 0) {
                n3 = (n3 << 3) + (n3 << 1) + string2.charAt(n++) - 48;
            }
            return bl ? -n3 : n3;
        }
    ...
    extends IgnorableAffix {
        ...
        CompositeAffix(PeriodFieldAffix periodFieldAffix, PeriodFieldAffix periodFieldAffix2) {
            ...
            for (String string2 : this.iLeft.getAffixes()) {
                for (String string3 : this.iRight.getAffixes()) {
        ...
        public int parse(String string2, int n) {
            int n2 = this.iLeft.parse(string2, n);
            if (n2 >= 0 && (n2 = this.iRight.parse(string2, n2)) >= 0 && this.matchesOtherAffix(this.parse(string2, n2) - n2, string2, n)) {
                return ~n;
            }
            return n2;
        }

        public int scan(String string2, int n) {
            int n2;
            int n3 = this.iLeft.scan(string2, n);
            if (!(n3 < 0 || (n2 = this.iRight.scan(string2, this.iLeft.parse(string2, n3))) >= 0 && this.matchesOtherAffix(this.iRight.parse(string2, n2) - n3, string2, n))) {
                if (n3 > 0) {
                    return n3;
                }
                return n2;
    ...
    extends IgnorableAffix {
        private static final Comparator<String> LENGTH_DESC_COMPARATOR = new Comparator<String>(){
            ...
            public int compare(String string2, String string3) {
                return string3.length() - string2.length();
            }
        };
        ...
        private int selectSuffixIndex(int n) {
            ...
            for (int i = 0; i < this.iPatterns.length; ++i) {
                if (!this.iPatterns[i].matcher(string2).matches()) continue;
                return i;
            }
        ...
        public int parse(String string2, int n) {
            for (String string3 : this.iSuffixesSortedDescByLength) {
                if (!string2.regionMatches(true, n, string3, 0, string3.length()) || this.matchesOtherAffix(string3.length(), string2, n)) continue;
        ...
        public int scan(String string2, int n) {
            ...
            for (int i = n; i < n2; ++i) {
                for (String string3 : this.iSuffixesSortedDescByLength) {
                    if (!string2.regionMatches(true, i, string3, 0, string3.length()) || this.matchesOtherAffix(string3.length(), string2, i)) continue;
                    return i;
                }
            }
            return ~n;
    ...
    extends IgnorableAffix {
        ...
        public int parse(String string2, int n) {
            String string3 = this.iPluralText;
            String string4 = this.iSingularText;
            if (string3.length() < string4.length()) {
                String string5 = string3;
                string3 = string4;
                string4 = string5;
            }
            if (string2.regionMatches(true, n, string3, 0, string3.length()) && !this.matchesOtherAffix(string3.length(), string2, n)) {
                return n + string3.length();
            }
            if (string2.regionMatches(true, n, string4, 0, string4.length()) && !this.matchesOtherAffix(string4.length(), string2, n)) {
                return n + string4.length();
            }
            return ~n;
        }
        ...
        public int scan(String string2, int n) {
            ...
            for (int i = n; i < n4; ++i) {
                if (string2.regionMatches(true, i, string3, 0, n2) && !this.matchesOtherAffix(string3.length(), string2, i)) {
                    return i;
                }
                if (!string2.regionMatches(true, i, string4, 0, n3) || this.matchesOtherAffix(string4.length(), string2, i)) continue;
                return i;
            }
            return ~n;
        }
    ...
    extends IgnorableAffix {
        ...
        public int parse(String string2, int n) {
            ...
            int n2 = string3.length();
            if (string2.regionMatches(true, n, string3, 0, n2) && !this.matchesOtherAffix(n2, string2, n)) {
                return n + n2;
            }
            return ~n;
        }
        ...
        public int scan(String string2, int n) {
            ...
            block3: for (int i = n; i < n3; ++i) {
                if (string2.regionMatches(true, i, string3, 0, n2) && !this.matchesOtherAffix(n2, string2, i)) {
                    return i;
                }
    ...
    implements PeriodFieldAffix {
        ...
        public void finish(Set<PeriodFieldAffix> set) {
            if (this.iOtherAffixes == null) {
                ...
                for (PeriodFieldAffix periodFieldAffix : set) {
                    ...
                    for (String string2 : periodFieldAffix.getAffixes()) {
                        if (string2.length() <= n && (!string2.equalsIgnoreCase(stringArray) || string2.equals(stringArray))) continue;
                        hashSet.add(string2);
                    }
                }
        ...
        protected boolean matchesOtherAffix(int n, String string2, int n2) {
            if (this.iOtherAffixes != null) {
                for (String string3 : this.iOtherAffixes) {
                    int n3 = string3.length();
                    if ((n >= n3 || !string2.regionMatches(true, n2, string3, 0, n3)) && (n != n3 || !string2.regionMatches(false, n2, string3, 0, n3))) continue;
                    return true;
                }
            }
            return false;
