...
public class PeriodFormat {
    ...
    private static PeriodFormatter buildRegExFormatter(ResourceBundle resourceBundle, Locale locale) {
        ...
        String string2 = resourceBundle.getString("PeriodFormat.regex.separator");
        PeriodFormatterBuilder periodFormatterBuilder = new PeriodFormatterBuilder();
        periodFormatterBuilder.appendYears();
        if (PeriodFormat.containsKey(resourceBundle, "PeriodFormat.years.regex")) {
            periodFormatterBuilder.appendSuffix(resourceBundle.getString("PeriodFormat.years.regex").split(string2), resourceBundle.getString("PeriodFormat.years.list").split(string2));
        } else {
        ...
        if (PeriodFormat.containsKey(resourceBundle, "PeriodFormat.months.regex")) {
            periodFormatterBuilder.appendSuffix(resourceBundle.getString("PeriodFormat.months.regex").split(string2), resourceBundle.getString("PeriodFormat.months.list").split(string2));
        } else {
        ...
        if (PeriodFormat.containsKey(resourceBundle, "PeriodFormat.weeks.regex")) {
            periodFormatterBuilder.appendSuffix(resourceBundle.getString("PeriodFormat.weeks.regex").split(string2), resourceBundle.getString("PeriodFormat.weeks.list").split(string2));
        } else {
        ...
        if (PeriodFormat.containsKey(resourceBundle, "PeriodFormat.days.regex")) {
            periodFormatterBuilder.appendSuffix(resourceBundle.getString("PeriodFormat.days.regex").split(string2), resourceBundle.getString("PeriodFormat.days.list").split(string2));
        } else {
        ...
        if (PeriodFormat.containsKey(resourceBundle, "PeriodFormat.hours.regex")) {
            periodFormatterBuilder.appendSuffix(resourceBundle.getString("PeriodFormat.hours.regex").split(string2), resourceBundle.getString("PeriodFormat.hours.list").split(string2));
        } else {
        ...
        if (PeriodFormat.containsKey(resourceBundle, "PeriodFormat.minutes.regex")) {
            periodFormatterBuilder.appendSuffix(resourceBundle.getString("PeriodFormat.minutes.regex").split(string2), resourceBundle.getString("PeriodFormat.minutes.list").split(string2));
        } else {
        ...
        if (PeriodFormat.containsKey(resourceBundle, "PeriodFormat.seconds.regex")) {
            periodFormatterBuilder.appendSuffix(resourceBundle.getString("PeriodFormat.seconds.regex").split(string2), resourceBundle.getString("PeriodFormat.seconds.list").split(string2));
        } else {
        ...
        if (PeriodFormat.containsKey(resourceBundle, "PeriodFormat.milliseconds.regex")) {
            periodFormatterBuilder.appendSuffix(resourceBundle.getString("PeriodFormat.milliseconds.regex").split(string2), resourceBundle.getString("PeriodFormat.milliseconds.list").split(string2));
        } else {
    ...
    private static boolean containsKey(ResourceBundle resourceBundle, String string2) {
        Enumeration<String> enumeration = resourceBundle.getKeys();
        while (enumeration.hasMoreElements()) {
            if (!enumeration.nextElement().equals(string2)) continue;
            return true;
        }
        return false;
    }
    ...
    PeriodParser {
        ...
        public int parseInto(ReadWritablePeriod readWritablePeriod, String string2, int n, Locale locale) {
            return this.getParser(locale).parseInto(readWritablePeriod, string2, n, locale);
        }
