...
public class DateTimeFormatterBuilder {
    ...
    public DateTimeFormatterBuilder appendTimeZoneName(Map<String, DateTimeZone> map2) {
        TimeZoneName timeZoneName = new TimeZoneName(0, map2);
    ...
    public DateTimeFormatterBuilder appendTimeZoneShortName(Map<String, DateTimeZone> map2) {
        TimeZoneName timeZoneName = new TimeZoneName(1, map2);
        return this.append0(timeZoneName, timeZoneName);
    }
    ...
    static int csCompare(CharSequence charSequence, int n, String string2) {
        int n2 = charSequence.length() - n;
        int n3 = string2.length();
        int n4 = Math.min(n2, n3);
        for (int i = 0; i < n4; ++i) {
            int n5 = string2.charAt(i) - charSequence.charAt(n + i);
            if (n5 == 0) continue;
            return n5;
        }
        return n3 - n2;
    ...
    static boolean csStartsWith(CharSequence charSequence, int n, String string2) {
        ...
        for (int i = 0; i < n2; ++i) {
            if (charSequence.charAt(n + i) == string2.charAt(i)) continue;
            return false;
        }
        return true;
    }
    ...
    static boolean csStartsWithIgnoreCase(CharSequence charSequence, int n, String string2) {
        ...
        for (int i = 0; i < n2; ++i) {
            ...
            if (c4 == (c3 = string2.charAt(i)) || (c2 = Character.toUpperCase(c4)) == (c = Character.toUpperCase(c3)) || Character.toLowerCase(c2) == Character.toLowerCase(c)) continue;
            return false;
        }
        return true;
    }
    ...
    InternalParser
    {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int n) {
            ...
            String string2;
            String string3 = null;
            for (int i = n2 = TimeZoneId.prefixedStartPosition(charSequence, n); i < ALL_IDS.size() && DateTimeFormatterBuilder.csStartsWith(charSequence, n, string2 = ALL_IDS.get(i)); ++i) {
                if (string3 != null && string2.length() <= string3.length()) continue;
                string3 = string2;
            }
            if (string3 != null) {
                dateTimeParserBucket.setZone(DateTimeZone.forID(string3));
                return n + string3.length();
            }
            return ~n;
        }

        private static int prefixedStartPosition(CharSequence charSequence, int n) {
            int n2 = 0;
            int n3 = ALL_IDS.size() - 1;
            while (n2 <= n3) {
                int n4 = n2 + n3 >>> 1;
                String string2 = ALL_IDS.get(n4);
                int n5 = DateTimeFormatterBuilder.csCompare(charSequence, n, string2);
                if (n5 > 0) {
                    n3 = n4 - 1;
                    continue;
                }
    ...
    InternalParser {
        ...
        TimeZoneName(int n, Map<String, DateTimeZone> map2) {
            this.iType = n;
            this.iParseLookup = map2;
        }
        ...
        @Override
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int n) {
            Map<String, DateTimeZone> map2 = this.iParseLookup;
            map2 = map2 != null ? map2 : DateTimeUtils.getDefaultTimeZoneNames();
            String string2 = null;
            for (String string3 : map2.keySet()) {
                if (!DateTimeFormatterBuilder.csStartsWith(charSequence, n, string3) || string2 != null && string3.length() <= string2.length()) continue;
                string2 = string3;
            }
            if (string2 != null) {
                dateTimeParserBucket.setZone(map2.get(string2));
    ...
    InternalParser {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int n) {
            ...
            if (map3 == null) {
                map3 = new ConcurrentHashMap<DateTimeFieldType, Object[]>();
                cParseCache.put(locale, map3);
            }
            if ((objectArray = map3.get(this.iFieldType)) == null) {
                ...
                objectArray = new Object[]{map2, n3};
                map3.put(this.iFieldType, objectArray);
            } else {
                map2 = (Map)objectArray[0];
                n3 = (Integer)objectArray[1];
            }
            for (int i = n2 = Math.min(charSequence.length(), n + n3); i > n; --i) {
                String string2 = ((Object)charSequence.subSequence(n, i)).toString();
                if (!map2.containsKey(string2)) continue;
                dateTimeParserBucket.saveField(this.iFieldType, string2, locale);
                return i;
            }
            return ~n;
        }
    ...
    InternalParser {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int n) {
            ...
            if (!this.iLenientParse) {
                ...
                if (n4 != 0 || n3 != 2) {
                    if (n3 >= 9) {
                        n2 = Integer.parseInt(((Object)charSequence.subSequence(n, n += n3)).toString());
                    } else {
                        int n6 = n;
                        if (c != '\u0000') {
                            ++n6;
    ...
    InternalParser {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int n) {
            ...
            if (n4 >= 9) {
                n2 = bl2 ? Integer.parseInt(((Object)charSequence.subSequence(n + 1, n += n4)).toString()) : Integer.parseInt(((Object)charSequence.subSequence(n, n += n4)).toString());
            } else {
                int n5 = n;
                if (bl || bl2) {
                    ++n5;
