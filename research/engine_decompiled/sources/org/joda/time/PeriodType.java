...
implements Serializable {
    ...
    public static synchronized PeriodType forFields(DurationFieldType[] durationFieldTypeArray) {
        ...
        Map<PeriodType, Object> map2 = cTypes;
        if (map2.isEmpty()) {
            map2.put(PeriodType.standard(), PeriodType.standard());
            map2.put(PeriodType.yearMonthDayTime(), PeriodType.yearMonthDayTime());
            map2.put(PeriodType.yearMonthDay(), PeriodType.yearMonthDay());
            map2.put(PeriodType.yearWeekDayTime(), PeriodType.yearWeekDayTime());
            map2.put(PeriodType.yearWeekDay(), PeriodType.yearWeekDay());
            map2.put(PeriodType.yearDayTime(), PeriodType.yearDayTime());
            map2.put(PeriodType.yearDay(), PeriodType.yearDay());
            map2.put(PeriodType.dayTime(), PeriodType.dayTime());
            map2.put(PeriodType.time(), PeriodType.time());
            map2.put(PeriodType.years(), PeriodType.years());
            map2.put(PeriodType.months(), PeriodType.months());
            map2.put(PeriodType.weeks(), PeriodType.weeks());
            map2.put(PeriodType.days(), PeriodType.days());
            map2.put(PeriodType.hours(), PeriodType.hours());
            map2.put(PeriodType.minutes(), PeriodType.minutes());
            map2.put(PeriodType.seconds(), PeriodType.seconds());
            map2.put(PeriodType.millis(), PeriodType.millis());
        }
        if ((object = map2.get(periodType = new PeriodType(null, durationFieldTypeArray, null))) instanceof PeriodType) {
        ...
        if (arrayList.size() > 0) {
            map2.put(periodType, arrayList);
            throw new IllegalArgumentException("PeriodType does not support fields: " + arrayList);
        }
        PeriodType periodType3 = new PeriodType(null, periodType2.iTypes, null);
        PeriodType periodType4 = (PeriodType)map2.get(periodType3);
        if (periodType4 != null) {
            map2.put(periodType3, periodType4);
            return periodType4;
        }
        map2.put(periodType3, periodType2);
        return periodType2;
    }
    ...
    private PeriodType withFieldRemoved(int n, String string2) {
        int n2 = this.iIndices[n];
        if (n2 == -1) {
            return this;
        }
