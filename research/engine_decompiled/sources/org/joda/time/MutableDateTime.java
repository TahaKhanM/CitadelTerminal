...
Serializable {
    ...
    @FromString
    public static MutableDateTime parse(String string2) {
        return MutableDateTime.parse(string2, ISODateTimeFormat.dateTimeParser().withOffsetParsed());
    }

    public static MutableDateTime parse(String string2, DateTimeFormatter dateTimeFormatter) {
        return dateTimeFormatter.parseDateTime(string2).toMutableDateTime();
    }
    ...
    extends AbstractReadableInstantFieldProperty {
        ...
        public MutableDateTime set(String string2, Locale locale) {
            this.iInstant.setMillis(this.getField().set(this.iInstant.getMillis(), string2, locale));
            return this.iInstant;
        }

        public MutableDateTime set(String string2) {
            this.set(string2, null);
            return this.iInstant;
        }
