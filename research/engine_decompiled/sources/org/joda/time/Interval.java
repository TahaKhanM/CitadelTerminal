...
Serializable {
    ...
    public static Interval parseWithOffset(String string2) {
        ...
        if (c == 'P' || c == 'p') {
            ...
            period = periodFormatter.withParseType(PeriodType.standard()).parsePeriod(string4);
            return new Interval((ReadableInstant)dateTime, period);
        }
        DateTime dateTime2 = dateTimeFormatter.parseDateTime(string4);
        if (period != null) {
