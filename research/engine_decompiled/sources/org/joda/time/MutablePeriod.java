...
Serializable {
    ...
    @FromString
    public static MutablePeriod parse(String string2) {
        return MutablePeriod.parse(string2, ISOPeriodFormat.standard());
    }

    public static MutablePeriod parse(String string2, PeriodFormatter periodFormatter) {
        return periodFormatter.parsePeriod(string2).toMutablePeriod();
    }
