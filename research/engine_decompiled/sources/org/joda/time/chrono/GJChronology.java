...
extends AssembledChronology {
    ...
    extends BaseDateTimeField {
        ...
        public long set(long l, String string2, Locale locale) {
            if (l >= this.iCutover) {
                if ((l = this.iGregorianField.set(l, string2, locale)) < this.iCutover && l + GJChronology.this.iGapDuration < this.iCutover) {
                    l = this.gregorianToJulian(l);
                }
            } else if ((l = this.iJulianField.set(l, string2, locale)) >= this.iCutover && l - GJChronology.this.iGapDuration >= this.iCutover) {
                l = this.julianToGregorian(l);
            }
            return l;
        }
