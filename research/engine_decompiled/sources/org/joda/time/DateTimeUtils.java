...
public class DateTimeUtils {
    ...
    public static final Map<String, DateTimeZone> getDefaultTimeZoneNames() {
        Map<String, DateTimeZone> map2 = cZoneNames.get();
        if (map2 == null && !cZoneNames.compareAndSet(null, map2 = DateTimeUtils.buildDefaultTimeZoneNames())) {
            map2 = cZoneNames.get();
        }
        return map2;
    }

    public static final void setDefaultTimeZoneNames(Map<String, DateTimeZone> map2) {
        cZoneNames.set(Collections.unmodifiableMap(new HashMap<String, DateTimeZone>(map2)));
    }
    ...
    private static void put(Map<String, DateTimeZone> map2, String string2, String string3) {
        try {
            map2.put(string2, DateTimeZone.forID(string3));
        }
