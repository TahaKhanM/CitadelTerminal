...
implements Serializable {
    ...
    public long set(long l, String string2, Locale locale) {
        return this.iField.set(l, string2, locale);
    }

    public long set(long l, String string2) {
        return this.iField.set(l, string2);
    }
    ...
    public int[] set(ReadablePartial readablePartial, int n, int[] nArray, String string2, Locale locale) {
        return this.iField.set(readablePartial, n, nArray, string2, locale);
    }
