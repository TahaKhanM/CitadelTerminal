...
Serializable {
    ...
    @FromString
    public static LocalDateTime parse(String string2) {
        return LocalDateTime.parse(string2, ISODateTimeFormat.localDateOptionalTimeParser());
    }

    public static LocalDateTime parse(String string2, DateTimeFormatter dateTimeFormatter) {
        return dateTimeFormatter.parseLocalDateTime(string2);
    }
    ...
    extends AbstractReadableInstantFieldProperty {
        ...
        public LocalDateTime setCopy(String string2, Locale locale) {
            return this.iInstant.withLocalMillis(this.iField.set(this.iInstant.getLocalMillis(), string2, locale));
        }

        public LocalDateTime setCopy(String string2) {
