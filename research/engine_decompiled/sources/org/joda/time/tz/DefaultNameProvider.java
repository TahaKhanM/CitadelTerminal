...
implements NameProvider {
    ...
    public String getShortName(Locale locale, String string2, String string3) {
        String[] stringArray = this.getNameSet(locale, string2, string3);
        return stringArray == null ? null : stringArray[0];
    }

    public String getName(Locale locale, String string2, String string3) {
        String[] stringArray = this.getNameSet(locale, string2, string3);
        return stringArray == null ? null : stringArray[1];
    }

    private synchronized String[] getNameSet(Locale locale, String string2, String string3) {
        HashMap hashMap;
        if (locale == null || string2 == null || string3 == null) {
            return null;
        }
        ...
        if ((hashMap = hashMap2.get(string2)) == null) {
            ...
            for (String[] stringArray3 : stringArray) {
                if (stringArray3 == null || stringArray3.length < 5 || !string2.equals(stringArray3[0])) continue;
            ...
            for (String[] stringArray6 : stringArray4) {
                if (stringArray6 == null || stringArray6.length < 5 || !string2.equals(stringArray6[0])) continue;
    ...
    public String getShortName(Locale locale, String string2, String string3, boolean bl) {
        String[] stringArray = this.getNameSet(locale, string2, string3, bl);
        return stringArray == null ? null : stringArray[0];
    }

    public String getName(Locale locale, String string2, String string3, boolean bl) {
        String[] stringArray = this.getNameSet(locale, string2, string3, bl);
        return stringArray == null ? null : stringArray[1];
    }

    private synchronized String[] getNameSet(Locale locale, String string2, String string3, boolean bl) {
        HashMap hashMap;
        HashMap hashMap2;
        if (locale == null || string2 == null || string3 == null) {
            return null;
        }
        if (string2.startsWith("Etc/")) {
