...
public class DateTimeZoneBuilder {
    ...
    private static DateTimeZone buildFixedZone(String string2, String string3, int n, int n2) {
        if ("UTC".equals(string2) && string2.equals(string3) && n == 0 && n2 == 0) {
            return DateTimeZone.UTC;
        }
        return new FixedDateTimeZone(string2, string3, n, n2);
    }
    ...
    public DateTimeZoneBuilder setFixedSavings(String string2, int n) {
        this.getLastRuleSet().setFixedSavings(string2, n);
        return this;
    }

    public DateTimeZoneBuilder addRecurringSavings(String string2, int n, int n2, int n3, char c, int n4, int n5, int n6, boolean bl, int n7) {
        if (n2 <= n3) {
            OfYear ofYear = new OfYear(c, n4, n5, n6, bl, n7);
            Recurrence recurrence = new Recurrence(ofYear, string2, n);
    ...
    public DateTimeZone toDateTimeZone(String string2, boolean bl) {
        if (string2 == null) {
        ...
        for (int i = 0; i < n2; ++i) {
            ...
            while (!((transition = ruleSet.nextTransition(l, n)) == null || this.addTransition(arrayList, transition) && dSTZone != null)) {
                ...
                dSTZone = ruleSet.buildTailZone(string2);
            }
        ...
        if (arrayList.size() == 0) {
            ...
            return DateTimeZoneBuilder.buildFixedZone(string2, "UTC", 0, 0);
        }
        if (arrayList.size() == 1 && dSTZone == null) {
            Transition transition = (Transition)arrayList.get(0);
            return DateTimeZoneBuilder.buildFixedZone(string2, transition.getNameKey(), transition.getWallOffset(), transition.getStandardOffset());
        }
        PrecalculatedZone precalculatedZone = PrecalculatedZone.create(string2, bl, arrayList, dSTZone);
    ...
    public void writeTo(String string2, OutputStream outputStream) throws IOException {
        if (outputStream instanceof DataOutput) {
            ...
            this.writeTo(string2, dataOutputStream);
    ...
    extends DateTimeZone {
        ...
        static PrecalculatedZone readFrom(DataInput dataInput, String string2) throws IOException {
            int n;
            ...
            if (dataInput.readBoolean()) {
                dSTZone = DSTZone.readFrom(dataInput, string2);
            }
            return new PrecalculatedZone(string2, lArray, nArray, nArray2, stringArray2, dSTZone);
        }

        static PrecalculatedZone create(String string2, boolean bl, ArrayList<Transition> arrayList, DSTZone dSTZone) {
            String[][] stringArray;
            int n = arrayList.size();
            if (n == 0) {
                throw new IllegalArgumentException();
            ...
            for (int i = 0; i < stringArray.length; ++i) {
                ...
                if (stringArray5 == null || stringArray5.length != 5 || !string2.equals(stringArray5[0])) continue;
            ...
            for (int i = 0; i < stringArray2.length - 1; ++i) {
                ...
                if (l == l2 || l3 != l4 || !string3.equals(string4) || period.getYears() != 0 || period.getMonths() <= 4 || period.getMonths() >= 8 || !string3.equals(stringArray4[2]) || !string3.equals(stringArray4[4])) continue;
                if (ZoneInfoLogger.verbose()) {
                    System.out.println("Fixing duplicate name key - " + string4);
                    System.out.println("     - " + new DateTime(lArray[i], (Chronology)iSOChronology) + " - " + new DateTime(lArray[i + 1], (Chronology)iSOChronology));
                }
                if (l > l2) {
                    stringArray2[i] = (string3 + "-Summer").intern();
                    continue;
                }
                if (l >= l2) continue;
                stringArray2[i + 1] = (string4 + "-Summer").intern();
                ++i;
            }
            ...
            return new PrecalculatedZone(bl ? string2 : "", lArray, nArray, nArray2, stringArray2, dSTZone);
        }
        ...
        public void writeTo(DataOutput dataOutput) throws IOException {
            ...
            while (iterator2.hasNext()) {
                stringArray[n3] = (String)iterator2.next();
                ++n3;
            }
            ...
            block3: for (n3 = 0; n3 < n2; ++n3) {
                ...
                String string2 = this.iNameKeys[n3];
                for (int i = 0; i < n; ++i) {
    ...
    private static final class RuleSet {
        ...
        public void setFixedSavings(String string2, int n) {
        ...
        public Transition nextTransition(long l, int n) {
            ...
            Iterator<Rule> iterator2 = this.iRules.iterator();
            while (iterator2.hasNext()) {
    ...
    private static final class Transition {
        ...
        Transition(long l, String string2, int n, int n2) {
            this.iMillis = l;
