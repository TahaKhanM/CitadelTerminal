...
extends DateTimeZone {
    ...
    private Info getInfo(long l) {
        ...
        Info info2 = infoArray[n2];
        if (info2 == null || (int)(info2.iPeriodStart >> 32) != n) {
            infoArray[n2] = info2 = this.createInfo(l);
        }
        return info2;
    }
    ...
    private Info createInfo(long l) {
        ...
        Info info2 = new Info(this.iZone, l3);
        long l4 = l3 | 0xFFFFFFFFL;
        Info info3 = info2;
        while ((l2 = this.iZone.nextTransition(l3)) != l3 && l2 <= l4) {
            l3 = l2;
            info3 = info3.iNextInfo = new Info(this.iZone, l3);
        }
        return info2;
    }
