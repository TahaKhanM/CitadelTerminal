...
public class FilenameUtils {
    ...
    private static String doNormalize(String filename, char separator, boolean keepSeparator) {
        ...
        for (i = prefix + 1; i < size2; ++i) {
            if (array[i] != separator || array[i - 1] != separator) continue;
            System.arraycopy(array, i, array, i - 1, size2 - i);
            --size2;
            --i;
        }
        for (i = prefix + 1; i < size2; ++i) {
            ...
            System.arraycopy(array, i + 1, array, i - 1, size2 - i);
            size2 -= 2;
            --i;
        }
        block3: for (i = prefix + 2; i < size2; ++i) {
            ...
            for (int j = i - 4; j >= prefix; --j) {
                ...
                System.arraycopy(array, i + 1, array, j + 1, size2 - i);
                size2 -= i - j;
                i = j + 1;
                continue block3;
            }
            System.arraycopy(array, i + 1, array, prefix, size2 - i);
            size2 -= i + 1 - prefix;
            i = prefix + 1;
        }
        if (size2 <= 0) {
    ...
    public static boolean isExtension(String filename, String extension2) {
        if (filename == null) {
            return false;
        }
        FilenameUtils.failIfNullBytePresent(filename);
        ...
        return fileExt.equals(extension2);
    }
    ...
    public static boolean isExtension(String filename, String[] extensions) {
        ...
        for (String extension2 : extensions) {
            if (!fileExt.equals(extension2)) continue;
            return true;
        }
        return false;
    }
