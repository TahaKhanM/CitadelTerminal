...
extends InputStream {
    ...
    public NullInputStream(long size2, boolean markSupported, boolean throwEofException) {
        this.size = size2;
    ...
    @Override
    public int read(byte[] bytes2) throws IOException {
    ...
    public int read(byte[] bytes2, int offset, int length) throws IOException {
        ...
        this.processBytes(bytes2, offset, returnLength);
        return returnLength;
    }
    ...
    protected void processBytes(byte[] bytes2, int offset, int length) {
    }
