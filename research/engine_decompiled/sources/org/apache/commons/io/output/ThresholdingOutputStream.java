...
extends OutputStream {
    ...
    protected void checkThreshold(int count2) throws IOException {
        if (!this.thresholdExceeded && this.written + (long)count2 > (long)this.threshold) {
    ...
    protected void setByteCount(long count2) {
        this.written = count2;
    }
