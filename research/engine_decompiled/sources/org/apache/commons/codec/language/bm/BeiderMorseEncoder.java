...
implements StringEncoder {
    ...
    public void setConcat(boolean concat2) {
        this.engine = new PhoneticEngine(this.engine.getNameType(), this.engine.getRuleType(), concat2, this.engine.getMaxPhonemes());
    }
