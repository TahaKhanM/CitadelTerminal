...
implements StringEncoder {
    ...
    public String colognePhonetic(String text) {
        ...
        CologneInputBuffer input2 = new CologneInputBuffer(text.toCharArray());
        char lastChar = '-';
        int lastCode = 47;
        int rightLength = input2.length();
        while (rightLength > 0) {
            int code;
            char chr = input2.removeNext();
            rightLength = input2.length();
            char nextChar = rightLength > 0 ? (char)input2.getNextChar() : (char)'-';
