...
BinaryDecoder {
    ...
    protected byte[] ensureBufferSize(int size2, Context context) {
        if (context.buffer == null || context.buffer.length < context.pos + size2) {
    ...
    public byte[] decode(byte[] pArray) {
        ...
        byte[] result2 = new byte[context.pos];
        this.readResults(result2, 0, result2.length, context);
        return result2;
    }
