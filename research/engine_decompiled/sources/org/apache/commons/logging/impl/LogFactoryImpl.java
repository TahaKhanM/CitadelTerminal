...
extends LogFactory {
    ...
    protected Log newInstance(String name) throws LogConfigurationException {
        try {
            ...
            if (this.logConstructor == null) {
                ...
                params2 = new Object[]{name};
                instance = (Log)this.logConstructor.newInstance(params2);
            }
            if (this.logMethod != null) {
                params2 = new Object[]{this};
                this.logMethod.invoke((Object)instance, params2);
            }
            return instance;
        }
    ...
    private Log createLogFromClass(String logAdapterClassName, String logCategory, boolean affectState) throws LogConfigurationException {
        ...
        Object[] params2 = new Object[]{logCategory};
        Log logAdapter = null;
        ...
        while (true) {
            ...
            try {
                ...
                Object o = constructor.newInstance(params2);
                if (o instanceof Log) {
                    logAdapterClass = c;
                    logAdapter = (Log)o;
                    break;
