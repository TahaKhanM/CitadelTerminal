...
public abstract class LogFactory {
    ...
    private static final Hashtable createFactoryStore() {
        ...
        block7: {
            ...
            try {
                ...
                result2 = (Hashtable)implementationClass.newInstance();
            }
            catch (Throwable t) {
    ...
    protected static LogFactory newFactory(final String factoryClass, final ClassLoader classLoader, ClassLoader contextClassLoader) throws LogConfigurationException {
        Object result2 = AccessController.doPrivileged(new PrivilegedAction(){
        ...
        if (LogFactory.isDiagnosticsEnabled()) {
            LogFactory.logDiagnostic("Created object " + LogFactory.objectId(result2) + " to manage classloader " + LogFactory.objectId(contextClassLoader));
        }
    ...
    private static Enumeration getResources(final ClassLoader loader, final String name) {
        ...
        Object result2 = AccessController.doPrivileged(action);
        return (Enumeration)result2;
    }
