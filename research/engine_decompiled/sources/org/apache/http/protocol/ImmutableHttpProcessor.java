...
implements HttpProcessor {
    ...
    public ImmutableHttpProcessor(HttpRequestInterceptorList requestInterceptors, HttpResponseInterceptorList responseInterceptors) {
        ...
        int count2;
        if (requestInterceptors != null) {
            count2 = requestInterceptors.getRequestInterceptorCount();
            this.requestInterceptors = new HttpRequestInterceptor[count2];
            for (i = 0; i < count2; ++i) {
        ...
        if (responseInterceptors != null) {
            count2 = responseInterceptors.getResponseInterceptorCount();
