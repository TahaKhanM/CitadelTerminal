...
Cloneable {
    ...
    @Override
    public void setInterceptors(List<?> list2) {
        Args.notNull(list2, "Inteceptor list");
        this.requestInterceptors.clear();
        this.responseInterceptors.clear();
    ...
    public BasicHttpProcessor copy() {
        BasicHttpProcessor clone2 = new BasicHttpProcessor();
        this.copyInterceptors(clone2);
        return clone2;
    }

    public Object clone() throws CloneNotSupportedException {
        BasicHttpProcessor clone2 = (BasicHttpProcessor)super.clone();
        this.copyInterceptors(clone2);
        return clone2;
    }
}
