...
LayeredSocketFactory {
    ...
    @Override
    public Socket createSocket(HttpParams params2) throws IOException {
    ...
    @Override
    public Socket connectSocket(Socket socket, InetSocketAddress remoteAddress, InetSocketAddress localAddress, HttpParams params2) throws IOException, UnknownHostException, ConnectTimeoutException {
        ...
        int socketTimeout = HttpConnectionParams.getSoTimeout(params2);
        int connectTimeout = HttpConnectionParams.getConnectionTimeout(params2);
    ...
    @Override
    public Socket createLayeredSocket(Socket socket, String host, int port, HttpParams params2) throws IOException, UnknownHostException {
    ...
    @Override
    public Socket connectSocket(Socket socket, String host, int port, InetAddress local, int localPort, HttpParams params2) throws IOException, UnknownHostException, ConnectTimeoutException {
        InetAddress remote2 = this.nameResolver != null ? this.nameResolver.resolve(host) : InetAddress.getByName(host);
        InetSocketAddress localAddress = null;
        if (local != null || localPort > 0) {
            localAddress = new InetSocketAddress(local, localPort > 0 ? localPort : 0);
        }
        HttpInetSocketAddress remoteAddress = new HttpInetSocketAddress(new HttpHost(host, port), remote2, port);
        return this.connectSocket(socket, remoteAddress, localAddress, params2);
    }
