...
implements SocketFactory {
    ...
    @Override
    public Socket connectSocket(Socket socket, String host, int port, InetAddress localAddress, int localPort, HttpParams params2) throws IOException {
        ...
        int timeout = HttpConnectionParams.getConnectionTimeout(params2);
