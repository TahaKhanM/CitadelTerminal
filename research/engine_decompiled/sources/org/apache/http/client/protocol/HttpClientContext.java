...
extends HttpCoreContext {
    ...
    public void setCookieSpecRegistry(Lookup<CookieSpecProvider> lookup2) {
        this.setAttribute(COOKIESPEC_REGISTRY, lookup2);
    }
    ...
    public void setAuthSchemeRegistry(Lookup<AuthSchemeProvider> lookup2) {
        this.setAttribute(AUTHSCHEME_REGISTRY, lookup2);
    }
