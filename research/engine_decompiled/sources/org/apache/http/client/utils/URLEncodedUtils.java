...
public class URLEncodedUtils {
    ...
    public static List<NameValuePair> parse(String s2, Charset charset, char ... separators) {
        if (s2 == null) {
            return Collections.emptyList();
        }
        CharArrayBuffer buffer = new CharArrayBuffer(s2.length());
    ...
    public static List<NameValuePair> parse(CharArrayBuffer buf, Charset charset, char ... separators) {
        ...
        while (!cursor.atEnd()) {
            ...
            list2.add(new BasicNameValuePair(URLEncodedUtils.decodeFormFields(name, charset), URLEncodedUtils.decodeFormFields(value, charset)));
        }
        return list2;
    }
    ...
    public static String format(List<? extends NameValuePair> parameters, char parameterSeparator, String charset) {
        ...
        for (NameValuePair nameValuePair : parameters) {
            ...
            if (result2.length() > 0) {
                result2.append(parameterSeparator);
            }
