...
implements ConnFactory<HttpHost, HttpClientConnection> {
    ...
    @Deprecated
    public BasicConnFactory(SSLSocketFactory sslfactory, HttpParams params2) {
        Args.notNull(params2, "HTTP params");
        this.plainfactory = null;
        this.sslfactory = sslfactory;
        this.connectTimeout = params2.getIntParameter("http.connection.timeout", 0);
        this.sconfig = HttpParamConfig.getSocketConfig(params2);
        this.connFactory = new DefaultBHttpClientConnectionFactory(HttpParamConfig.getConnectionConfig(params2));
    }

    @Deprecated
    public BasicConnFactory(HttpParams params2) {
        this(null, params2);
    }
    ...
    @Deprecated
    protected HttpClientConnection create(Socket socket, HttpParams params2) throws IOException {
        int bufsize = params2.getIntParameter("http.socket.buffer-size", 8192);
