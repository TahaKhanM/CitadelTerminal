...
implements HttpServerConnection {
    ...
    protected HttpMessageParser<HttpRequest> createRequestParser(SessionInputBuffer buffer, HttpRequestFactory requestFactory, HttpParams params2) {
        return new DefaultHttpRequestParser(buffer, null, requestFactory, params2);
    }

    protected HttpMessageWriter<HttpResponse> createResponseWriter(SessionOutputBuffer buffer, HttpParams params2) {
        return new HttpResponseWriter(buffer, null, params2);
    }
    ...
    protected void init(SessionInputBuffer inbuffer, SessionOutputBuffer outbuffer, HttpParams params2) {
        ...
        this.requestParser = this.createRequestParser(inbuffer, this.createHttpRequestFactory(), params2);
        this.responseWriter = this.createResponseWriter(outbuffer, params2);
