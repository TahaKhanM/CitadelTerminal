...
extends AuthSchemeBase {
    ...
    protected byte[] generateGSSToken(byte[] input2, Oid oid, String authServer) throws GSSException {
        return this.generateGSSToken(input2, oid, authServer, null);
    }

    protected byte[] generateGSSToken(byte[] input2, Oid oid, String authServer, Credentials credentials) throws GSSException {
        ...
        if (input2 != null) {
            return gssContext.initSecContext(input2, 0, input2.length);
        }
    ...
    @Deprecated
    protected byte[] generateToken(byte[] input2, String authServer) throws GSSException {
        return null;
    }

    protected byte[] generateToken(byte[] input2, String authServer, Credentials credentials) throws GSSException {
        return this.generateToken(input2, authServer);
    }
