...
extends RFC2617Scheme {
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest request) throws AuthenticationException {
        ...
        params2.add(new BasicNameValuePair("response", digest));
        if (qop != 0) {
        ...
        params2.add(new BasicNameValuePair("algorithm", algorithm));
        if (opaque != null) {
        ...
        for (int i = 0; i < params2.size(); ++i) {
            ...
            boolean noQuotes = "nc".equals(name = param2.getName()) || "qop".equals(name) || "algorithm".equals(name);
            BasicHeaderValueFormatter.INSTANCE.formatNameValuePair(buffer, param2, !noQuotes);
        }
