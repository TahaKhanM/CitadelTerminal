...
implements NTLMEngine {
    ...
    static class HMACMD5 {
        ...
        HMACMD5(byte[] input2) throws NTLMEngineException {
            int i;
            byte[] key = input2;
            try {
    ...
    static class MD4 {
        ...
        byte[] getOutput() {
            ...
            NTLMEngineImpl.writeULong(result2, this.A, 0);
            NTLMEngineImpl.writeULong(result2, this.B, 4);
            NTLMEngineImpl.writeULong(result2, this.C, 8);
            NTLMEngineImpl.writeULong(result2, this.D, 12);
            return result2;
        }
    ...
    extends NTLMMessage {
        ...
        Type3Message(String domain, String host, String user, String password, byte[] nonce, int type2Flags, String target, byte[] targetInformation) throws NTLMEngineException {
            ...
            this.userBytes = user.getBytes(UNICODE_LITTLE_UNMARKED);
        }
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(String messageBody, int expectedType) throws NTLMEngineException {
            this.messageContents = Base64.decodeBase64(messageBody.getBytes(DEFAULT_CHARSET));
