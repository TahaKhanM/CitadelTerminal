...
implements HttpMessageParser<T> {
    ...
    @Deprecated
    public AbstractMessageParser(SessionInputBuffer buffer, LineParser parser, HttpParams params2) {
        Args.notNull(buffer, "Session input buffer");
        Args.notNull(params2, "HTTP parameters");
        this.sessionBuffer = buffer;
        this.messageConstraints = HttpParamConfig.getMessageConstraints(params2);
