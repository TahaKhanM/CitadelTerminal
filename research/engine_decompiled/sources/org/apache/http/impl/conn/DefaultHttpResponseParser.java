...
extends AbstractMessageParser<HttpResponse> {
    ...
    @Deprecated
    public DefaultHttpResponseParser(SessionInputBuffer buffer, LineParser parser, HttpResponseFactory responseFactory, HttpParams params2) {
    ...
    protected HttpResponse parseHead(SessionInputBuffer sessionBuffer) throws IOException, HttpException {
        ...
        while (true) {
            ...
            if (i == -1 || this.reject(this.lineBuf, count2)) {
    ...
    protected boolean reject(CharArrayBuffer line, int count2) {
        return false;
    }
}
