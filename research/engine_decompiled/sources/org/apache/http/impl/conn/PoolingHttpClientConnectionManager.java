...
Closeable {
        ...
        synchronized (httpClientConnection) {
            ...
            block8: {
                ...
                try {
                    ...
                    String s2 = keepalive > 0L ? "for " + (double)effectiveUnit.toMillis(keepalive) / 1000.0 + " seconds" : "indefinitely";
    ...
    public void setDefaultMaxPerRoute(int max2) {
        this.pool.setDefaultMaxPerRoute(max2);
    }
    ...
    @Override
    public void setMaxPerRoute(HttpRoute route, int max2) {
        this.pool.setMaxPerRoute(route, max2);
    }
