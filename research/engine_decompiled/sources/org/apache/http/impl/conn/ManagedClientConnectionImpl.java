...
implements ManagedClientConnection {
    ...
    public SSLSession getSSLSession() {
        OperatedClientConnection conn = this.ensureConnection();
        SSLSession result2 = null;
        Socket sock = conn.getSocket();
        if (sock instanceof SSLSocket) {
            result2 = ((SSLSocket)sock).getSession();
        }
        return result2;
    }
    ...
    public void open(HttpRoute route, HttpContext context, HttpParams params2) throws IOException {
        ...
        this.operator.openConnection(conn, proxy != null ? proxy : route.getTargetHost(), route.getLocalAddress(), context, params2);
    ...
    public void tunnelTarget(boolean secure, HttpParams params2) throws IOException {
        ...
        conn.update(null, target, secure, params2);
    ...
    public void tunnelProxy(HttpHost next2, boolean secure, HttpParams params2) throws IOException {
        ...
        conn.update(null, next2, secure, params2);
        managedClientConnectionImpl = this;
        synchronized (managedClientConnectionImpl) {
            if (this.poolEntry == null) {
                throw new InterruptedIOException();
            ...
            tracker = this.poolEntry.getTracker();
            tracker.tunnelProxy(next2, secure);
        }
    }
    ...
    public void layerProtocol(HttpContext context, HttpParams params2) throws IOException {
        ...
        this.operator.updateSecureConnection(conn, target, context, params2);
        managedClientConnectionImpl = this;
        synchronized (managedClientConnectionImpl) {
            if (this.poolEntry == null) {
                throw new InterruptedIOException();
