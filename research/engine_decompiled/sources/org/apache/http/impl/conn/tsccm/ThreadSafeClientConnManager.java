...
implements ClientConnectionManager {
    ...
    @Deprecated
    public ThreadSafeClientConnManager(HttpParams params2, SchemeRegistry schreg) {
        Args.notNull(schreg, "Scheme registry");
        this.log = LogFactory.getLog(this.getClass());
        this.schemeRegistry = schreg;
        this.connPerRoute = new ConnPerRouteBean();
        this.connOperator = this.createConnectionOperator(schreg);
        this.pool = (ConnPoolByRoute)this.createConnectionPool(params2);
        this.connectionPool = this.pool;
    }
    ...
    @Deprecated
    protected AbstractConnPool createConnectionPool(HttpParams params2) {
        return new ConnPoolByRoute(this.connOperator, params2);
    }
    ...
    public void setMaxTotal(int max2) {
        this.pool.setMaxTotalConnections(max2);
    }
    ...
    public void setDefaultMaxPerRoute(int max2) {
        this.connPerRoute.setDefaultMaxPerRoute(max2);
    }
    ...
    public void setMaxForRoute(HttpRoute route, int max2) {
        this.connPerRoute.setMaxForRoute(route, max2);
    }
}
