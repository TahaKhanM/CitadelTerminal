...
extends AbstractConnPool {
    ...
    @Deprecated
    public ConnPoolByRoute(ClientConnectionOperator operator, HttpParams params2) {
        this(operator, ConnManagerParams.getMaxConnectionsPerRoute(params2), ConnManagerParams.getMaxTotalConnections(params2));
    }
    ...
    public void closeIdleConnections(long idletime, TimeUnit tunit) {
        ...
        if (this.log.isDebugEnabled()) {
            this.log.debug("Closing connections idle longer than " + t + " " + (Object)((Object)tunit));
        }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public void setMaxTotalConnections(int max2) {
        this.poolLock.lock();
        try {
            this.maxTotalConnections = max2;
        }
        finally {
            this.poolLock.unlock();
        }
