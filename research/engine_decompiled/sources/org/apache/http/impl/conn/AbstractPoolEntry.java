...
public abstract class AbstractPoolEntry {
    ...
    public void open(HttpRoute route, HttpContext context, HttpParams params2) throws IOException {
        ...
        this.connOperator.openConnection(this.connection, proxy != null ? proxy : route.getTargetHost(), route.getLocalAddress(), context, params2);
    ...
    public void tunnelProxy(HttpHost next2, boolean secure, HttpParams params2) throws IOException {
        ...
        Asserts.notNull(this.tracker, "Route tracker");
        Asserts.check(this.tracker.isConnected(), "Connection not open");
        this.connection.update(null, next2, secure, params2);
        this.tracker.tunnelProxy(next2, secure);
    }
    ...
    public void layerProtocol(HttpContext context, HttpParams params2) throws IOException {
        ...
        this.connOperator.updateSecureConnection(this.connection, target, context, params2);
