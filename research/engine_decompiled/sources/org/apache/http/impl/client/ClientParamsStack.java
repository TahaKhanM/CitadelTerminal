...
extends AbstractHttpParams {
    ...
    public Object getParameter(String name) {
        ...
        if (this.overrideParams != null) {
            result2 = this.overrideParams.getParameter(name);
        }
        if (result2 == null && this.requestParams != null) {
            result2 = this.requestParams.getParameter(name);
        }
        if (result2 == null && this.clientParams != null) {
            result2 = this.clientParams.getParameter(name);
        }
        if (result2 == null && this.applicationParams != null) {
            result2 = this.applicationParams.getParameter(name);
        }
        return result2;
    }
