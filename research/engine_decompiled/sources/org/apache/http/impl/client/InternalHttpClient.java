    ...
    protected CloseableHttpResponse doExecute(HttpHost target, HttpRequest request, HttpContext context) throws IOException, ClientProtocolException {
        ...
        try {
            ...
            if (config == null) {
                ...
                if (params2 instanceof HttpParamsNames) {
                    if (!((HttpParamsNames)((Object)params2)).getNames().isEmpty()) {
                        config = HttpClientParamConfig.getRequestConfig(params2, this.defaultConfig);
                    }
                } else {
                    config = HttpClientParamConfig.getRequestConfig(params2, this.defaultConfig);
                }
