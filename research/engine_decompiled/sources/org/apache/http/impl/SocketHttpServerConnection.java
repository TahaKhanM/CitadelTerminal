...
implements HttpInetConnection {
    ...
    protected SessionInputBuffer createSessionInputBuffer(Socket socket, int buffersize, HttpParams params2) throws IOException {
        return new SocketInputBuffer(socket, buffersize, params2);
    }
    ...
    protected SessionOutputBuffer createSessionOutputBuffer(Socket socket, int buffersize, HttpParams params2) throws IOException {
        return new SocketOutputBuffer(socket, buffersize, params2);
    }

    protected void bind(Socket socket, HttpParams params2) throws IOException {
        Args.notNull(socket, "Socket");
        Args.notNull(params2, "HTTP parameters");
        this.socket = socket;
        int buffersize = params2.getIntParameter("http.socket.buffer-size", -1);
        this.init(this.createSessionInputBuffer(socket, buffersize, params2), this.createSessionOutputBuffer(socket, buffersize, params2), params2);
        this.open = true;
    }
