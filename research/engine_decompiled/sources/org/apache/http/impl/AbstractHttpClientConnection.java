...
implements HttpClientConnection {
    ...
    protected HttpMessageWriter<HttpRequest> createRequestWriter(SessionOutputBuffer buffer, HttpParams params2) {
        return new HttpRequestWriter(buffer, null, params2);
    }
    ...
    protected void init(SessionInputBuffer inbuffer, SessionOutputBuffer outbuffer, HttpParams params2) {
        ...
        this.responseParser = this.createResponseParser(inbuffer, this.createHttpResponseFactory(), params2);
        this.requestWriter = this.createRequestWriter(outbuffer, params2);
