...
implements Serializable {
    ...
    void removeInternal(Node<K, V> node, boolean unlink2) {
        if (unlink2) {
    ...
    private void rebalance(Node<K, V> unbalanced, boolean insert2) {
        ...
        while (node != null) {
            ...
            if (delta == -2) {
                ...
                if (rightDelta == -1 || rightDelta == 0 && !insert2) {
                ...
                if (leftDelta == 1 || leftDelta == 0 && !insert2) {
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        ...
        return result2 != null ? result2 : (this.entrySet = new EntrySet());
    }

    @Override
    public Set<K> keySet() {
        KeySet result2 = this.keySet;
        return result2 != null ? result2 : (this.keySet = new KeySet());
    }
    ...
    static class AvlIterator<K, V> {
        ...
        public Node<K, V> next() {
            ...
            Node<K, V> result2 = stackTop;
            stackTop = result2.parent;
            result2.parent = null;
            Node n = result2.right;
            while (n != null) {
                n.parent = stackTop;
                stackTop = n;
                n = n.left;
    ...
    implements Map.Entry<K, V> {
        ...
        Node(Node<K, V> parent, K key, int hash, Node<K, V> next2, Node<K, V> prev) {
            this.parent = parent;
            this.key = key;
            this.hash = hash;
            this.height = 1;
