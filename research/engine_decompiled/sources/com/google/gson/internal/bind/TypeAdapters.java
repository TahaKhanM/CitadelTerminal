...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<AtomicIntegerArray> ATOMIC_INTEGER_ARRAY = new TypeAdapter<AtomicIntegerArray>(){
        ...
        public AtomicIntegerArray read(JsonReader in) throws IOException {
            ...
            for (int i = 0; i < length; ++i) {
                array.set(i, (Integer)list2.get(i));
            }
            return array;
        }
    ...
    public static final TypeAdapter<URL> URL = new TypeAdapter<URL>(){
        ...
        public URL read(JsonReader in) throws IOException {
            ...
            return "null".equals(nextString2) ? null : new URL(nextString2);
        }
    ...
    public static final TypeAdapter<URI> URI = new TypeAdapter<URI>(){
        ...
        public URI read(JsonReader in) throws IOException {
            ...
            try {
                String nextString2 = in.nextString();
                return "null".equals(nextString2) ? null : new URI(nextString2);
            }
            ...
            public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
                ...
                return new TypeAdapter<T1>(){
                    ...
                    public T1 read(JsonReader in) throws IOException {
                        Object result2 = typeAdapter.read(in);
                        if (result2 != null && !requestedType.isInstance(result2)) {
                            throw new JsonSyntaxException("Expected a " + requestedType.getName() + " but was " + result2.getClass().getName());
                        }
                        return result2;
                    }
                };
