...
extends JsonReader {
    private static final Reader UNREADABLE_READER = new Reader(){
        ...
        @Override
        public int read(char[] buffer, int offset, int count2) throws IOException {
    ...
    private Object popStack() {
        Object result2 = this.stack[--this.stackSize];
    ...
    public String nextName() throws IOException {
        ...
        this.pathNames[this.stackSize - 1] = result2 = (String)entry.getKey();
    ...
    public String nextString() throws IOException {
        ...
        String result2 = ((JsonPrimitive)this.popStack()).getAsString();
        if (this.stackSize > 0) {
            int n = this.stackSize - 1;
            this.pathIndices[n] = this.pathIndices[n] + 1;
        }
    ...
    public boolean nextBoolean() throws IOException {
        ...
        boolean result2 = ((JsonPrimitive)this.popStack()).getAsBoolean();
        if (this.stackSize > 0) {
            int n = this.stackSize - 1;
            this.pathIndices[n] = this.pathIndices[n] + 1;
        }
    ...
    public double nextDouble() throws IOException {
        ...
        double result2 = ((JsonPrimitive)this.peekStack()).getAsDouble();
        if (!this.isLenient() && (Double.isNaN(result2) || Double.isInfinite(result2))) {
            throw new NumberFormatException("JSON forbids NaN and infinities: " + result2);
        }
        this.popStack();
        if (this.stackSize > 0) {
            int n = this.stackSize - 1;
    ...
    public long nextLong() throws IOException {
        ...
        long result2 = ((JsonPrimitive)this.peekStack()).getAsLong();
        this.popStack();
        if (this.stackSize > 0) {
            int n = this.stackSize - 1;
            this.pathIndices[n] = this.pathIndices[n] + 1;
    ...
    public int nextInt() throws IOException {
        ...
        int result2 = ((JsonPrimitive)this.peekStack()).getAsInt();
        this.popStack();
        if (this.stackSize > 0) {
            int n = this.stackSize - 1;
            this.pathIndices[n] = this.pathIndices[n] + 1;
