...
implements Closeable {
        ...
        block6: while (true) {
            ...
            switch (c) {
                ...
                default: {
                    ...
                    if (last2 != 5 && last2 != 6) break;
                    last2 = 7;
                }
            }
            ++i;
        }
        if (last2 == 2 && fitsInLong && (value != Long.MIN_VALUE || negative)) {
            this.peekedLong = negative ? value : -value;
            this.pos += i;
            this.peeked = 15;
            return 15;
        }
        if (last2 == 2 || last2 == 4 || last2 == 7) {
    ...
    public double nextDouble() throws IOException {
        ...
        if (!this.lenient && (Double.isNaN(result2) || Double.isInfinite(result2))) {
            throw new MalformedJsonException("JSON forbids NaN and infinities: " + result2 + this.locationString());
        }
        this.peekedString = null;
        this.peeked = 0;
        int n = this.stackSize - 1;
    ...
    private String nextUnquotedValue() throws IOException {
        ...
        if (builder == null) {
            result2 = new String(this.buffer, this.pos, i);
        } else {
            builder.append(this.buffer, this.pos, i);
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        this.pos = 0;
        while ((total2 = this.in.read(buffer, this.limit, buffer.length - this.limit)) != -1) {
            this.limit += total2;
    ...
    private char readEscapeCharacter() throws IOException {
        ...
        char escaped2 = this.buffer[this.pos++];
        switch (escaped2) {
            case 'u': {
                int i;
