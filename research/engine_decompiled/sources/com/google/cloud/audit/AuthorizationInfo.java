...
implements AuthorizationInfoOrBuilder {
    ...
    private static final Parser<AuthorizationInfo> PARSER = new AbstractParser<AuthorizationInfo>(){

        @Override
        public AuthorizationInfo parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new AuthorizationInfo(input2, extensionRegistry);
        }
    };
    ...
    private AuthorizationInfo(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public void writeTo(CodedOutputStream output) throws IOException {
        ...
        if (!this.getPermissionBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 2, this.permission_);
        }
        if (this.granted_) {
            output.writeBool(3, this.granted_);
        }
    ...
    public int getSerializedSize() {
        ...
        if (!this.getPermissionBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(2, this.permission_);
        }
        if (this.granted_) {
            size2 += CodedOutputStream.computeBoolSize(3, this.granted_);
        }
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getPermission().equals(other.getPermission());
        result2 = result2 && this.getGranted() == other.getGranted();
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AuthorizationInfo.getDescriptor().hashCode();
        hash = 37 * hash + 1;
        hash = 53 * hash + this.getResource().hashCode();
        hash = 37 * hash + 2;
        hash = 53 * hash + this.getPermission().hashCode();
        hash = 37 * hash + 3;
        hash = 53 * hash + Internal.hashBoolean(this.getGranted());
    ...
    public static AuthorizationInfo parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static AuthorizationInfo parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static AuthorizationInfo parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static AuthorizationInfo parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static AuthorizationInfo parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static AuthorizationInfo parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements AuthorizationInfoOrBuilder {
        ...
        public AuthorizationInfo build() {
            AuthorizationInfo result2 = this.buildPartial();
        ...
        public AuthorizationInfo buildPartial() {
            AuthorizationInfo result2 = new AuthorizationInfo(this);
            result2.resource_ = this.resource_;
            result2.permission_ = this.permission_;
            result2.granted_ = this.granted_;
            this.onBuilt();
            return result2;
        }
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof AuthorizationInfo) {
                return this.mergeFrom((AuthorizationInfo)other);
            }
        ...
        public Builder mergeFrom(AuthorizationInfo other) {
            if (other == AuthorizationInfo.getDefaultInstance()) {
                return this;
            }
            ...
            if (other.getGranted()) {
                this.setGranted(other.getGranted());
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (AuthorizationInfo)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setResourceBytes(ByteString value) {
            ...
            AuthorizationInfo.checkByteStringIsUtf8(value);
            this.resource_ = value;
            this.onChanged();
            return this;
        }
