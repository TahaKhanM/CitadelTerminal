...
public final class MediaType {
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new Function<Collection<String>, ImmutableMultiset<String>>(){
            ...
            @Override
            public ImmutableMultiset<String> apply(Collection<String> input2) {
                return ImmutableMultiset.copyOf(input2);
            }
        });
    }
    ...
    public static MediaType parse(String input2) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Could not parse '" + input2 + "'", e);
        }
    }
    ...
    public String toString() {
        ...
        if (result2 == null) {
            this.toString = result2 = this.computeToString();
        }
        return result2;
    }
    ...
    private static String escapeAndQuote(String value) {
        StringBuilder escaped2 = new StringBuilder(value.length() + 16).append('\"');
        ...
        return escaped2.append('\"').toString();
    }
