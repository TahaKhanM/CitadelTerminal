...
implements Runnable {
    ...
    static <X extends Throwable, V> ListenableFuture<V> create(ListenableFuture<? extends V> input2, Class<X> exceptionType, Function<? super X, ? extends V> fallback) {
        CatchingFuture<? extends V, ? super X> future = new CatchingFuture<V, X>(input2, exceptionType, fallback);
        input2.addListener(future, MoreExecutors.directExecutor());
        return future;
    }

    static <V, X extends Throwable> ListenableFuture<V> create(ListenableFuture<? extends V> input2, Class<X> exceptionType, Function<? super X, ? extends V> fallback, Executor executor) {
        CatchingFuture<? extends V, ? super X> future = new CatchingFuture<V, X>(input2, exceptionType, fallback);
        input2.addListener(future, MoreExecutors.rejectionPropagatingExecutor(executor, future));
        return future;
    }

    static <X extends Throwable, V> ListenableFuture<V> create(ListenableFuture<? extends V> input2, Class<X> exceptionType, AsyncFunction<? super X, ? extends V> fallback) {
        AsyncCatchingFuture<? extends V, ? super X> future = new AsyncCatchingFuture<V, X>(input2, exceptionType, fallback);
        input2.addListener(future, MoreExecutors.directExecutor());
        return future;
    }

    static <X extends Throwable, V> ListenableFuture<V> create(ListenableFuture<? extends V> input2, Class<X> exceptionType, AsyncFunction<? super X, ? extends V> fallback, Executor executor) {
        AsyncCatchingFuture<? extends V, ? super X> future = new AsyncCatchingFuture<V, X>(input2, exceptionType, fallback);
        input2.addListener(future, MoreExecutors.rejectionPropagatingExecutor(executor, future));
        return future;
    }
    ...
    extends AbstractCatchingFuture<V, X, Function<? super X, ? extends V>, V> {
        CatchingFuture(ListenableFuture<? extends V> input2, Class<X> exceptionType, Function<? super X, ? extends V> fallback) {
            super(input2, exceptionType, fallback);
        }
    ...
    extends AbstractCatchingFuture<V, X, AsyncFunction<? super X, ? extends V>, ListenableFuture<? extends V>> {
        AsyncCatchingFuture(ListenableFuture<? extends V> input2, Class<X> exceptionType, AsyncFunction<? super X, ? extends V> fallback) {
            super(input2, exceptionType, fallback);
        }
