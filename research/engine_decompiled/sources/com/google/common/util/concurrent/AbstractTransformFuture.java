...
implements Runnable {
    ...
    static <I, O> ListenableFuture<O> create(ListenableFuture<I> input2, AsyncFunction<? super I, ? extends O> function) {
        AsyncTransformFuture<? super I, ? extends O> output = new AsyncTransformFuture<I, O>(input2, function);
        input2.addListener(output, MoreExecutors.directExecutor());
        return output;
    }

    static <I, O> ListenableFuture<O> create(ListenableFuture<I> input2, AsyncFunction<? super I, ? extends O> function, Executor executor) {
        Preconditions.checkNotNull(executor);
        AsyncTransformFuture<? super I, ? extends O> output = new AsyncTransformFuture<I, O>(input2, function);
        input2.addListener(output, MoreExecutors.rejectionPropagatingExecutor(executor, output));
        return output;
    }

    static <I, O> ListenableFuture<O> create(ListenableFuture<I> input2, Function<? super I, ? extends O> function) {
        Preconditions.checkNotNull(function);
        TransformFuture<? super I, ? extends O> output = new TransformFuture<I, O>(input2, function);
        input2.addListener(output, MoreExecutors.directExecutor());
        return output;
    }

    static <I, O> ListenableFuture<O> create(ListenableFuture<I> input2, Function<? super I, ? extends O> function, Executor executor) {
        Preconditions.checkNotNull(function);
        TransformFuture<? super I, ? extends O> output = new TransformFuture<I, O>(input2, function);
        input2.addListener(output, MoreExecutors.rejectionPropagatingExecutor(executor, output));
        return output;
    ...
    extends AbstractTransformFuture<I, O, Function<? super I, ? extends O>, O> {
        ...
        @Override
        @Nullable
        O doTransform(Function<? super I, ? extends O> function, @Nullable I input2) {
    ...
    extends AbstractTransformFuture<I, O, AsyncFunction<? super I, ? extends O>, ListenableFuture<? extends O>> {
        ...
        @Override
        ListenableFuture<? extends O> doTransform(AsyncFunction<? super I, ? extends O> function, @Nullable I input2) throws Exception {
            ListenableFuture<? extends O> outputFuture = function.apply(input2);
