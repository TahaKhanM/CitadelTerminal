...
implements RunnableFuture<V> {
    ...
    static <V> TrustedListenableFutureTask<V> create(Runnable runnable, @Nullable V result2) {
        return new TrustedListenableFutureTask<V>(Executors.callable(runnable, result2));
    }
