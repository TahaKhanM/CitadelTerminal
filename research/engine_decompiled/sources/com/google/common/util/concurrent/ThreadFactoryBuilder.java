...
public final class ThreadFactoryBuilder {
    ...
    private static ThreadFactory build(ThreadFactoryBuilder builder) {
        ...
        return new ThreadFactory(){
            ...
            public Thread newThread(Runnable runnable) {
                ...
                if (nameFormat != null) {
                    thread.setName(ThreadFactoryBuilder.format(nameFormat, new Object[]{count2.getAndIncrement()}));
                }
                if (daemon != null) {
    ...
    private static String format(String format2, Object ... args) {
        return String.format(Locale.ROOT, format2, args);
    }
}
