...
implements Function<A, B> {
    ...
    @CanIgnoreReturnValue
    public Iterable<B> convertAll(final Iterable<? extends A> fromIterable2) {
        Preconditions.checkNotNull(fromIterable2, "fromIterable");
        return new Iterable<B>(){
            ...
            public Iterator<B> iterator() {
                return new Iterator<B>(){
                    ...
                    {
                        this.fromIterator = fromIterable2.iterator();
                    }
    ...
    public Converter<B, A> reverse() {
        Converter<A, B> result2 = this.reverse;
        return result2 == null ? (this.reverse = new ReverseConverter(this)) : result2;
    }
