...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.is('-'), "-"){
        ...
        @Override
        String convert(CaseFormat format2, String s2) {
            ...
            return super.convert(format2, s2);
        }
    }
    ,
    ...
    String convert(CaseFormat format2, String s2) {
        ...
        while (true) {
            ...
            if (i == 0) {
                ...
                out.append(format2.normalizeFirstWord(s2.substring(i, j)));
            } else {
                out.append(format2.normalizeWord(s2.substring(i, j)));
            }
            out.append(format2.wordSeparator);
            i = j + this.wordSeparator.length();
        }
        return i == 0 ? format2.normalizeFirstWord(s2) : out.append(format2.normalizeWord(s2.substring(i))).toString();
    }
