...
public final class Floats {
    ...
    public static float[] ensureCapacity(float[] array, int minLength, int padding2) {
    ...
    Serializable {
        ...
        public int hashCode() {
            ...
            for (int i = this.start; i < this.end; ++i) {
                result2 = 31 * result2 + Floats.hashCode(this.array[i]);
            }
            return result2;
        }
    ...
    private static enum LexicographicalComparator implements Comparator<float[]>
    {
        ...
        public int compare(float[] left, float[] right) {
            ...
            for (int i = 0; i < minLength; ++i) {
                int result2 = Float.compare(left[i], right[i]);
