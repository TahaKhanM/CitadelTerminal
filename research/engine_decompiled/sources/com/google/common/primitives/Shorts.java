...
public final class Shorts {
    ...
    @GwtIncompatible
    public static short fromByteArray(byte[] bytes2) {
        Preconditions.checkArgument(bytes2.length >= 2, "array too small: %s < %s", bytes2.length, 2);
        return Shorts.fromBytes(bytes2[0], bytes2[1]);
    }
    ...
    public static short[] ensureCapacity(short[] array, int minLength, int padding2) {
