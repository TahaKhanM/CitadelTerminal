...
Serializable {
    ...
    public static UnsignedLong fromLongBits(long bits2) {
        return new UnsignedLong(bits2);
    }
    ...
    @CanIgnoreReturnValue
    public static UnsignedLong valueOf(String string2, int radix) {
        return UnsignedLong.fromLongBits(UnsignedLongs.parseUnsignedLong(string2, radix));
    }
