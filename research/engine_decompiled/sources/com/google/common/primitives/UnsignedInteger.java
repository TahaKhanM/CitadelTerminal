...
implements Comparable<UnsignedInteger> {
    ...
    public static UnsignedInteger fromIntBits(int bits2) {
        return new UnsignedInteger(bits2);
    }
    ...
    public static UnsignedInteger valueOf(String string2, int radix) {
        return UnsignedInteger.fromIntBits(UnsignedInts.parseUnsignedInt(string2, radix));
    }
