...
public final class Doubles {
    ...
    public static double[] ensureCapacity(double[] array, int minLength, int padding2) {
    ...
    public static Double tryParse(String string2) {
        if (FLOATING_POINT_PATTERN.matcher(string2).matches()) {
            try {
    ...
    Serializable {
        ...
        public int hashCode() {
            ...
            for (int i = this.start; i < this.end; ++i) {
                result2 = 31 * result2 + Doubles.hashCode(this.array[i]);
            }
            return result2;
        }
    ...
    private static enum LexicographicalComparator implements Comparator<double[]>
    {
        ...
        public int compare(double[] left, double[] right) {
            ...
            for (int i = 0; i < minLength; ++i) {
                int result2 = Double.compare(left[i], right[i]);
