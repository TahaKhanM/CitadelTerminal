...
implements GenericDeclaration {
    ...
    extends Invokable<T, T> {
        ...
        Type getGenericReturnType() {
            ...
            Type[] typeParams2 = declaringClass.getTypeParameters();
            if (typeParams2.length > 0) {
                return Types.newParameterizedType(declaringClass, typeParams2);
            }
        ...
        public final TypeVariable<?>[] getTypeParameters() {
            ...
            TypeVariable[] result2 = new TypeVariable[declaredByClass.length + declaredByConstructor.length];
            System.arraycopy(declaredByClass, 0, result2, 0, declaredByClass.length);
            System.arraycopy(declaredByConstructor, 0, result2, declaredByClass.length, declaredByConstructor.length);
            return result2;
        }
