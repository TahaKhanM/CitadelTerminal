...
public final class TypeResolver {
    ...
    private static void populateTypeMappings(final Map<TypeVariableKey, Type> mappings, Type from2, final Type to2) {
        if (from2.equals(to2)) {
            return;
        }
        new TypeVisitor(){
            ...
            void visitWildcardType(WildcardType fromWildcardType) {
                ...
                WildcardType toWildcardType = (WildcardType)to2;
                Type[] fromUpperBounds = fromWildcardType.getUpperBounds();
                Type[] toUpperBounds = toWildcardType.getUpperBounds();
                Type[] fromLowerBounds = fromWildcardType.getLowerBounds();
                Type[] toLowerBounds = toWildcardType.getLowerBounds();
                Preconditions.checkArgument(fromUpperBounds.length == toUpperBounds.length && fromLowerBounds.length == toLowerBounds.length, "Incompatible type: %s vs. %s", (Object)fromWildcardType, (Object)to2);
            ...
            void visitParameterizedType(ParameterizedType fromParameterizedType) {
                ...
                Preconditions.checkArgument(fromParameterizedType.getRawType().equals(toParameterizedType.getRawType()), "Inconsistent raw type: %s vs. %s", (Object)fromParameterizedType, (Object)to2);
            ...
            void visitGenericArrayType(GenericArrayType fromArrayType) {
                ...
                Preconditions.checkArgument(componentType != null, "%s is not an array type.", (Object)to2);
            ...
            void visitClass(Class<?> fromClass) {
                ...
                throw new IllegalArgumentException("No type mapping from " + fromClass + " to " + to2);
            }
        }.visit(from2);
    }
    ...
    private ParameterizedType resolveParameterizedType(ParameterizedType type) {
        Type owner2 = type.getOwnerType();
        Type resolvedOwner = owner2 == null ? null : this.resolveType(owner2);
    ...
    extends TypeVisitor {
        ...
        void visitParameterizedType(ParameterizedType parameterizedType) {
            ...
            Preconditions.checkState(vars.length == (typeArgs2 = parameterizedType.getActualTypeArguments()).length);
            for (int i = 0; i < vars.length; ++i) {
                this.map(new TypeVariableKey(vars[i]), typeArgs2[i]);
            }
            this.visit(rawClass);
