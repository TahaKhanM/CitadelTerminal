...
implements Multiset<E> {
    ...
    extends ImmutableCollection.Builder<E> {
        ...
        @CanIgnoreReturnValue
        public Builder<E> setCount(E element, int count2) {
            this.contents.setCount(Preconditions.checkNotNull(element), count2);
            return this;
        }
    ...
    extends ImmutableSet.Indexed<Multiset.Entry<E>> {
        ...
        public boolean contains(Object o) {
            if (o instanceof Multiset.Entry) {
                ...
                int count2 = ImmutableMultiset.this.count(entry.getElement());
