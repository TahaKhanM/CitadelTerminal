...
extends ContiguousSet<C> {
    ...
    @Override
    ContiguousSet<C> headSetImpl(C toElement, boolean inclusive2) {
        return this.intersectionInCurrentDomain(Range.upTo(toElement, BoundType.forBoolean(inclusive2)));
    }
    ...
    @Override
    ContiguousSet<C> tailSetImpl(C fromElement, boolean inclusive2) {
        return this.intersectionInCurrentDomain(Range.downTo(fromElement, BoundType.forBoolean(inclusive2)));
    }
    ...
    implements Serializable {
        ...
        private SerializedForm(Range<C> range2, DiscreteDomain<C> domain) {
            this.range = range2;
            this.domain = domain;
        }
