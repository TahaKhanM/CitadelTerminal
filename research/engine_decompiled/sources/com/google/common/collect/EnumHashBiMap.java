...
extends AbstractBiMap<K, V> {
    ...
    public static <K extends Enum<K>, V> EnumHashBiMap<K, V> create(Map<K, ? extends V> map2) {
        EnumHashBiMap<K, V> bimap = EnumHashBiMap.create(EnumBiMap.inferKeyType(map2));
