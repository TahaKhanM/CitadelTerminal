...
extends TreeTraverser<T> {
    ...
    implements PeekingIterator<T> {
        ...
        @Override
        public T next() {
            Object result2 = this.stack.removeLast();
            BinaryTreeTraverser.pushIfPresent(this.stack, BinaryTreeTraverser.this.rightChild(result2));
            BinaryTreeTraverser.pushIfPresent(this.stack, BinaryTreeTraverser.this.leftChild(result2));
            return result2;
        }
