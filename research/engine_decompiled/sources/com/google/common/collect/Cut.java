...
Serializable {
    ...
    public int compareTo(Cut<C> that) {
        ...
        int result2 = Range.compareOrThrow(this.endpoint, that.endpoint);
        if (result2 != 0) {
            return result2;
        }
    ...
    extends Cut<C> {
        ...
        Cut<C> withLowerBoundType(BoundType boundType, DiscreteDomain<C> domain) {
            switch (boundType) {
                ...
                case CLOSED: {
                    Comparable next2 = domain.next(this.endpoint);
                    return next2 == null ? Cut.belowAll() : AboveValue.belowValue(next2);
                }
            }
        ...
        Cut<C> withUpperBoundType(BoundType boundType, DiscreteDomain<C> domain) {
            switch (boundType) {
                case OPEN: {
                    Comparable next2 = domain.next(this.endpoint);
                    return next2 == null ? Cut.aboveAll() : AboveValue.belowValue(next2);
                }
                case CLOSED: {
                    return this;
                }
        ...
        @Override
        Cut<C> canonical(DiscreteDomain<C> domain) {
            C next2 = this.leastValueAbove(domain);
            return next2 != null ? AboveValue.belowValue(next2) : Cut.aboveAll();
        }
