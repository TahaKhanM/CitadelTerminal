...
Serializable {
    ...
    public static <K, V> ImmutableMap<K, V> copyOf(Map<? extends K, ? extends V> map2) {
        if (map2 instanceof ImmutableMap && !(map2 instanceof ImmutableSortedMap)) {
            ...
            ImmutableMap<K, V> kvMap = ImmutableMap.copyOfEnumMap((EnumMap)map2);
            return kvMap;
        }
    ...
    private static <K extends Enum<K>, V> ImmutableMap<K, V> copyOfEnumMap(EnumMap<K, ? extends V> original) {
        EnumMap<K, V> copy2 = new EnumMap<K, V>(original);
        for (Map.Entry<K, V> entry : copy2.entrySet()) {
            CollectPreconditions.checkEntryNotNull(entry.getKey(), entry.getValue());
        }
        return ImmutableEnumMap.asImmutable(copy2);
    }
    ...
    public ImmutableSetMultimap<K, V> asMultimap() {
        ...
        return result2 == null ? (this.multimapView = new ImmutableSetMultimap(new MapViewOfValuesAsSingletonSets(), this.size(), null)) : result2;
    }
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> putAll(Map<? extends K, ? extends V> map2) {
            return this.putAll(map2.entrySet());
        }
