...
extends ImmutableSortedSet<E> {
    ...
    @Override
    ImmutableSortedSet<E> headSetImpl(E toElement, boolean inclusive2) {
        return this.getSubSet(0, this.headIndex(toElement, inclusive2));
    }

    int headIndex(E toElement, boolean inclusive2) {
        return SortedLists.binarySearch(this.elements, Preconditions.checkNotNull(toElement), this.comparator(), inclusive2 ? SortedLists.KeyPresentBehavior.FIRST_AFTER : SortedLists.KeyPresentBehavior.FIRST_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
    }
    ...
    @Override
    ImmutableSortedSet<E> tailSetImpl(E fromElement, boolean inclusive2) {
        return this.getSubSet(this.tailIndex(fromElement, inclusive2), this.size());
    }

    int tailIndex(E fromElement, boolean inclusive2) {
        return SortedLists.binarySearch(this.elements, Preconditions.checkNotNull(fromElement), this.comparator(), inclusive2 ? SortedLists.KeyPresentBehavior.FIRST_PRESENT : SortedLists.KeyPresentBehavior.FIRST_AFTER, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
    }
    ...
    ImmutableSortedSet<E> createDescendingSet() {
        Ordering reversedOrder = Ordering.from(this.comparator).reverse();
