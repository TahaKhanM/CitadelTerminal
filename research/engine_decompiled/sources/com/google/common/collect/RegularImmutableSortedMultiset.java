...
extends ImmutableSortedMultiset<E> {
    ...
    ImmutableSortedMultiset<E> getSubMultiset(int from2, int to2) {
        ...
        RegularImmutableSortedSet<E> subElementSet = this.elementSet.getSubSet(from2, to2);
        return new RegularImmutableSortedMultiset<E>(subElementSet, this.cumulativeCounts, this.offset + from2, to2 - from2);
    }
