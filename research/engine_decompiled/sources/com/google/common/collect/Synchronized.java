...
final class Synchronized {
    ...
    private static <E> List<E> list(List<E> list2, @Nullable Object mutex) {
        return list2 instanceof RandomAccess ? new SynchronizedRandomAccessList<E>(list2, mutex) : new SynchronizedList<E>(list2, mutex);
    }
    ...
    @VisibleForTesting
    static <K, V> Map<K, V> map(Map<K, V> map2, @Nullable Object mutex) {
        return new SynchronizedMap<K, V>(map2, mutex);
    }
    ...
    implements NavigableMap<K, V> {
        ...
        public NavigableMap<K, V> headMap(K toKey, boolean inclusive2) {
            Object object = this.mutex;
            synchronized (object) {
                return Synchronized.navigableMap(this.delegate().headMap(toKey, inclusive2), this.mutex);
            }
        }
        ...
        public NavigableMap<K, V> tailMap(K fromKey, boolean inclusive2) {
            Object object = this.mutex;
            synchronized (object) {
                return Synchronized.navigableMap(this.delegate().tailMap(fromKey, inclusive2), this.mutex);
            }
        }
    ...
    implements NavigableSet<E> {
        ...
        public NavigableSet<E> headSet(E toElement, boolean inclusive2) {
            Object object = this.mutex;
            synchronized (object) {
                return Synchronized.navigableSet(this.delegate().headSet(toElement, inclusive2), this.mutex);
            }
        }
        ...
        public NavigableSet<E> tailSet(E fromElement, boolean inclusive2) {
            Object object = this.mutex;
            synchronized (object) {
                return Synchronized.navigableSet(this.delegate().tailSet(fromElement, inclusive2), this.mutex);
            }
        }
    ...
    extends SynchronizedCollection<Collection<V>> {
        ...
        public Iterator<Collection<V>> iterator() {
            return new TransformedIterator<Collection<V>, Collection<V>>(super.iterator()){
                ...
                @Override
                Collection<V> transform(Collection<V> from2) {
                    return Synchronized.typePreservingCollection(from2, SynchronizedAsMapValues.this.mutex);
                }
            };
        }
    }
    ...
    implements Multiset<E> {
        ...
        public int setCount(E element, int count2) {
            Object object = this.mutex;
            synchronized (object) {
                return this.delegate().setCount(element, count2);
            }
        }
    ...
    implements RandomAccess {
        ...
        SynchronizedRandomAccessList(List<E> list2, @Nullable Object mutex) {
            super(list2, mutex);
        }
    }
