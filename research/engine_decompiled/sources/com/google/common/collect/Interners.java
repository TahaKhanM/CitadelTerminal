...
public final class Interners {
    ...
    public static <E> Interner<E> newStrongInterner() {
        final ConcurrentMap map2 = new MapMaker().makeMap();
        return new Interner<E>(){

            @Override
            public E intern(E sample) {
                Object canonical = map2.putIfAbsent(Preconditions.checkNotNull(sample), sample);
    ...
    implements Function<E, E> {
        ...
        @Override
        public E apply(E input2) {
            return this.interner.intern(input2);
        }
