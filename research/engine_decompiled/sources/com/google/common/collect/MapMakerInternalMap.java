...
Serializable {
    ...
    public boolean isEmpty() {
        ...
        for (i = 0; i < segments2.length; ++i) {
            ...
            sum2 += (long)segments2[i].modCount;
        }
        if (sum2 != 0L) {
            for (i = 0; i < segments2.length; ++i) {
                if (segments2[i].count != 0) {
    ...
    public boolean containsValue(@Nullable Object value) {
        ...
        for (int i = 0; i < 3; ++i) {
            long sum2 = 0L;
            for (Segment<K, V, InternalEntry, S> segment : segments2) {
    ...
    private static <E> ArrayList<E> toArrayList(Collection<E> c) {
        ArrayList result2 = new ArrayList(c.size());
        Iterators.addAll(result2, c.iterator());
        return result2;
    }
    ...
    implements Serializable {
        ...
        MapMaker readMapMaker(ObjectInputStream in) throws IOException {
            ...
            return new MapMaker().initialCapacity(size2).setKeyStrength(this.keyStrength).setValueStrength(this.valueStrength).keyEquivalence(this.keyEquivalence).concurrencyLevel(this.concurrencyLevel);
        }
    ...
    implements Runnable {
        ...
        public CleanupMapTask(MapMakerInternalMap<?, ?, ?, ?> map2) {
            this.mapReference = new WeakReference(map2);
        }

        @Override
        public void run() {
            MapMakerInternalMap map2 = (MapMakerInternalMap)this.mapReference.get();
            if (map2 == null) {
                throw new CancellationException();
            }
            for (Segment segment : map2.segments) {
                segment.runCleanup();
            }
        }
    }
    ...
    extends Segment<K, V, WeakKeyWeakValueEntry<K, V>, WeakKeyWeakValueSegment<K, V>> {
        ...
        WeakKeyWeakValueSegment(MapMakerInternalMap<K, V, WeakKeyWeakValueEntry<K, V>, WeakKeyWeakValueSegment<K, V>> map2, int initialCapacity, int maxSegmentSize) {
            super(map2, initialCapacity, maxSegmentSize);
        }
    ...
    extends Segment<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> {
        ...
        WeakKeyStrongValueSegment(MapMakerInternalMap<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> map2, int initialCapacity, int maxSegmentSize) {
            super(map2, initialCapacity, maxSegmentSize);
        }
    ...
    extends Segment<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> {
        ...
        StrongKeyWeakValueSegment(MapMakerInternalMap<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> map2, int initialCapacity, int maxSegmentSize) {
            super(map2, initialCapacity, maxSegmentSize);
        }
    ...
    extends Segment<K, V, StrongKeyStrongValueEntry<K, V>, StrongKeyStrongValueSegment<K, V>> {
        StrongKeyStrongValueSegment(MapMakerInternalMap<K, V, StrongKeyStrongValueEntry<K, V>, StrongKeyStrongValueSegment<K, V>> map2, int initialCapacity, int maxSegmentSize) {
            super(map2, initialCapacity, maxSegmentSize);
        }
    ...
    extends ReentrantLock {
        ...
        Segment(MapMakerInternalMap<K, V, E, S> map2, int initialCapacity, int maxSegmentSize) {
            this.map = map2;
        ...
        AtomicReferenceArray<E> newEntryArray(int size2) {
            return new AtomicReferenceArray(size2);
        }
        ...
        E newEntryForTesting(K key, int hash, @Nullable InternalEntry<K, V, ?> next2) {
            return this.map.entryHelper.newEntry(this.self(), key, hash, this.castForTesting(next2));
        }
        ...
        void expand() {
            ...
            for (int oldIndex = 0; oldIndex < oldCapacity; ++oldIndex) {
                int newIndex;
                Object e;
                InternalEntry head2 = (InternalEntry)oldTable.get(oldIndex);
                if (head2 == null) continue;
                Object next2 = head2.getNext();
                int headIndex = head2.getHash() & newMask;
                if (next2 == null) {
                    newTable.set(headIndex, head2);
                    continue;
                }
                Object tail = head2;
                int tailIndex = headIndex;
                for (e = next2; e != null; e = e.getNext()) {
                ...
                for (e = head2; e != tail; e = e.getNext()) {
                    newIndex = e.getHash() & newMask;
        ...
        E removeFromChain(E first, E entry) {
            ...
            for (E e = first; e != entry; e = e.getNext()) {
                E next2 = this.copyEntry(e, newFirst);
                if (next2 != null) {
                    newFirst = next2;
                    continue;
                }
    ...
    implements WeakValueEntry<K, V, WeakKeyWeakValueEntry<K, V>> {
        ...
        WeakKeyWeakValueEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable WeakKeyWeakValueEntry<K, V> next2) {
            super(queue, key, hash, next2);
        }
        ...
        implements InternalEntryHelper<K, V, WeakKeyWeakValueEntry<K, V>, WeakKeyWeakValueSegment<K, V>> {
            ...
            @Override
            public WeakKeyWeakValueSegment<K, V> newSegment(MapMakerInternalMap<K, V, WeakKeyWeakValueEntry<K, V>, WeakKeyWeakValueSegment<K, V>> map2, int initialCapacity, int maxSegmentSize) {
                return new WeakKeyWeakValueSegment<K, V>(map2, initialCapacity, maxSegmentSize);
            }
            ...
            @Override
            public WeakKeyWeakValueEntry<K, V> newEntry(WeakKeyWeakValueSegment<K, V> segment, K key, int hash, @Nullable WeakKeyWeakValueEntry<K, V> next2) {
                return new WeakKeyWeakValueEntry<K, V>(((WeakKeyWeakValueSegment)segment).queueForKeys, key, hash, next2);
            }
        }
    }
    ...
    implements StrongValueEntry<K, V, WeakKeyStrongValueEntry<K, V>> {
        ...
        WeakKeyStrongValueEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable WeakKeyStrongValueEntry<K, V> next2) {
            super(queue, key, hash, next2);
        }
        ...
        implements InternalEntryHelper<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> {
            ...
            @Override
            public WeakKeyStrongValueSegment<K, V> newSegment(MapMakerInternalMap<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> map2, int initialCapacity, int maxSegmentSize) {
                return new WeakKeyStrongValueSegment<K, V>(map2, initialCapacity, maxSegmentSize);
            }
            ...
            @Override
            public WeakKeyStrongValueEntry<K, V> newEntry(WeakKeyStrongValueSegment<K, V> segment, K key, int hash, @Nullable WeakKeyStrongValueEntry<K, V> next2) {
                return new WeakKeyStrongValueEntry<K, V>(((WeakKeyStrongValueSegment)segment).queueForKeys, key, hash, next2);
            }
        }
    }
    ...
    implements InternalEntry<K, V, E> {
        ...
        AbstractWeakKeyEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable E next2) {
            super(key, queue);
            this.hash = hash;
            this.next = next2;
        }
    ...
    implements WeakValueEntry<K, V, StrongKeyWeakValueEntry<K, V>> {
        ...
        StrongKeyWeakValueEntry(K key, int hash, @Nullable StrongKeyWeakValueEntry<K, V> next2) {
            super(key, hash, next2);
        }
        ...
        implements InternalEntryHelper<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> {
            ...
            @Override
            public StrongKeyWeakValueSegment<K, V> newSegment(MapMakerInternalMap<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> map2, int initialCapacity, int maxSegmentSize) {
                return new StrongKeyWeakValueSegment<K, V>(map2, initialCapacity, maxSegmentSize);
            }
            ...
            @Override
            public StrongKeyWeakValueEntry<K, V> newEntry(StrongKeyWeakValueSegment<K, V> segment, K key, int hash, @Nullable StrongKeyWeakValueEntry<K, V> next2) {
                return new StrongKeyWeakValueEntry<K, V>(key, hash, next2);
            }
        }
    }
    ...
    implements StrongValueEntry<K, V, StrongKeyStrongValueEntry<K, V>> {
        ...
        StrongKeyStrongValueEntry(K key, int hash, @Nullable StrongKeyStrongValueEntry<K, V> next2) {
            super(key, hash, next2);
        }
        ...
        implements InternalEntryHelper<K, V, StrongKeyStrongValueEntry<K, V>, StrongKeyStrongValueSegment<K, V>> {
            ...
            @Override
            public StrongKeyStrongValueSegment<K, V> newSegment(MapMakerInternalMap<K, V, StrongKeyStrongValueEntry<K, V>, StrongKeyStrongValueSegment<K, V>> map2, int initialCapacity, int maxSegmentSize) {
                return new StrongKeyStrongValueSegment<K, V>(map2, initialCapacity, maxSegmentSize);
            }
            ...
            @Override
            public StrongKeyStrongValueEntry<K, V> newEntry(StrongKeyStrongValueSegment<K, V> segment, K key, int hash, @Nullable StrongKeyStrongValueEntry<K, V> next2) {
                return new StrongKeyStrongValueEntry<K, V>(key, hash, next2);
            }
        }
    }
    ...
    implements InternalEntry<K, V, E> {
        ...
        AbstractStrongKeyEntry(K key, int hash, @Nullable E next2) {
            this.key = key;
            this.hash = hash;
            this.next = next2;
        }
