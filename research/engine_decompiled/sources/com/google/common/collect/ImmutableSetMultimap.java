...
implements SetMultimap<K, V> {
    ...
    private static <K, V> ImmutableSetMultimap<K, V> copyOf(Multimap<? extends K, ? extends V> multimap, Comparator<? super V> valueComparator) {
        ...
        return new ImmutableSetMultimap(builder.build(), size2, valueComparator);
    }
    ...
    ImmutableSetMultimap(ImmutableMap<K, ImmutableSet<V>> map2, int size2, @Nullable Comparator<? super V> valueComparator) {
        super(map2, size2);
    ...
    public ImmutableSetMultimap<V, K> inverse() {
        ImmutableSetMultimap<K, V> result2 = this.inverse;
    ...
    public ImmutableSet<Map.Entry<K, V>> entries() {
        ImmutableSet<Map.Entry<K, V>> result2 = this.entries;
        return result2 == null ? (this.entries = new EntrySet(this)) : result2;
    }
