...
implements Serializable {
    ...
    public static <C extends Comparable<?>> TreeRangeSet<C> create(RangeSet<C> rangeSet) {
        TreeRangeSet<C> result2 = TreeRangeSet.create();
        result2.addAll((RangeSet)rangeSet);
        return result2;
    }
    ...
    public Set<Range<C>> asRanges() {
        AsRanges result2 = this.asRanges;
        return result2 == null ? (this.asRanges = new AsRanges(this.rangesByLowerBound.values())) : result2;
    }

    @Override
    public Set<Range<C>> asDescendingSetOfRanges() {
        AsRanges result2 = this.asDescendingSetOfRanges;
        return result2 == null ? (this.asDescendingSetOfRanges = new AsRanges(this.rangesByLowerBound.descendingMap().values())) : result2;
    }
    ...
    @Override
    public boolean intersects(Range<C> range2) {
        Preconditions.checkNotNull(range2);
        Map.Entry ceilingEntry = this.rangesByLowerBound.ceilingEntry(range2.lowerBound);
        if (ceilingEntry != null && ceilingEntry.getValue().isConnected(range2) && !ceilingEntry.getValue().intersection(range2).isEmpty()) {
            return true;
        }
        Map.Entry priorEntry = this.rangesByLowerBound.lowerEntry(range2.lowerBound);
        return priorEntry != null && priorEntry.getValue().isConnected(range2) && !priorEntry.getValue().intersection(range2).isEmpty();
    }

    @Override
    public boolean encloses(Range<C> range2) {
        Preconditions.checkNotNull(range2);
        Map.Entry floorEntry = this.rangesByLowerBound.floorEntry(range2.lowerBound);
        return floorEntry != null && floorEntry.getValue().encloses(range2);
    }

    @Nullable
    private Range<C> rangeEnclosing(Range<C> range2) {
        Preconditions.checkNotNull(range2);
        Map.Entry floorEntry = this.rangesByLowerBound.floorEntry(range2.lowerBound);
        return floorEntry != null && floorEntry.getValue().encloses(range2) ? floorEntry.getValue() : null;
    }
    ...
    private void replaceRangeWithSameLowerBound(Range<C> range2) {
        if (range2.isEmpty()) {
    ...
    public RangeSet<C> complement() {
        Complement result2 = this.complement;
        return result2 == null ? (this.complement = new Complement()) : result2;
    }
    ...
    extends TreeRangeSet<C> {
        ...
        @Override
        public boolean encloses(Range<C> range2) {
            if (!this.restriction.isEmpty() && this.restriction.encloses(range2)) {
                Range enclosing = TreeRangeSet.this.rangeEnclosing(range2);
        ...
        public Range<C> rangeContaining(C value) {
            ...
            Range result2 = TreeRangeSet.this.rangeContaining(value);
            return result2 == null ? null : result2.intersection(this.restriction);
        }
    ...
    extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        @Override
        public NavigableMap<Cut<C>, Range<C>> headMap(Cut<C> toKey, boolean inclusive2) {
            return this.subMap(Range.upTo(toKey, BoundType.forBoolean(inclusive2)));
        }

        @Override
        public NavigableMap<Cut<C>, Range<C>> tailMap(Cut<C> fromKey, boolean inclusive2) {
            return this.subMap(Range.downTo(fromKey, BoundType.forBoolean(inclusive2)));
        }
            ...
            if (key instanceof Cut) {
                try {
                    ...
                    if (cut.equals(this.restriction.lowerBound)) {
                        ...
                        Range result2 = (Range)this.rangesByLowerBound.get(cut);
                        if (result2 != null) {
                            return result2.intersection(this.restriction);
                        }
                    }
                }
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            final Iterator completeRangeItr = this.lowerBoundWindow.lowerBound.isLessThan(this.restriction.lowerBound) ? this.rangesByUpperBound.tailMap(this.restriction.lowerBound, false).values().iterator() : this.rangesByLowerBound.tailMap((Cut<C>)this.lowerBoundWindow.lowerBound.endpoint(), this.lowerBoundWindow.lowerBoundType() == BoundType.CLOSED).values().iterator();
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            Cut upperBoundOnLowerBounds = Ordering.natural().min(this.lowerBoundWindow.upperBound, Cut.belowValue(this.restriction.upperBound));
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    Range nextRange = (Range)completeRangeItr.next();
                    if (((SubRangeSetRangesByLowerBound)SubRangeSetRangesByLowerBound.this).restriction.lowerBound.compareTo(nextRange.upperBound) >= 0) {
                        return (Map.Entry)this.endOfData();
                    }
                    nextRange = nextRange.intersection(SubRangeSetRangesByLowerBound.this.restriction);
    ...
    extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            final PeekingIterator positiveItr = Iterators.peekingIterator(this.positiveRangesByUpperBound.headMap(startingPoint, inclusive2 = this.complementLowerBoundWindow.hasUpperBound() && this.complementLowerBoundWindow.upperBoundType() == BoundType.CLOSED).descendingMap().values().iterator());
            if (positiveItr.hasNext()) {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    if (positiveItr.hasNext()) {
                        ...
                        if (((ComplementRangesByLowerBound)ComplementRangesByLowerBound.this).complementLowerBoundWindow.lowerBound.isLessThan(negativeRange.lowerBound)) {
                            return Maps.immutableEntry(negativeRange.lowerBound, negativeRange);
                        }
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    Range range2 = (Range)backingItr.next();
                    if (((RangesByUpperBound)RangesByUpperBound.this).upperBoundWindow.upperBound.isLessThan(range2.upperBound)) {
                        return (Map.Entry)this.endOfData();
                    }
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new AbstractIterator<Map.Entry<Cut<C>, Range<C>>>(){
                ...
                protected Map.Entry<Cut<C>, Range<C>> computeNext() {
                    ...
                    Range range2 = (Range)backingItr.next();
                    return ((RangesByUpperBound)RangesByUpperBound.this).upperBoundWindow.lowerBound.isLessThan(range2.upperBound) ? Maps.immutableEntry(range2.upperBound, range2) : (Map.Entry)this.endOfData();
                }
            };
        }
