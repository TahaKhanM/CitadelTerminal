...
final class Constraints {
    ...
    public static <E> List<E> constrainedList(List<E> list2, Constraint<? super E> constraint) {
        return list2 instanceof RandomAccess ? new ConstrainedRandomAccessList<E>(list2, constraint) : new ConstrainedList<E>(list2, constraint);
    }
    ...
    private static <E> Collection<E> checkElements(Collection<E> elements, Constraint<? super E> constraint) {
        ArrayList<E> copy2 = Lists.newArrayList(elements);
        for (Object element : copy2) {
