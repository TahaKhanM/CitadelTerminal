...
public final class Lists {
    ...
    public static <E> ArrayList<E> newArrayList(Iterator<? extends E> elements) {
        ...
        Iterators.addAll(list2, elements);
        return list2;
    }
    ...
    public static <E> LinkedList<E> newLinkedList(Iterable<? extends E> elements) {
        ...
        Iterables.addAll(list2, elements);
        return list2;
    }
    ...
    public static <T> List<T> reverse(List<T> list2) {
        if (list2 instanceof ImmutableList) {
            return ((ImmutableList)list2).reverse();
        }
    ...
    static boolean equalsImpl(List<?> thisList, @Nullable Object other) {
        ...
        int size2 = thisList.size();
        if (size2 != otherList.size()) {
            return false;
        }
    ...
    static <E> boolean addAllImpl(List<E> list2, int index, Iterable<? extends E> elements) {
        boolean changed = false;
        ListIterator<E> listIterator = list2.listIterator(index);
        for (E e : elements) {
            listIterator.add(e);
            changed = true;
        }
    ...
    static int indexOfImpl(List<?> list2, @Nullable Object element) {
        if (list2 instanceof RandomAccess) {
            return Lists.indexOfRandomAccess(list2, element);
        }
    ...
    private static int indexOfRandomAccess(List<?> list2, @Nullable Object element) {
        ...
        if (element == null) {
            ...
            for (int i = 0; i < size2; ++i) {
                if (!element.equals(list2.get(i))) continue;
                return i;
            }
        }
        return -1;
    ...
    static int lastIndexOfImpl(List<?> list2, @Nullable Object element) {
        if (list2 instanceof RandomAccess) {
            return Lists.lastIndexOfRandomAccess(list2, element);
        }
    ...
    private static int lastIndexOfRandomAccess(List<?> list2, @Nullable Object element) {
        if (element == null) {
    ...
    static <E> ListIterator<E> listIteratorImpl(List<E> list2, int index) {
        return new AbstractListWrapper<E>(list2).listIterator(index);
    }
    ...
    extends AbstractList<T> {
        ...
        private int reverseIndex(int index) {
            int size2 = this.size();
            Preconditions.checkElementIndex(index, size2);
            return size2 - 1 - index;
        }

        private int reversePosition(int index) {
            int size2 = this.size();
            Preconditions.checkPositionIndex(index, size2);
            return size2 - index;
        }
    ...
    Serializable {
        ...
        public ListIterator<T> listIterator(int index) {
            return new TransformedListIterator<F, T>(this.fromList.listIterator(index)){
                ...
                @Override
                T transform(F from2) {
                    return TransformingRandomAccessList.this.function.apply(from2);
                }
            };
        }
