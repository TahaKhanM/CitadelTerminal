...
public final class Multisets {
    ...
    public static <E> Multiset<E> unmodifiableMultiset(Multiset<? extends E> multiset) {
        if (multiset instanceof UnmodifiableMultiset || multiset instanceof ImmutableMultiset) {
            Multiset<? extends E> result2 = multiset;
            return result2;
        }
    ...
    public static <E> Multiset<E> filter(Multiset<E> unfiltered, Predicate<? super E> predicate) {
        if (unfiltered instanceof FilteredMultiset) {
            FilteredMultiset filtered2 = (FilteredMultiset)unfiltered;
            Predicate<? super E> combinedPredicate = Predicates.and(filtered2.predicate, predicate);
            return new FilteredMultiset<E>(filtered2.unfiltered, combinedPredicate);
        }
                ...
                return new AbstractIterator<Multiset.Entry<E>>(){
                    ...
                    protected Multiset.Entry<E> computeNext() {
                        if (iterator1.hasNext()) {
                            ...
                            int count2 = Math.max(entry1.getCount(), multiset2.count(element));
                            return Multisets.immutableEntry(element, count2);
                        }
                ...
                return new AbstractIterator<Multiset.Entry<E>>(){
                    ...
                    protected Multiset.Entry<E> computeNext() {
                        while (iterator1.hasNext()) {
                            Multiset.Entry entry1 = (Multiset.Entry)iterator1.next();
                            Object element = entry1.getElement();
                            int count2 = Math.min(entry1.getCount(), multiset2.count(element));
                ...
                return new AbstractIterator<Multiset.Entry<E>>(){
                    ...
                    protected Multiset.Entry<E> computeNext() {
                        if (iterator1.hasNext()) {
                            Multiset.Entry entry1 = (Multiset.Entry)iterator1.next();
                            Object element = entry1.getElement();
                            int count2 = entry1.getCount() + multiset2.count(element);
                            return Multisets.immutableEntry(element, count2);
                        }
                        while (iterator2.hasNext()) {
                            Multiset.Entry entry2 = (Multiset.Entry)iterator2.next();
    ...
    static <E> int setCountImpl(Multiset<E> self, E element, int count2) {
        CollectPreconditions.checkNonnegative(count2, "count");
        int oldCount = self.count(element);
        int delta = count2 - oldCount;
        if (delta > 0) {
    ...
    extends Sets.ImprovedAbstractSet<Multiset.Entry<E>> {
        ...
        public boolean contains(@Nullable Object o) {
            if (o instanceof Multiset.Entry) {
                ...
                int count2 = this.multiset().count(entry.getElement());
                return count2 == entry.getCount();
            }
            return false;
        }
    ...
    extends AbstractMultiset<E> {
        ...
        @Override
        public int count(@Nullable Object element) {
            int count2 = this.unfiltered.count(element);
            if (count2 > 0) {
                Object e = element;
                return this.predicate.apply(e) ? count2 : 0;
            }
            return 0;
        }
    ...
    implements Serializable {
        ...
        ImmutableEntry(@Nullable E element, int count2) {
