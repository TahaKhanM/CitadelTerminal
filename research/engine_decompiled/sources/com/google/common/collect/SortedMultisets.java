...
final class SortedMultisets {
    ...
    implements NavigableSet<E> {
        ...
        public NavigableSet<E> headSet(E toElement, boolean inclusive2) {
            return new NavigableElementSet<E>(this.multiset().headMultiset(toElement, BoundType.forBoolean(inclusive2)));
        }

        @Override
        public NavigableSet<E> tailSet(E fromElement, boolean inclusive2) {
            return new NavigableElementSet<E>(this.multiset().tailMultiset(fromElement, BoundType.forBoolean(inclusive2)));
        }
    }
