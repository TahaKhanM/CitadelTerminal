...
implements Comparator<T> {
    ...
    public <E extends T> List<E> leastOf(Iterator<E> iterator2, int k) {
        Preconditions.checkNotNull(iterator2);
        CollectPreconditions.checkNonnegative(k, "k");
        if (k == 0 || !iterator2.hasNext()) {
            return ImmutableList.of();
        }
        if (k >= 0x3FFFFFFF) {
            ArrayList<E> list2 = Lists.newArrayList(iterator2);
    ...
    extends Ordering<Object> {
        ...
        public int compare(Object left, Object right) {
            ...
            int result2 = this.getUid(left).compareTo(this.getUid(right));
            if (result2 == 0) {
