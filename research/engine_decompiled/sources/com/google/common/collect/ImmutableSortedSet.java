...
SortedIterable<E> {
    ...
    public static <E> ImmutableSortedSet<E> copyOfSorted(SortedSet<E> sortedSet) {
        ...
        ImmutableList<E> list2 = ImmutableList.copyOf(sortedSet);
        if (list2.isEmpty()) {
            return ImmutableSortedSet.emptySet(comparator);
        }
        return new RegularImmutableSortedSet<E>(list2, comparator);
    }
    ...
    @Override
    @GwtIncompatible
    public ImmutableSortedSet<E> headSet(E toElement, boolean inclusive2) {
        return this.headSetImpl(Preconditions.checkNotNull(toElement), inclusive2);
    }
    ...
    @Override
    @GwtIncompatible
    public ImmutableSortedSet<E> tailSet(E fromElement, boolean inclusive2) {
        return this.tailSetImpl(Preconditions.checkNotNull(fromElement), inclusive2);
    }
