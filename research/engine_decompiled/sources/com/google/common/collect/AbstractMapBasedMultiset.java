...
implements Serializable {
        ...
        return new Iterator<Multiset.Entry<E>>(){
            ...
            public Multiset.Entry<E> next() {
                ...
                return new Multisets.AbstractEntry<E>(){
                    ...
                    public int getCount() {
                        Count frequency;
                        Count count2 = (Count)mapEntry.getValue();
                        if ((count2 == null || count2.get() == 0) && (frequency = (Count)AbstractMapBasedMultiset.this.backingMap.get(this.getElement())) != null) {
    ...
    public int setCount(@Nullable E element, int count2) {
        ...
        if (count2 == 0) {
            ...
            oldCount = AbstractMapBasedMultiset.getAndSet(existingCounter, count2);
        } else {
            Count existingCounter = this.backingMap.get(element);
            oldCount = AbstractMapBasedMultiset.getAndSet(existingCounter, count2);
            if (existingCounter == null) {
                this.backingMap.put(element, new Count(count2));
            }
        }
    ...
    private static int getAndSet(@Nullable Count i, int count2) {
        if (i == null) {
            return 0;
        }
        return i.getAndSet(count2);
    }
