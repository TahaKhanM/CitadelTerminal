...
implements Serializable {
    ...
    final void setMap(Map<K, Collection<V>> map2) {
        this.map = map2;
        this.totalSize = 0;
        for (Collection<Collection<V>> values : map2.values()) {
    ...
    private List<V> wrapList(@Nullable K key, List<V> list2, @Nullable WrappedCollection ancestor) {
        return list2 instanceof RandomAccess ? new RandomAccessWrappedList(key, list2, ancestor) : new WrappedList(key, list2, ancestor);
    }
    ...
    private void removeValuesForKey(Object key) {
        ...
        if (collection != null) {
            int count2 = collection.size();
            collection.clear();
            this.totalSize -= count2;
        }
    }
    ...
    implements NavigableMap<K, Collection<V>> {
        ...
        @Override
        public NavigableMap<K, Collection<V>> headMap(K toKey, boolean inclusive2) {
            return new NavigableAsMap(this.sortedMap().headMap(toKey, inclusive2));
        }
        ...
        @Override
        public NavigableMap<K, Collection<V>> tailMap(K fromKey, boolean inclusive2) {
            return new NavigableAsMap(this.sortedMap().tailMap(fromKey, inclusive2));
        }
    }
    ...
    implements SortedMap<K, Collection<V>> {
        ...
        public SortedSet<K> keySet() {
            SortedSet result2 = this.sortedKeySet;
            return result2 == null ? (this.sortedKeySet = this.createKeySet()) : result2;
        }
    ...
    implements NavigableSet<K> {
        ...
        public NavigableSet<K> headSet(K toElement, boolean inclusive2) {
            return new NavigableKeySet(this.sortedMap().headMap(toElement, inclusive2));
        }
        ...
        public NavigableSet<K> tailSet(K fromElement, boolean inclusive2) {
            return new NavigableKeySet(this.sortedMap().tailMap(fromElement, inclusive2));
        }
    }
    ...
    extends Maps.KeySet<K, Collection<V>> {
        ...
        public boolean remove(Object key) {
            ...
            if (collection != null) {
                ...
                collection.clear();
                AbstractMapBasedMultimap.this.totalSize -= count2;
            }
            return count2 > 0;
        }
    ...
    implements NavigableSet<V> {
        ...
        @Override
        public NavigableSet<V> headSet(V toElement, boolean inclusive2) {
            return this.wrap(this.getSortedSetDelegate().headSet(toElement, inclusive2));
        }

        @Override
        public NavigableSet<V> tailSet(V fromElement, boolean inclusive2) {
            return this.wrap(this.getSortedSetDelegate().tailSet(fromElement, inclusive2));
        }
    }
