...
public final class Collections2 {
    ...
    static String toStringImpl(final Collection<?> collection) {
        ...
        STANDARD_JOINER.appendTo(sb, Iterables.transform(collection, new Function<Object, Object>(){
            ...
            @Override
            public Object apply(Object input2) {
                return input2 == collection ? "(this Collection)" : input2;
            }
        }));
        return sb.append(']').toString();
    }

    static StringBuilder newStringBuilderForCollection(int size2) {
        CollectPreconditions.checkNonnegative(size2, "size");
        return new StringBuilder((int)Math.min((long)size2 * 8L, 0x40000000L));
    }
    ...
    extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            this.list = new ArrayList<E>(list2);
            int n = list2.size();
            this.c = new int[n];
            this.o = new int[n];
        ...
        protected List<E> computeNext() {
            ...
            ImmutableList<E> next2 = ImmutableList.copyOf(this.list);
        ...
        void calculateNextPermutation() {
            block4: {
                ...
                Collections.swap(this.list, this.j - this.c[this.j] + s2, this.j - q + s2);
                this.c[this.j] = q;
            }
        }
    ...
    extends AbstractCollection<List<E>> {
        ...
        PermutationCollection(ImmutableList<E> input2) {
            this.inputList = input2;
        }
        ...
        public boolean contains(@Nullable Object obj) {
            if (obj instanceof List) {
                List list2 = (List)obj;
                return Collections2.isPermutation(this.inputList, list2);
            }
            return false;
        }
    ...
    extends AbstractIterator<List<E>> {
        ...
        OrderedPermutationIterator(List<E> list2, Comparator<? super E> comparator) {
            this.nextPermutation = Lists.newArrayList(list2);
        ...
        protected List<E> computeNext() {
            ...
            ImmutableList<E> next2 = ImmutableList.copyOf(this.nextPermutation);
            this.calculateNextPermutation();
            return next2;
        }
    ...
    extends AbstractCollection<List<E>> {
        ...
        OrderedPermutationCollection(Iterable<E> input2, Comparator<? super E> comparator) {
            this.inputList = Ordering.from(comparator).immutableSortedCopy(input2);
            this.comparator = comparator;
        ...
        private static <E> int calculateSize(List<E> sortedInputList, Comparator<? super E> comparator) {
            long permutations2 = 1L;
            int n = 1;
            int r = 1;
            while (n < sortedInputList.size()) {
                int comparison = comparator.compare(sortedInputList.get(n - 1), sortedInputList.get(n));
                if (comparison < 0) {
                    permutations2 *= LongMath.binomial(n, r);
                    r = 0;
            ...
            if (!Collections2.isPositiveInt(permutations2 *= LongMath.binomial(n, r))) {
                return Integer.MAX_VALUE;
            }
