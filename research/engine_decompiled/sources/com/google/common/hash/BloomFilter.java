...
Serializable {
    ...
    private BloomFilter(BloomFilterStrategies.BitArray bits2, int numHashFunctions, Funnel<? super T> funnel, Strategy strategy) {
        ...
        this.bits = Preconditions.checkNotNull(bits2);
    ...
    @Override
    @Deprecated
    public boolean apply(T input2) {
        return this.mightContain(input2);
    }
