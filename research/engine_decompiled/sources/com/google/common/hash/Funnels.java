...
public final class Funnels {
    ...
    extends OutputStream {
        ...
        public void write(byte[] bytes2) {
            this.sink.putBytes(bytes2);
        }

        @Override
        public void write(byte[] bytes2, int off, int len) {
            this.sink.putBytes(bytes2, off, len);
        }
    ...
    Serializable {
        ...
        @Override
        public void funnel(Iterable<? extends E> from2, PrimitiveSink into) {
            for (E e : from2) {
    ...
    Serializable {
        ...
        public void funnel(CharSequence from2, PrimitiveSink into) {
            into.putString(from2, this.charset);
        }
