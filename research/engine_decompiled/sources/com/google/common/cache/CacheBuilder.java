...
public final class CacheBuilder<K, V> {
    ...
    public CacheBuilder<K, V> maximumSize(long size2) {
        ...
        Preconditions.checkArgument(size2 >= 0L, "maximum size must not be negative");
    ...
    public String toString() {
        ...
        if (this.maximumWeight != -1L) {
            s2.add("maximumWeight", this.maximumWeight);
        }
