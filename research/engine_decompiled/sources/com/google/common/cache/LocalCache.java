...
implements ConcurrentMap<K, V> {
     ...
     */
    @VisibleForTesting
    ReferenceEntry<K, V> newEntry(K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
        Segment<K, V> segment = this.segmentFor(hash);
        segment.lock();
        try {
            ReferenceEntry<K, V> referenceEntry = segment.newEntry(key, hash, next2);
    ...
    static <K, V> void connectAccessOrder(ReferenceEntry<K, V> previous, ReferenceEntry<K, V> next2) {
        previous.setNextInAccessQueue(next2);
        next2.setPreviousInAccessQueue(previous);
    }
    ...
    static <K, V> void connectWriteOrder(ReferenceEntry<K, V> previous, ReferenceEntry<K, V> next2) {
        previous.setNextInWriteQueue(next2);
        next2.setPreviousInWriteQueue(previous);
    }
    ...
    long longSize() {
        ...
        for (int i = 0; i < segments2.length; ++i) {
            sum2 += (long)Math.max(0, segments2[i].count);
        }
        return sum2;
    }
    ...
    ImmutableMap<K, V> getAllPresent(Iterable<?> keys) {
        int hits = 0;
        int misses = 0;
        LinkedHashMap<?, V> result2 = Maps.newLinkedHashMap();
        for (Object key : keys) {
    ...
    ImmutableMap<K, V> getAll(Iterable<? extends K> keys) throws ExecutionException {
        int hits = 0;
        int misses = 0;
        LinkedHashMap<Object, V> result2 = Maps.newLinkedHashMap();
        ...
        try {
            if (!keysToLoad.isEmpty()) {
                try {
                    ...
                    for (Object key : keysToLoad) {
                        --misses;
                        result2.put(key, this.get(key, this.defaultLoader));
                    }
                }
            }
    ...
    Map<K, V> loadAll(Set<? extends K> keys, CacheLoader<? super K, V> loader) throws ExecutionException {
        ...
        try {
            Map<K, V> map2;
            result2 = map2 = loader.loadAll(keys);
            success = true;
        }
        catch (CacheLoader.UnsupportedLoadingOperationException e) {
            success = true;
        ...
        for (Map.Entry<K, V> entry : result2.entrySet()) {
            K key = entry.getKey();
    ...
    extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new AbstractReferenceEntry<K, V>(){
            ...
            @Override
            public void setNextInAccessQueue(ReferenceEntry<K, V> next2) {
                this.nextAccess = next2;
            }
        ...
        public ReferenceEntry<K, V> peek() {
            ReferenceEntry<K, V> next2 = this.head.getNextInAccessQueue();
            return next2 == this.head ? null : next2;
        }
        ...
        public boolean remove(Object o) {
            ...
            ReferenceEntry next2 = e.getNextInAccessQueue();
            LocalCache.connectAccessOrder(previous, next2);
            LocalCache.nullifyAccessOrder(e);
            return next2 != NullEntry.INSTANCE;
        }
        ...
        public void clear() {
            ...
            while (e != this.head) {
                ReferenceEntry<K, V> next2 = e.getNextInAccessQueue();
                LocalCache.nullifyAccessOrder(e);
                e = next2;
            }
        ...
        public Iterator<ReferenceEntry<K, V>> iterator() {
            return new AbstractSequentialIterator<ReferenceEntry<K, V>>((ReferenceEntry)this.peek()){
                ...
                protected ReferenceEntry<K, V> computeNext(ReferenceEntry<K, V> previous) {
                    ReferenceEntry next2 = previous.getNextInAccessQueue();
                    return next2 == AccessQueue.this.head ? null : next2;
                }
            };
        }
    }
    ...
    extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new AbstractReferenceEntry<K, V>(){
            ...
            @Override
            public void setNextInWriteQueue(ReferenceEntry<K, V> next2) {
                this.nextWrite = next2;
            }
        ...
        @Override
        public ReferenceEntry<K, V> peek() {
            ReferenceEntry<K, V> next2 = this.head.getNextInWriteQueue();
            return next2 == this.head ? null : next2;
        }
        ...
        public boolean remove(Object o) {
            ...
            ReferenceEntry next2 = e.getNextInWriteQueue();
            LocalCache.connectWriteOrder(previous, next2);
        ...
        public void clear() {
            ...
            while (e != this.head) {
                ReferenceEntry<K, V> next2 = e.getNextInWriteQueue();
                LocalCache.nullifyWriteOrder(e);
                e = next2;
            }
        ...
        public Iterator<ReferenceEntry<K, V>> iterator() {
            return new AbstractSequentialIterator<ReferenceEntry<K, V>>((ReferenceEntry)this.peek()){
                ...
                @Override
                protected ReferenceEntry<K, V> computeNext(ReferenceEntry<K, V> previous) {
                    ReferenceEntry next2 = previous.getNextInWriteQueue();
                    return next2 == WriteQueue.this.head ? null : next2;
                }
            };
        }
    }
    ...
    implements ValueReference<K, V> {
        ...
        public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
            try {
                ...
                ListenableFuture<V> result2;
                ListenableFuture<V> listenableFuture = result2 = this.setException(t) ? this.futureValue : this.fullyFailedFuture(t);
    ...
    extends ReentrantLock {
        ...
        Segment(LocalCache<K, V> map2, int initialCapacity, long maxSegmentWeight, AbstractCache.StatsCounter statsCounter) {
            this.map = map2;
            ...
            this.valueReferenceQueue = map2.usesValueReferences() ? new ReferenceQueue() : null;
        ...
        AtomicReferenceArray<ReferenceEntry<K, V>> newEntryArray(int size2) {
            return new AtomicReferenceArray<ReferenceEntry<K, V>>(size2);
        }
        ...
        @GuardedBy(value="this")
        ReferenceEntry<K, V> newEntry(K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
            return this.map.entryFactory.newEntry(this, Preconditions.checkNotNull(key), hash, next2);
        }
        ...
        V refresh(K key, int hash, CacheLoader<? super K, V> loader, boolean checkTime) {
            ...
            ListenableFuture<V> result2 = this.loadAsync(key, hash, loadingValueReference, loader);
            if (result2.isDone()) {
                try {
                    return Uninterruptibles.getUninterruptibly(result2);
                }
                catch (Throwable t) {
                    // empty catch block
                }
        ...
        void expand() {
            ...
            for (int oldIndex = 0; oldIndex < oldCapacity; ++oldIndex) {
                int newIndex;
                ReferenceEntry<K, V> e;
                ReferenceEntry<K, V> head2 = oldTable.get(oldIndex);
                if (head2 == null) continue;
                ReferenceEntry<K, V> next2 = head2.getNext();
                int headIndex = head2.getHash() & newMask;
                if (next2 == null) {
                    newTable.set(headIndex, head2);
                    continue;
                }
                ReferenceEntry<K, V> tail = head2;
        ...
        ReferenceEntry<K, V> removeEntryFromChain(ReferenceEntry<K, V> first, ReferenceEntry<K, V> entry) {
            ...
            for (ReferenceEntry<K, V> e = first; e != entry; e = e.getNext()) {
                ReferenceEntry<K, V> next2 = this.copyEntry(e, newFirst);
                if (next2 != null) {
                    newFirst = next2;
                    continue;
                }
    ...
    extends WeakEntry<K, V> {
        ...
        WeakAccessWriteEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
    ...
    extends WeakEntry<K, V> {
        ...
        WeakWriteEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
            super(queue, key, hash, next2);
        }
    ...
    extends WeakEntry<K, V> {
        ...
        WeakAccessEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
            super(queue, key, hash, next2);
        }
    ...
    implements ReferenceEntry<K, V> {
        ...
        WeakEntry(ReferenceQueue<K> queue, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
            super(key, queue);
            this.hash = hash;
            this.next = next2;
        }
    ...
    extends StrongEntry<K, V> {
        ...
        StrongAccessWriteEntry(K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
    ...
    extends StrongEntry<K, V> {
        ...
        StrongWriteEntry(K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
            super(key, hash, next2);
        }
    ...
    extends StrongEntry<K, V> {
        ...
        StrongAccessEntry(K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
            super(key, hash, next2);
        }
    ...
    extends AbstractReferenceEntry<K, V> {
        ...
        StrongEntry(K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
            this.key = key;
            this.hash = hash;
            this.next = next2;
        }
    ...
    private static enum NullEntry implements ReferenceEntry<Object, Object>
    {
        ...
        @Override
        public void setNextInAccessQueue(ReferenceEntry<Object, Object> next2) {
        }
        ...
        @Override
        public void setNextInWriteQueue(ReferenceEntry<Object, Object> next2) {
        }
    ...
    static enum EntryFactory {
        STRONG{
            ...
            @Override
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
                return new StrongEntry<K, V>(key, hash, next2);
            }
        }
        ,
        STRONG_ACCESS{
            ...
            @Override
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
                return new StrongAccessEntry<K, V>(key, hash, next2);
            }
        ...
        STRONG_WRITE{
            ...
            @Override
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
                return new StrongWriteEntry<K, V>(key, hash, next2);
            }
        ...
        STRONG_ACCESS_WRITE{
            ...
            @Override
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
                return new StrongAccessWriteEntry<K, V>(key, hash, next2);
            }
        ...
        WEAK{
            ...
            @Override
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
                return new WeakEntry(segment.keyReferenceQueue, key, hash, next2);
            }
        }
        ,
        WEAK_ACCESS{
            ...
            @Override
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
                return new WeakAccessEntry(segment.keyReferenceQueue, key, hash, next2);
            }
        ...
        WEAK_WRITE{
            ...
            @Override
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
                return new WeakWriteEntry(segment.keyReferenceQueue, key, hash, next2);
            }
        ...
        WEAK_ACCESS_WRITE{
            ...
            @Override
            <K, V> ReferenceEntry<K, V> newEntry(Segment<K, V> segment, K key, int hash, @Nullable ReferenceEntry<K, V> next2) {
                return new WeakAccessWriteEntry(segment.keyReferenceQueue, key, hash, next2);
            }
