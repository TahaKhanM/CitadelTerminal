...
final class DoubleUtils {
    ...
    static long getSignificand(double d) {
        ...
        return exponent == -1023 ? bits2 << 1 : (bits2 &= 0xFFFFFFFFFFFFFL) | 0x10000000000000L;
    }
    ...
    static double bigToDouble(BigInteger x) {
        ...
        long bits2 = (long)(exponent + 1023) << 52;
        bits2 += signifRounded;
        return Double.longBitsToDouble(bits2 |= (long)x.signum() & Long.MIN_VALUE);
    }
