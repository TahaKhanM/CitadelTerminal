...
public final class LongMath {
    ...
    public static long checkedAdd(long a, long b) {
        long result2 = a + b;
        MathPreconditions.checkNoOverflow((a ^ b) < 0L | (a ^ result2) >= 0L);
        return result2;
    }
    ...
    public static long checkedMultiply(long a, long b) {
        ...
        long result2 = a * b;
        MathPreconditions.checkNoOverflow(a == 0L || result2 / a == b);
        return result2;
    }
    ...
    private static enum MillerRabinTester {
        ...
        LARGE{
            ...
            long mulMod(long a, long b, long m) {
                ...
                long result2 = this.times2ToThe32Mod(aHi * bHi, m);
                if ((result2 += aHi * bLo) < 0L) {
                    result2 = UnsignedLongs.remainder(result2, m);
                }
                result2 += aLo * bHi;
                result2 = this.times2ToThe32Mod(result2, m);
                return this.plusMod(result2, UnsignedLongs.remainder(aLo * bLo, m), m);
            }
            ...
            long squareMod(long a, long m) {
                long aHi = a >>> 32;
                long aLo = a & 0xFFFFFFFFL;
                long result2 = this.times2ToThe32Mod(aHi * aHi, m);
                ...
                result2 += hiLo;
                result2 = this.times2ToThe32Mod(result2, m);
                return this.plusMod(result2, UnsignedLongs.remainder(aLo * aLo, m), m);
            }
        };
