...
implements PreconditionFailureOrBuilder {
    ...
    private static final Parser<PreconditionFailure> PARSER = new AbstractParser<PreconditionFailure>(){

        @Override
        public PreconditionFailure parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new PreconditionFailure(input2, extensionRegistry);
        }
    };
    ...
    private PreconditionFailure(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public boolean equals(Object obj) {
        ...
        PreconditionFailure other = (PreconditionFailure)obj;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + PreconditionFailure.getDescriptor().hashCode();
    ...
    public static PreconditionFailure parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static PreconditionFailure parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static PreconditionFailure parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static PreconditionFailure parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static PreconditionFailure parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static PreconditionFailure parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    @Override
    public Builder newBuilderForType() {
        return PreconditionFailure.newBuilder();
    }
    ...
    implements PreconditionFailureOrBuilder {
        ...
        public PreconditionFailure build() {
            PreconditionFailure result2 = this.buildPartial();
        ...
        public PreconditionFailure buildPartial() {
            PreconditionFailure result2 = new PreconditionFailure(this);
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof PreconditionFailure) {
                return this.mergeFrom((PreconditionFailure)other);
            }
        ...
        public Builder mergeFrom(PreconditionFailure other) {
            if (other == PreconditionFailure.getDefaultInstance()) {
                return this;
            }
            if (this.violationsBuilder_ == null) {
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (PreconditionFailure)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
    ...
    implements ViolationOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if (!this.getSubjectBytes().isEmpty()) {
                GeneratedMessageV3.writeString(output, 2, this.subject_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (!this.getSubjectBytes().isEmpty()) {
                size2 += GeneratedMessageV3.computeStringSize(2, this.subject_);
            }
            if (!this.getDescriptionBytes().isEmpty()) {
