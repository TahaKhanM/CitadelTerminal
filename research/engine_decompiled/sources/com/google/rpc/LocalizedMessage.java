...
implements LocalizedMessageOrBuilder {
    ...
    private static final Parser<LocalizedMessage> PARSER = new AbstractParser<LocalizedMessage>(){

        @Override
        public LocalizedMessage parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new LocalizedMessage(input2, extensionRegistry);
        }
    };
    ...
    private LocalizedMessage(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public void writeTo(CodedOutputStream output) throws IOException {
        if (!this.getLocaleBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 1, this.locale_);
        }
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (!this.getLocaleBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(1, this.locale_);
        }
        if (!this.getMessageBytes().isEmpty()) {
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getLocale().equals(other.getLocale());
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + LocalizedMessage.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public static LocalizedMessage parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static LocalizedMessage parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static LocalizedMessage parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static LocalizedMessage parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static LocalizedMessage parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static LocalizedMessage parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements LocalizedMessageOrBuilder {
        ...
        public LocalizedMessage build() {
            LocalizedMessage result2 = this.buildPartial();
        ...
        public LocalizedMessage buildPartial() {
            LocalizedMessage result2 = new LocalizedMessage(this);
            result2.locale_ = this.locale_;
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof LocalizedMessage) {
                return this.mergeFrom((LocalizedMessage)other);
            }
        ...
        public Builder mergeFrom(LocalizedMessage other) {
            if (other == LocalizedMessage.getDefaultInstance()) {
                return this;
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (LocalizedMessage)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setLocaleBytes(ByteString value) {
            ...
            LocalizedMessage.checkByteStringIsUtf8(value);
            this.locale_ = value;
            this.onChanged();
            return this;
        }
