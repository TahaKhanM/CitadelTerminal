...
public final class StructProto {
    ...
    static {
        ...
        internal_static_google_protobuf_Struct_descriptor = StructProto.getDescriptor().getMessageTypes().get(0);
        ...
        internal_static_google_protobuf_Value_descriptor = StructProto.getDescriptor().getMessageTypes().get(1);
        ...
        internal_static_google_protobuf_ListValue_descriptor = StructProto.getDescriptor().getMessageTypes().get(2);
