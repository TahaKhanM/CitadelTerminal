...
public class TextFormatParseInfoTree {
    ...
    public List<TextFormatParseLocation> getLocations(Descriptors.FieldDescriptor fieldDescriptor) {
        List<TextFormatParseLocation> result2 = this.locationsFromField.get(fieldDescriptor);
    ...
    public List<TextFormatParseInfoTree> getNestedTrees(Descriptors.FieldDescriptor fieldDescriptor) {
        List<TextFormatParseInfoTree> result2 = this.subtreesFromField.get(fieldDescriptor);
        return result2 == null ? Collections.emptyList() : result2;
    }
    ...
    private static <T> T getFromList(List<T> list2, int index, Descriptors.FieldDescriptor fieldDescriptor) {
