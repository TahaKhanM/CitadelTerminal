...
implements ListValueOrBuilder {
    ...
    private static final Parser<ListValue> PARSER = new AbstractParser<ListValue>(){
        ...
        @Override
        public ListValue parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new ListValue(input2, extensionRegistry);
        }
    };
    ...
    private ListValue(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
            ...
            block10: while (!done) {
                ...
                switch (tag) {
                    ...
                    case 10: {
                        ...
                        this.values_.add(input2.readMessage(Value.parser(), extensionRegistry));
                        continue block10;
                    }
                }
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getValuesList().equals(other.getValuesList());
    ...
    public static ListValue parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static ListValue parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static ListValue parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static ListValue parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static ListValue parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static ListValue parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements ListValueOrBuilder {
        ...
        public ListValue build() {
            ListValue result2 = this.buildPartial();
        ...
        public ListValue buildPartial() {
            ListValue result2 = new ListValue(this);
            ...
            if (this.valuesBuilder_ == null) {
                ...
                result2.values_ = this.values_;
            } else {
                result2.values_ = this.valuesBuilder_.build();
            }
            this.onBuilt();
            return result2;
        }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (ListValue)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        private RepeatedFieldBuilderV3<Value, Value.Builder, ValueOrBuilder> getValuesFieldBuilder() {
            if (this.valuesBuilder_ == null) {
                this.valuesBuilder_ = new RepeatedFieldBuilderV3(this.values_, (this.bitField0_ & 1) == 1, this.getParentForChildren(), this.isClean());
                this.values_ = null;
            }
