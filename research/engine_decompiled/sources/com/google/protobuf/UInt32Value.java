...
implements UInt32ValueOrBuilder {
    ...
    private static final Parser<UInt32Value> PARSER = new AbstractParser<UInt32Value>(){
        ...
        @Override
        public UInt32Value parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new UInt32Value(input2, extensionRegistry);
        }
    };
    ...
    private UInt32Value(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (this.value_ != 0) {
            size2 += CodedOutputStream.computeUInt32Size(1, this.value_);
        }
    ...
    public static UInt32Value parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static UInt32Value parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static UInt32Value parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static UInt32Value parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static UInt32Value parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static UInt32Value parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements UInt32ValueOrBuilder {
        ...
        public UInt32Value build() {
            UInt32Value result2 = this.buildPartial();
        ...
        public UInt32Value buildPartial() {
            UInt32Value result2 = new UInt32Value(this);
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (UInt32Value)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
