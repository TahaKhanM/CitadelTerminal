...
implements ApiOrBuilder {
    ...
    private static final Parser<Api> PARSER = new AbstractParser<Api>(){
        ...
        @Override
        public Api parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Api(input2, extensionRegistry);
        }
    };
    ...
    private Api(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
            ...
            block16: while (!done) {
                ...
                switch (tag) {
                    ...
                    case 18: {
                        ...
                        this.methods_.add(input2.readMessage(Method.parser(), extensionRegistry));
                        continue block16;
                    }
                    case 26: {
                    ...
                    case 50: {
                        ...
                        this.mixins_.add(input2.readMessage(Mixin.parser(), extensionRegistry));
                        continue block16;
                    }
                    case 56: {
                        int rawValue;
    ...
    public int getSerializedSize() {
        ...
        for (i = 0; i < this.mixins_.size(); ++i) {
            size2 += CodedOutputStream.computeMessageSize(6, this.mixins_.get(i));
        }
        if (this.syntax_ != Syntax.SYNTAX_PROTO2.getNumber()) {
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getMethodsList().equals(other.getMethodsList());
        result2 = result2 && this.getOptionsList().equals(other.getOptionsList());
        result2 = result2 && this.getVersion().equals(other.getVersion());
        ...
        result2 = result2 && this.getMixinsList().equals(other.getMixinsList());
    ...
    public static Api parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Api parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Api parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Api parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Api parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Api parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements ApiOrBuilder {
        ...
        public Api buildPartial() {
            ...
            if (this.methodsBuilder_ == null) {
                ...
                result2.methods_ = this.methods_;
            } else {
                result2.methods_ = this.methodsBuilder_.build();
            }
            if (this.optionsBuilder_ == null) {
            ...
            if (this.mixinsBuilder_ == null) {
                ...
                result2.mixins_ = this.mixins_;
            } else {
                result2.mixins_ = this.mixinsBuilder_.build();
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Api)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        private RepeatedFieldBuilderV3<Method, Method.Builder, MethodOrBuilder> getMethodsFieldBuilder() {
            if (this.methodsBuilder_ == null) {
                this.methodsBuilder_ = new RepeatedFieldBuilderV3(this.methods_, (this.bitField0_ & 2) == 2, this.getParentForChildren(), this.isClean());
                this.methods_ = null;
            }
        ...
        private RepeatedFieldBuilderV3<Option, Option.Builder, OptionOrBuilder> getOptionsFieldBuilder() {
            if (this.optionsBuilder_ == null) {
                this.optionsBuilder_ = new RepeatedFieldBuilderV3(this.options_, (this.bitField0_ & 4) == 4, this.getParentForChildren(), this.isClean());
                this.options_ = null;
            }
        ...
        private RepeatedFieldBuilderV3<Mixin, Mixin.Builder, MixinOrBuilder> getMixinsFieldBuilder() {
            if (this.mixinsBuilder_ == null) {
                this.mixinsBuilder_ = new RepeatedFieldBuilderV3(this.mixins_, (this.bitField0_ & 0x20) == 32, this.getParentForChildren(), this.isClean());
                this.mixins_ = null;
            }
