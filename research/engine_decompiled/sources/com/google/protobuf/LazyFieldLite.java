...
public class LazyFieldLite {
    ...
    public LazyFieldLite(ExtensionRegistryLite extensionRegistry, ByteString bytes2) {
        LazyFieldLite.checkArguments(extensionRegistry, bytes2);
        this.extensionRegistry = extensionRegistry;
        this.delayedBytes = bytes2;
    }
    ...
    public void mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        if (this.containsDefaultInstance()) {
            this.setByteString(input2.readBytes(), extensionRegistry);
            return;
        }
        if (this.extensionRegistry == null) {
            this.extensionRegistry = extensionRegistry;
        ...
        if (this.delayedBytes != null) {
            this.setByteString(this.delayedBytes.concat(input2.readBytes()), this.extensionRegistry);
            return;
        }
        try {
            this.setValue(this.value.toBuilder().mergeFrom(input2, extensionRegistry).build());
        }
    ...
    public void setByteString(ByteString bytes2, ExtensionRegistryLite extensionRegistry) {
        LazyFieldLite.checkArguments(extensionRegistry, bytes2);
        this.delayedBytes = bytes2;
        this.extensionRegistry = extensionRegistry;
        this.value = null;
    ...
    private static void checkArguments(ExtensionRegistryLite extensionRegistry, ByteString bytes2) {
