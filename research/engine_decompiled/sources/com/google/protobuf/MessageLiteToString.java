...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder buffer, int indent) {
        ...
        for (String getter2 : getters) {
            Method setter2;
            String camelCase;
            String suffix = getter2.replaceFirst("get", "");
            if (suffix.endsWith(LIST_SUFFIX) && !suffix.endsWith(BUILDER_LIST_SUFFIX) && !suffix.equals(LIST_SUFFIX)) {
                ...
                Method listMethod = (Method)nameToNoArgMethod.get(getter2);
            ...
            if (suffix.endsWith(MAP_SUFFIX) && !suffix.equals(MAP_SUFFIX)) {
                ...
                Method mapMethod = (Method)nameToNoArgMethod.get(getter2);
            ...
            if ((setter2 = (Method)nameToMethod.get("set" + suffix)) == null || suffix.endsWith(BYTES_SUFFIX) && nameToNoArgMethod.containsKey("get" + suffix.substring(0, suffix.length() - BYTES_SUFFIX.length()))) continue;
        ...
        if (messageLite instanceof GeneratedMessageLite.ExtendableMessage) {
            ...
            while (iter2.hasNext()) {
                Map.Entry<GeneratedMessageLite.ExtensionDescriptor, Object> entry = iter2.next();
