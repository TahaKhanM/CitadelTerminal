...
implements TimestampOrBuilder {
    ...
    private static final Parser<Timestamp> PARSER = new AbstractParser<Timestamp>(){
        ...
        @Override
        public Timestamp parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Timestamp(input2, extensionRegistry);
        }
    };
    ...
    private Timestamp(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
        ...
        try {
            ...
            block11: while (!done) {
                ...
                switch (tag) {
                    ...
                    case 8: {
                        this.seconds_ = input2.readInt64();
                        continue block11;
                    }
                    case 16: {
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (this.seconds_ != 0L) {
            size2 += CodedOutputStream.computeInt64Size(1, this.seconds_);
        }
        if (this.nanos_ != 0) {
    ...
    public static Timestamp parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Timestamp parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Timestamp parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Timestamp parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Timestamp parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Timestamp parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements TimestampOrBuilder {
        ...
        public Timestamp build() {
            Timestamp result2 = this.buildPartial();
        ...
        public Timestamp buildPartial() {
            Timestamp result2 = new Timestamp(this);
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Timestamp)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
