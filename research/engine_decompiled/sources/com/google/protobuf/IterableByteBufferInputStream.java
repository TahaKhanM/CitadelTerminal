...
extends InputStream {
    ...
    public int read() throws IOException {
        ...
        if (this.hasArray) {
            int result2 = this.currentArray[this.currentByteBufferPos + this.currentArrayOffset] & 0xFF;
            this.updateCurrentByteBufferPos(1);
            return result2;
        }
        int result3 = UnsafeUtil.getByte((long)this.currentByteBufferPos + this.currentAddress) & 0xFF;
        this.updateCurrentByteBufferPos(1);
        return result3;
    }
