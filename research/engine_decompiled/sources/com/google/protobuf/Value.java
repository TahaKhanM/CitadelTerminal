...
implements ValueOrBuilder {
    ...
    private static final Parser<Value> PARSER = new AbstractParser<Value>(){
        ...
        @Override
        public Value parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Value(input2, extensionRegistry);
        }
    };
    ...
    private Value(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
            ...
            block15: while (!done) {
                ...
                switch (tag) {
                    ...
                    case 42: {
                        ...
                        this.kind_ = input2.readMessage(Struct.parser(), extensionRegistry);
                        if (subBuilder != null) {
                    ...
                    case 50: {
                        ...
                        this.kind_ = input2.readMessage(ListValue.parser(), extensionRegistry);
                        if (subBuilder != null) {
    ...
    public NullValue getNullValue() {
        if (this.kindCase_ == 1) {
            NullValue result2 = NullValue.valueOf((Integer)this.kind_);
            return result2 == null ? NullValue.UNRECOGNIZED : result2;
        }
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (this.kindCase_ == 1) {
            size2 += CodedOutputStream.computeEnumSize(1, (Integer)this.kind_);
        }
        if (this.kindCase_ == 2) {
            size2 += CodedOutputStream.computeDoubleSize(2, (Double)this.kind_);
        }
        if (this.kindCase_ == 3) {
            size2 += GeneratedMessageV3.computeStringSize(3, this.kind_);
        }
        if (this.kindCase_ == 4) {
            size2 += CodedOutputStream.computeBoolSize(4, (Boolean)this.kind_);
        }
        if (this.kindCase_ == 5) {
    ...
    public boolean equals(Object obj) {
        ...
        boolean bl = result2 = result2 && this.getKindCase().equals(other.getKindCase());
        if (!result2) {
            return false;
        }
        switch (this.kindCase_) {
            case 1: {
                result2 = result2 && this.getNullValueValue() == other.getNullValueValue();
                break;
            }
            case 2: {
                result2 = result2 && Double.doubleToLongBits(this.getNumberValue()) == Double.doubleToLongBits(other.getNumberValue());
                break;
            }
            case 3: {
                result2 = result2 && this.getStringValue().equals(other.getStringValue());
                break;
            }
            case 4: {
                result2 = result2 && this.getBoolValue() == other.getBoolValue();
                break;
            }
            case 5: {
                result2 = result2 && this.getStructValue().equals(other.getStructValue());
                break;
            }
            case 6: {
                result2 = result2 && this.getListValue().equals(other.getListValue());
                break;
            }
        }
    ...
    public static Value parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Value parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Value parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Value parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Value parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Value parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements ValueOrBuilder {
        ...
        public Value buildPartial() {
            ...
            if (this.kindCase_ == 5) {
                if (this.structValueBuilder_ == null) {
                    ...
                    result2.kind_ = this.structValueBuilder_.build();
                }
            }
            if (this.kindCase_ == 6) {
                if (this.listValueBuilder_ == null) {
                    ...
                    result2.kind_ = this.listValueBuilder_.build();
                }
            }
            result2.kindCase_ = this.kindCase_;
            this.onBuilt();
            return result2;
        }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Value)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
