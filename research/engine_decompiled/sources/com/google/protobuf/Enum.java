...
implements EnumOrBuilder {
    ...
    private static final Parser<Enum> PARSER = new AbstractParser<Enum>(){
        ...
        @Override
        public Enum parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Enum(input2, extensionRegistry);
        }
    };
    ...
    private Enum(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
            ...
            block14: while (!done) {
                ...
                switch (tag) {
                    ...
                    case 18: {
                        ...
                        this.enumvalue_.add(input2.readMessage(EnumValue.parser(), extensionRegistry));
                        continue block14;
                    }
                    case 26: {
    ...
    public int getSerializedSize() {
        ...
        if (this.sourceContext_ != null) {
            size2 += CodedOutputStream.computeMessageSize(4, this.getSourceContext());
        }
        if (this.syntax_ != Syntax.SYNTAX_PROTO2.getNumber()) {
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getEnumvalueList().equals(other.getEnumvalueList());
    ...
    public static Enum parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Enum parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Enum parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Enum parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Enum parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Enum parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements EnumOrBuilder {
        ...
        @Override
        public Enum build() {
            Enum result2 = this.buildPartial();
        ...
        public Enum buildPartial() {
            ...
            if (this.enumvalueBuilder_ == null) {
                ...
                result2.enumvalue_ = this.enumvalue_;
            } else {
                result2.enumvalue_ = this.enumvalueBuilder_.build();
            }
            if (this.optionsBuilder_ == null) {
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Enum)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        private RepeatedFieldBuilderV3<EnumValue, EnumValue.Builder, EnumValueOrBuilder> getEnumvalueFieldBuilder() {
            if (this.enumvalueBuilder_ == null) {
                this.enumvalueBuilder_ = new RepeatedFieldBuilderV3(this.enumvalue_, (this.bitField0_ & 2) == 2, this.getParentForChildren(), this.isClean());
