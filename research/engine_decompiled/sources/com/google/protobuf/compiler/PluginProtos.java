...
public final class PluginProtos {
    ...
    implements CodeGeneratorResponseOrBuilder {
        ...
        public static final Parser<CodeGeneratorResponse> PARSER = new AbstractParser<CodeGeneratorResponse>(){
            ...
            @Override
            public CodeGeneratorResponse parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new CodeGeneratorResponse(input2, extensionRegistry);
            }
        };
        ...
        private CodeGeneratorResponse(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
            ...
            try {
                ...
                block11: while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 10: {
                            ByteString bs = input2.readBytes();
                            this.bitField0_ |= 1;
                            this.error_ = bs;
                            continue block11;
                        }
                        case 122: {
                            ...
                            this.file_.add(input2.readMessage(File.PARSER, extensionRegistry));
                            continue block11;
                        }
                    }
                    if (this.parseUnknownField(input2, unknownFields, extensionRegistry, tag)) continue;
                    done = true;
                }
            }
        ...
        public int getSerializedSize() {
            ...
            size2 = 0;
            if ((this.bitField0_ & 1) == 1) {
                size2 += GeneratedMessageV3.computeStringSize(1, this.error_);
            }
            for (int i = 0; i < this.file_.size(); ++i) {
        ...
        public boolean equals(Object obj) {
            ...
            boolean bl = result2 = result2 && this.hasError() == other.hasError();
            if (this.hasError()) {
                result2 = result2 && this.getError().equals(other.getError());
            }
            result2 = result2 && this.getFileList().equals(other.getFileList());
        ...
        public static CodeGeneratorResponse parseFrom(InputStream input2) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2);
        }

        public static CodeGeneratorResponse parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
        }

        public static CodeGeneratorResponse parseDelimitedFrom(InputStream input2) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
        }

        public static CodeGeneratorResponse parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
        }

        public static CodeGeneratorResponse parseFrom(CodedInputStream input2) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2);
        }

        public static CodeGeneratorResponse parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
        }
        ...
        implements CodeGeneratorResponseOrBuilder {
            ...
            public CodeGeneratorResponse build() {
                CodeGeneratorResponse result2 = this.buildPartial();
            ...
            public CodeGeneratorResponse buildPartial() {
                CodeGeneratorResponse result2 = new CodeGeneratorResponse(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 1) == 1) {
                    to_bitField0_ |= 1;
                }
                result2.error_ = this.error_;
                if (this.fileBuilder_ == null) {
                    ...
                    result2.file_ = this.fileBuilder_.build();
                }
            ...
            public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
                ...
                try {
                    parsedMessage = PARSER.parsePartialFrom(input2, extensionRegistry);
                }
                catch (InvalidProtocolBufferException e) {
            ...
            private RepeatedFieldBuilderV3<File, File.Builder, FileOrBuilder> getFileFieldBuilder() {
                if (this.fileBuilder_ == null) {
                    this.fileBuilder_ = new RepeatedFieldBuilderV3(this.file_, (this.bitField0_ & 2) == 2, this.getParentForChildren(), this.isClean());
                    this.file_ = null;
                }
        ...
        implements FileOrBuilder {
            ...
            public static final Parser<File> PARSER = new AbstractParser<File>(){
                ...
                @Override
                public File parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                    return new File(input2, extensionRegistry);
                }
            };
            ...
            private File(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                this();
                if (extensionRegistry == null) {
                    throw new NullPointerException();
                }
            ...
            public boolean equals(Object obj) {
                ...
                File other = (File)obj;
                boolean result2 = true;
                boolean bl = result2 = result2 && this.hasName() == other.hasName();
                if (this.hasName()) {
                    result2 = result2 && this.getName().equals(other.getName());
                }
                boolean bl2 = result2 = result2 && this.hasInsertionPoint() == other.hasInsertionPoint();
                if (this.hasInsertionPoint()) {
                    result2 = result2 && this.getInsertionPoint().equals(other.getInsertionPoint());
                }
                boolean bl3 = result2 = result2 && this.hasContent() == other.hasContent();
                if (this.hasContent()) {
            ...
            public static File parseFrom(InputStream input2) throws IOException {
                return GeneratedMessageV3.parseWithIOException(PARSER, input2);
            }

            public static File parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
                return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
            }

            public static File parseDelimitedFrom(InputStream input2) throws IOException {
                return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
            }

            public static File parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
                return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
            }

            public static File parseFrom(CodedInputStream input2) throws IOException {
                return GeneratedMessageV3.parseWithIOException(PARSER, input2);
            }

            public static File parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
                return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
            }
            ...
            implements FileOrBuilder {
                ...
                @Override
                public File build() {
                    File result2 = this.buildPartial();
                    if (!result2.isInitialized()) {
                        throw Builder.newUninitializedMessageException(result2);
                    }
                    return result2;
                ...
                public File buildPartial() {
                    ...
                    result2.insertionPoint_ = this.insertionPoint_;
    ...
    implements CodeGeneratorRequestOrBuilder {
        ...
        public static final Parser<CodeGeneratorRequest> PARSER = new AbstractParser<CodeGeneratorRequest>(){
            ...
            @Override
            public CodeGeneratorRequest parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new CodeGeneratorRequest(input2, extensionRegistry);
            }
        };
        ...
        private CodeGeneratorRequest(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
            if (extensionRegistry == null) {
                throw new NullPointerException();
            }
                ...
                block13: while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 26: {
                            ...
                            this.compilerVersion_ = input2.readMessage(Version.PARSER, extensionRegistry);
                            if (subBuilder != null) {
                        ...
                        case 122: {
                            ...
                            this.protoFile_.add(input2.readMessage(DescriptorProtos.FileDescriptorProto.PARSER, extensionRegistry));
                            continue block13;
                        }
                    }
                    if (this.parseUnknownField(input2, unknownFields, extensionRegistry, tag)) continue;
        ...
        public int getSerializedSize() {
            ...
            size2 += dataSize;
            size2 += 1 * this.getFileToGenerateList().size();
            if ((this.bitField0_ & 1) == 1) {
                size2 += GeneratedMessageV3.computeStringSize(2, this.parameter_);
            }
            if ((this.bitField0_ & 2) == 2) {
                size2 += CodedOutputStream.computeMessageSize(3, this.getCompilerVersion());
            }
            for (int i = 0; i < this.protoFile_.size(); ++i) {
                size2 += CodedOutputStream.computeMessageSize(15, this.protoFile_.get(i));
            }
            this.memoizedSize = size2 += this.unknownFields.getSerializedSize();
            return size2;
        }
        ...
        public boolean equals(Object obj) {
            ...
            boolean result2 = true;
            result2 = result2 && this.getFileToGenerateList().equals(other.getFileToGenerateList());
            boolean bl = result2 = result2 && this.hasParameter() == other.hasParameter();
            if (this.hasParameter()) {
                result2 = result2 && this.getParameter().equals(other.getParameter());
            }
            result2 = result2 && this.getProtoFileList().equals(other.getProtoFileList());
            boolean bl2 = result2 = result2 && this.hasCompilerVersion() == other.hasCompilerVersion();
            if (this.hasCompilerVersion()) {
                result2 = result2 && this.getCompilerVersion().equals(other.getCompilerVersion());
            }
            result2 = result2 && this.unknownFields.equals(other.unknownFields);
            return result2;
        }
        ...
        public static CodeGeneratorRequest parseFrom(InputStream input2) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2);
        }

        public static CodeGeneratorRequest parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
        }

        public static CodeGeneratorRequest parseDelimitedFrom(InputStream input2) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
        }

        public static CodeGeneratorRequest parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
        }

        public static CodeGeneratorRequest parseFrom(CodedInputStream input2) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2);
        }

        public static CodeGeneratorRequest parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
        }
        ...
        implements CodeGeneratorRequestOrBuilder {
            ...
            private Version compilerVersion_ = null;
            ...
            public CodeGeneratorRequest build() {
                CodeGeneratorRequest result2 = this.buildPartial();
                if (!result2.isInitialized()) {
                    throw Builder.newUninitializedMessageException(result2);
                }
                return result2;
            ...
            public CodeGeneratorRequest buildPartial() {
                CodeGeneratorRequest result2 = new CodeGeneratorRequest(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((this.bitField0_ & 1) == 1) {
                    this.fileToGenerate_ = this.fileToGenerate_.getUnmodifiableView();
                ...
                result2.fileToGenerate_ = this.fileToGenerate_;
                if ((from_bitField0_ & 2) == 2) {
                    to_bitField0_ |= 1;
                }
                result2.parameter_ = this.parameter_;
                if (this.protoFileBuilder_ == null) {
                    if ((this.bitField0_ & 4) == 4) {
                        this.protoFile_ = Collections.unmodifiableList(this.protoFile_);
                        this.bitField0_ &= 0xFFFFFFFB;
                    }
                    result2.protoFile_ = this.protoFile_;
                } else {
                    result2.protoFile_ = this.protoFileBuilder_.build();
                }
                if ((from_bitField0_ & 8) == 8) {
                    to_bitField0_ |= 2;
                }
                if (this.compilerVersionBuilder_ == null) {
                    result2.compilerVersion_ = this.compilerVersion_;
                } else {
                    result2.compilerVersion_ = this.compilerVersionBuilder_.build();
                }
                result2.bitField0_ = to_bitField0_;
                this.onBuilt();
                return result2;
            ...
            private RepeatedFieldBuilderV3<DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> getProtoFileFieldBuilder() {
                if (this.protoFileBuilder_ == null) {
                    this.protoFileBuilder_ = new RepeatedFieldBuilderV3(this.protoFile_, (this.bitField0_ & 4) == 4, this.getParentForChildren(), this.isClean());
            ...
            public Builder mergeCompilerVersion(Version value) {
                if (this.compilerVersionBuilder_ == null) {
                    this.compilerVersion_ = (this.bitField0_ & 8) == 8 && this.compilerVersion_ != null && this.compilerVersion_ != Version.getDefaultInstance() ? Version.newBuilder(this.compilerVersion_).mergeFrom(value).buildPartial() : value;
                    this.onChanged();
                } else {
    ...
    implements VersionOrBuilder {
        ...
        public static final Parser<Version> PARSER = new AbstractParser<Version>(){
            ...
            @Override
            public Version parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new Version(input2, extensionRegistry);
            }
        };
        ...
        private Version(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
            if (extensionRegistry == null) {
                throw new NullPointerException();
            }
            ...
            try {
                ...
                block13: while (!done) {
                    ...
                    switch (tag) {
                        ...
                        case 8: {
                            this.bitField0_ |= 1;
                            this.major_ = input2.readInt32();
                            continue block13;
                        }
                        case 16: {
                            this.bitField0_ |= 2;
                            this.minor_ = input2.readInt32();
                            continue block13;
                        }
                        case 24: {
                            this.bitField0_ |= 4;
                            this.patch_ = input2.readInt32();
                            continue block13;
                        }
                        case 34: {
                            ByteString bs = input2.readBytes();
        ...
        public int getSerializedSize() {
            ...
            size2 = 0;
            if ((this.bitField0_ & 1) == 1) {
                size2 += CodedOutputStream.computeInt32Size(1, this.major_);
            }
            if ((this.bitField0_ & 2) == 2) {
        ...
        public boolean equals(Object obj) {
            ...
            boolean result2 = true;
            boolean bl = result2 = result2 && this.hasMajor() == other.hasMajor();
            if (this.hasMajor()) {
                result2 = result2 && this.getMajor() == other.getMajor();
            }
            boolean bl2 = result2 = result2 && this.hasMinor() == other.hasMinor();
            if (this.hasMinor()) {
                result2 = result2 && this.getMinor() == other.getMinor();
            }
            boolean bl3 = result2 = result2 && this.hasPatch() == other.hasPatch();
            if (this.hasPatch()) {
                result2 = result2 && this.getPatch() == other.getPatch();
            }
            boolean bl4 = result2 = result2 && this.hasSuffix() == other.hasSuffix();
            if (this.hasSuffix()) {
                result2 = result2 && this.getSuffix().equals(other.getSuffix());
            }
            result2 = result2 && this.unknownFields.equals(other.unknownFields);
            return result2;
        }
        ...
        public static Version parseFrom(InputStream input2) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2);
        }

        public static Version parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
        }

        public static Version parseDelimitedFrom(InputStream input2) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
        }

        public static Version parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
        }

        public static Version parseFrom(CodedInputStream input2) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2);
        }

        public static Version parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
        }
        ...
        implements VersionOrBuilder {
            ...
            public Version build() {
                Version result2 = this.buildPartial();
                if (!result2.isInitialized()) {
                    throw Builder.newUninitializedMessageException(result2);
                }
                return result2;
            ...
            public Version buildPartial() {
                Version result2 = new Version(this);
                int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 1) == 1) {
                    to_bitField0_ |= 1;
                }
                result2.major_ = this.major_;
                if ((from_bitField0_ & 2) == 2) {
                    to_bitField0_ |= 2;
                }
                result2.minor_ = this.minor_;
                if ((from_bitField0_ & 4) == 4) {
                    to_bitField0_ |= 4;
                }
                result2.patch_ = this.patch_;
                if ((from_bitField0_ & 8) == 8) {
                    to_bitField0_ |= 8;
                }
                result2.suffix_ = this.suffix_;
                result2.bitField0_ = to_bitField0_;
                this.onBuilt();
                return result2;
            }
