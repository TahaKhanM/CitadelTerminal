...
implements FloatValueOrBuilder {
    ...
    private static final Parser<FloatValue> PARSER = new AbstractParser<FloatValue>(){
        ...
        @Override
        public FloatValue parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new FloatValue(input2, extensionRegistry);
        }
    };
    ...
    private FloatValue(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (this.value_ != 0.0f) {
            size2 += CodedOutputStream.computeFloatSize(1, this.value_);
        }
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && Float.floatToIntBits(this.getValue()) == Float.floatToIntBits(other.getValue());
    ...
    public static FloatValue parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static FloatValue parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static FloatValue parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static FloatValue parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static FloatValue parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static FloatValue parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements FloatValueOrBuilder {
        ...
        public FloatValue build() {
            FloatValue result2 = this.buildPartial();
        ...
        public FloatValue buildPartial() {
            FloatValue result2 = new FloatValue(this);
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (FloatValue)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
