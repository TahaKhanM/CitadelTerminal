...
implements Serializable {
    ...
    public static final class FieldAccessorTable {
        ...
        private boolean isMapFieldEnabled(Descriptors.FieldDescriptor field2) {
                ...
                for (int i = 0; i < fieldsSize; ++i) {
                    ...
                    if (field2.isRepeated()) {
                        if (field2.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE) {
                            if (field2.isMapField() && this.isMapFieldEnabled(field2)) {
    ...
    implements ExtendableMessageOrBuilder<MessageType> {
        ...
        public final <Type> boolean hasExtension(ExtensionLite<MessageType, Type> extensionLite) {
            Extension extension2 = GeneratedMessage.checkNotLite(extensionLite);
        ...
        @Override
        public final <Type> boolean hasExtension(GeneratedExtension<MessageType, Type> extension2) {
            return this.hasExtension((ExtensionLite<MessageType, Type>)extension2);
        }
        ...
        @Override
        public final <Type> int getExtensionCount(GeneratedExtension<MessageType, List<Type>> extension2) {
            return this.getExtensionCount((ExtensionLite<MessageType, List<Type>>)extension2);
        }
        ...
        @Override
        public final <Type> Type getExtension(GeneratedExtension<MessageType, Type> extension2) {
            return this.getExtension((ExtensionLite<MessageType, Type>)extension2);
        }
        ...
        @Override
        public final <Type> Type getExtension(GeneratedExtension<MessageType, List<Type>> extension2, int index) {
            return this.getExtension((ExtensionLite<MessageType, List<Type>>)extension2, index);
        }
        ...
        public <Type> BuilderType setExtension(GeneratedExtension<MessageType, Type> extension2, Type value) {
            return this.setExtension((ExtensionLite<MessageType, Type>)extension2, value);
        }
        ...
        public <Type> BuilderType setExtension(GeneratedExtension<MessageType, List<Type>> extension2, int index, Type value) {
            return this.setExtension((ExtensionLite<MessageType, List<Type>>)extension2, index, value);
        }
        ...
        public <Type> BuilderType addExtension(GeneratedExtension<MessageType, List<Type>> extension2, Type value) {
            return this.addExtension((ExtensionLite<MessageType, List<Type>>)extension2, value);
        }
        ...
        public <Type> BuilderType clearExtension(GeneratedExtension<MessageType, ?> extension2) {
            return this.clearExtension((ExtensionLite<MessageType, ?>)extension2);
        }
        ...
        @Override
        protected boolean parseUnknownField(CodedInputStream input2, UnknownFieldSet.Builder unknownFields, ExtensionRegistryLite extensionRegistry, int tag) throws IOException {
            return MessageReflection.mergeFieldFrom(input2, unknownFields, extensionRegistry, this.getDescriptorForType(), new MessageReflection.BuilderAdapter(this), tag);
        }
    ...
    implements ExtendableMessageOrBuilder<MessageType> {
        ...
        @Override
        protected boolean parseUnknownField(CodedInputStream input2, UnknownFieldSet.Builder unknownFields, ExtensionRegistryLite extensionRegistry, int tag) throws IOException {
            return MessageReflection.mergeFieldFrom(input2, unknownFields, extensionRegistry, this.getDescriptorForType(), new MessageReflection.ExtensionAdapter(this.extensions), tag);
        }
