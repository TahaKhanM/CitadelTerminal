...
implements OptionOrBuilder {
    ...
    private static final Parser<Option> PARSER = new AbstractParser<Option>(){
        ...
        @Override
        public Option parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Option(input2, extensionRegistry);
        }
    };
    ...
    private Option(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
            ...
            block11: while (!done) {
                ...
                switch (tag) {
                    ...
                    case 18: {
                        ...
                        this.value_ = input2.readMessage(Any.parser(), extensionRegistry);
    ...
    public int getSerializedSize() {
        ...
        if (this.value_ != null) {
            size2 += CodedOutputStream.computeMessageSize(2, this.getValue());
        }
    ...
    public boolean equals(Object obj) {
        ...
        boolean bl = result2 = result2 && this.hasValue() == other.hasValue();
        if (this.hasValue()) {
    ...
    public static Option parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Option parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Option parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Option parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Option parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Option parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements OptionOrBuilder {
        ...
        @Override
        public Option build() {
            Option result2 = this.buildPartial();
        ...
        public Option buildPartial() {
            Option result2 = new Option(this);
            result2.name_ = this.name_;
            if (this.valueBuilder_ == null) {
                result2.value_ = this.value_;
            } else {
                result2.value_ = this.valueBuilder_.build();
            }
            this.onBuilt();
            return result2;
        }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Option)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
