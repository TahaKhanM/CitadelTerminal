...
extends LazyFieldLite {
    ...
    public LazyField(MessageLite defaultInstance, ExtensionRegistryLite extensionRegistry, ByteString bytes2) {
        super(extensionRegistry, bytes2);
    ...
    implements Map.Entry<K, Object> {
        ...
        public Object getValue() {
            LazyField field2 = this.entry.getValue();
            if (field2 == null) {
                return null;
            }
