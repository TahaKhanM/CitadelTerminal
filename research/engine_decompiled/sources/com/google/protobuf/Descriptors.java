...
public final class Descriptors {
    ...
    public static final class OneofDescriptor {
        ...
        static /* synthetic */ FieldDescriptor[] access$1802(OneofDescriptor x0, FieldDescriptor[] x1) {
            x0.fields = x1;
            return x1;
        }
    }
    ...
    private static final class DescriptorPool {
        ...
        GenericDescriptor lookupSymbol(String name, GenericDescriptor relativeTo, SearchFilter filter2) throws DescriptorValidationException {
            ...
            if (name.startsWith(".")) {
                ...
                while (true) {
                    ...
                    if ((dotpos = scopeToTry.lastIndexOf(".")) == -1) {
                        fullname = name;
                        result2 = this.findSymbol(name, filter2);
                        break;
                    }
        ...
        void addFieldByNumber(FieldDescriptor field2) throws DescriptorValidationException {
            ...
            if (old != null) {
                ...
                throw new DescriptorValidationException((GenericDescriptor)field2, "Field number " + field2.getNumber() + " has already been used in \"" + field2.getContainingType().getFullName() + "\" by field \"" + old.getName() + "\".");
            }
        }
    ...
    extends GenericDescriptor {
        ...
        private void crossLink() throws DescriptorValidationException {
            GenericDescriptor input2 = this.file.pool.lookupSymbol(this.proto.getInputType(), this, DescriptorPool.SearchFilter.TYPES_ONLY);
            if (!(input2 instanceof Descriptor)) {
                throw new DescriptorValidationException((GenericDescriptor)this, '\"' + this.proto.getInputType() + "\" is not a message type.");
            }
            this.inputType = (Descriptor)input2;
    ...
    extends GenericDescriptor {
        ...
        public MethodDescriptor findMethodByName(String name) {
            GenericDescriptor result2 = this.file.pool.findSymbol(this.fullName + '.' + name);
    ...
    implements Internal.EnumLiteMap<EnumValueDescriptor> {
        ...
        public EnumValueDescriptor findValueByNumberCreatingIfUnknown(int number) {
            EnumValueDescriptor result2 = this.findValueByNumber(number);
            if (result2 != null) {
                return result2;
            }
            ...
            synchronized (enumDescriptor) {
                ...
                if (reference != null) {
                    result2 = (EnumValueDescriptor)reference.get();
                }
                if (result2 == null) {
                    result2 = new EnumValueDescriptor(this.file, this, key);
                    this.unknownValues.put(key, new WeakReference<EnumValueDescriptor>(result2));
                }
            }
            return result2;
        }
    ...
    FieldSet.FieldDescriptorLite<FieldDescriptor> {
        ...
        private static String fieldNameToJsonName(String name) {
            ...
            for (int i = 0; i < name.length(); ++i) {
                ...
                if (isNextUpperCase) {
                    result2.append(Character.toUpperCase(ch.charValue()));
        ...
        public MessageLite.Builder internalMergeFrom(MessageLite.Builder to2, MessageLite from2) {
            return ((Message.Builder)to2).mergeFrom((Message)from2);
        }
    ...
    extends GenericDescriptor {
        ...
        public boolean isExtensionNumber(int number) {
            for (DescriptorProtos.DescriptorProto.ExtensionRange range2 : this.proto.getExtensionRangeList()) {
                if (range2.getStart() > number || number >= range2.getEnd()) continue;
                return true;
            }
            return false;
        }
        ...
        public boolean isReservedNumber(int number) {
            for (DescriptorProtos.DescriptorProto.ReservedRange range2 : this.proto.getReservedRangeList()) {
                if (range2.getStart() > number || number >= range2.getEnd()) continue;
                return true;
            }
            return false;
        ...
        private Descriptor(DescriptorProtos.DescriptorProto proto, FileDescriptor file, Descriptor parent, int index) throws DescriptorValidationException {
            ...
            for (i = 0; i < proto.getOneofDeclCount(); ++i) {
                OneofDescriptor.access$1802(this.oneofs[i], new FieldDescriptor[this.oneofs[i].getFieldCount()]);
    ...
    extends GenericDescriptor {
        ...
        public Descriptor findMessageTypeByName(String name) {
            ...
            if ((result2 = this.pool.findSymbol(name)) != null && result2 instanceof Descriptor && result2.getFile() == this) {
                return (Descriptor)result2;
            }
            return null;
        }
        ...
        public EnumDescriptor findEnumTypeByName(String name) {
            ...
            if ((result2 = this.pool.findSymbol(name)) != null && result2 instanceof EnumDescriptor && result2.getFile() == this) {
                return (EnumDescriptor)result2;
            }
            return null;
        }
        ...
        public ServiceDescriptor findServiceByName(String name) {
            ...
            if ((result2 = this.pool.findSymbol(name)) != null && result2 instanceof ServiceDescriptor && result2.getFile() == this) {
        ...
        public FieldDescriptor findExtensionByName(String name) {
            ...
            if ((result2 = this.pool.findSymbol(name)) != null && result2 instanceof FieldDescriptor && result2.getFile() == this) {
                return (FieldDescriptor)result2;
            }
            return null;
        }
        ...
        public static FileDescriptor buildFrom(DescriptorProtos.FileDescriptorProto proto, FileDescriptor[] dependencies, boolean allowUnknownDependencies) throws DescriptorValidationException {
            ...
            FileDescriptor result2 = new FileDescriptor(proto, dependencies, pool, allowUnknownDependencies);
            result2.crossLink();
            return result2;
        }
        ...
        public static void internalBuildGeneratedFileFrom(String[] descriptorDataParts, FileDescriptor[] dependencies, InternalDescriptorAssigner descriptorAssigner) {
            ...
            try {
                result2 = FileDescriptor.buildFrom(proto, dependencies, true);
            }
            catch (DescriptorValidationException e) {
        ...
        public static void internalUpdateFileDescriptor(FileDescriptor descriptor, ExtensionRegistry registry) {
            DescriptorProtos.FileDescriptorProto proto;
            ByteString bytes2 = descriptor.proto.toByteString();
            try {
                proto = DescriptorProtos.FileDescriptorProto.parseFrom(bytes2, (ExtensionRegistryLite)registry);
            }
            catch (InvalidProtocolBufferException e) {
                throw new IllegalArgumentException("Failed to parse protocol buffer descriptor for generated code.", e);
            }
