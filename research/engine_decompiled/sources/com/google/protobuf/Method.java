...
implements MethodOrBuilder {
    ...
    private static final Parser<Method> PARSER = new AbstractParser<Method>(){
        ...
        @Override
        public Method parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Method(input2, extensionRegistry);
        }
    };
    ...
    private Method(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
            ...
            block16: while (!done) {
                ...
                switch (tag) {
                    ...
                    case 18: {
                        ...
                        this.requestTypeUrl_ = s3;
                        continue block16;
                    }
                    case 24: {
                        this.requestStreaming_ = input2.readBool();
                        continue block16;
                    }
                    case 34: {
                        String s4 = input2.readStringRequireUtf8();
                        this.responseTypeUrl_ = s4;
                        continue block16;
                    }
                    case 40: {
                        this.responseStreaming_ = input2.readBool();
                        continue block16;
                    }
                    case 50: {
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getRequestTypeUrl().equals(other.getRequestTypeUrl());
        result2 = result2 && this.getRequestStreaming() == other.getRequestStreaming();
        result2 = result2 && this.getResponseTypeUrl().equals(other.getResponseTypeUrl());
        result2 = result2 && this.getResponseStreaming() == other.getResponseStreaming();
    ...
    public static Method parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Method parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Method parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Method parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Method parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Method parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements MethodOrBuilder {
        ...
        @Override
        public Method build() {
            Method result2 = this.buildPartial();
        ...
        public Method buildPartial() {
            Method result2 = new Method(this);
            int from_bitField0_ = this.bitField0_;
            int to_bitField0_ = 0;
            result2.name_ = this.name_;
            result2.requestTypeUrl_ = this.requestTypeUrl_;
            result2.requestStreaming_ = this.requestStreaming_;
            result2.responseTypeUrl_ = this.responseTypeUrl_;
            result2.responseStreaming_ = this.responseStreaming_;
            if (this.optionsBuilder_ == null) {
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Method)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        private RepeatedFieldBuilderV3<Option, Option.Builder, OptionOrBuilder> getOptionsFieldBuilder() {
            if (this.optionsBuilder_ == null) {
                this.optionsBuilder_ = new RepeatedFieldBuilderV3(this.options_, (this.bitField0_ & 0x20) == 32, this.getParentForChildren(), this.isClean());
                this.options_ = null;
            }
