...
implements SourceContextOrBuilder {
    ...
    private static final Parser<SourceContext> PARSER = new AbstractParser<SourceContext>(){
        ...
        @Override
        public SourceContext parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new SourceContext(input2, extensionRegistry);
        }
    };
    ...
    private SourceContext(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (!this.getFileNameBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(1, this.fileName_);
        }
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getFileName().equals(other.getFileName());
    ...
    public static SourceContext parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static SourceContext parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static SourceContext parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static SourceContext parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static SourceContext parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static SourceContext parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements SourceContextOrBuilder {
        ...
        public SourceContext build() {
            SourceContext result2 = this.buildPartial();
        ...
        public SourceContext buildPartial() {
            SourceContext result2 = new SourceContext(this);
            result2.fileName_ = this.fileName_;
            this.onBuilt();
            return result2;
        }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (SourceContext)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
