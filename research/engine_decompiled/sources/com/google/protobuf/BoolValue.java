...
implements BoolValueOrBuilder {
    ...
    private static final Parser<BoolValue> PARSER = new AbstractParser<BoolValue>(){
        ...
        @Override
        public BoolValue parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new BoolValue(input2, extensionRegistry);
        }
    };
    ...
    private BoolValue(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (this.value_) {
            size2 += CodedOutputStream.computeBoolSize(1, this.value_);
        }
    ...
    public static BoolValue parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static BoolValue parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static BoolValue parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static BoolValue parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static BoolValue parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static BoolValue parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements BoolValueOrBuilder {
        ...
        public BoolValue build() {
            BoolValue result2 = this.buildPartial();
        ...
        public BoolValue buildPartial() {
            BoolValue result2 = new BoolValue(this);
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (BoolValue)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
