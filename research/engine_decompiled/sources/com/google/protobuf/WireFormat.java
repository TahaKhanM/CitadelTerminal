...
public final class WireFormat {
    ...
    static Object readPrimitiveField(CodedInputStream input2, FieldType type, Utf8Validation utf8Validation) throws IOException {
        switch (type) {
            case DOUBLE: {
            ...
            case STRING: {
                return utf8Validation.readString(input2);
            }
            case GROUP: {
    ...
    static enum Utf8Validation {
        LOOSE{
            ...
            @Override
            Object readString(CodedInputStream input2) throws IOException {
