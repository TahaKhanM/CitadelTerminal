...
implements AuthRequirementOrBuilder {
    ...
    private static final Parser<AuthRequirement> PARSER = new AbstractParser<AuthRequirement>(){

        @Override
        public AuthRequirement parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new AuthRequirement(input2, extensionRegistry);
        }
    };
    ...
    private AuthRequirement(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public void writeTo(CodedOutputStream output) throws IOException {
        if (!this.getProviderIdBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 1, this.providerId_);
        }
        if (!this.getAudiencesBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 2, this.audiences_);
        }
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (!this.getProviderIdBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(1, this.providerId_);
        }
        if (!this.getAudiencesBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(2, this.audiences_);
        }
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getProviderId().equals(other.getProviderId());
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + AuthRequirement.getDescriptor().hashCode();
        hash = 37 * hash + 1;
        hash = 53 * hash + this.getProviderId().hashCode();
        hash = 37 * hash + 2;
    ...
    public static AuthRequirement parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static AuthRequirement parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static AuthRequirement parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static AuthRequirement parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static AuthRequirement parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static AuthRequirement parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    @Override
    public Builder newBuilderForType() {
        return AuthRequirement.newBuilder();
    }
    ...
    implements AuthRequirementOrBuilder {
        ...
        public AuthRequirement build() {
            AuthRequirement result2 = this.buildPartial();
        ...
        public AuthRequirement buildPartial() {
            AuthRequirement result2 = new AuthRequirement(this);
            result2.providerId_ = this.providerId_;
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof AuthRequirement) {
                return this.mergeFrom((AuthRequirement)other);
            }
        ...
        public Builder mergeFrom(AuthRequirement other) {
            if (other == AuthRequirement.getDefaultInstance()) {
                return this;
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (AuthRequirement)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setProviderIdBytes(ByteString value) {
            ...
            AuthRequirement.checkByteStringIsUtf8(value);
            this.providerId_ = value;
            this.onChanged();
            return this;
        }
