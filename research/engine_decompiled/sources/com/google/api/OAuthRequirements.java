...
implements OAuthRequirementsOrBuilder {
    ...
    private static final Parser<OAuthRequirements> PARSER = new AbstractParser<OAuthRequirements>(){

        @Override
        public OAuthRequirements parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new OAuthRequirements(input2, extensionRegistry);
        }
    };
    ...
    private OAuthRequirements(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public String getCanonicalScopes() {
        Object ref = this.canonicalScopes_;
    ...
    public void writeTo(CodedOutputStream output) throws IOException {
        if (!this.getCanonicalScopesBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 1, this.canonicalScopes_);
        }
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (!this.getCanonicalScopesBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(1, this.canonicalScopes_);
        }
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getCanonicalScopes().equals(other.getCanonicalScopes());
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + OAuthRequirements.getDescriptor().hashCode();
        hash = 37 * hash + 1;
        hash = 53 * hash + this.getCanonicalScopes().hashCode();
    ...
    public static OAuthRequirements parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static OAuthRequirements parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static OAuthRequirements parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static OAuthRequirements parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static OAuthRequirements parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static OAuthRequirements parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    @Override
    public Builder newBuilderForType() {
        return OAuthRequirements.newBuilder();
    }
    ...
    implements OAuthRequirementsOrBuilder {
        ...
        public OAuthRequirements build() {
            OAuthRequirements result2 = this.buildPartial();
        ...
        public OAuthRequirements buildPartial() {
            OAuthRequirements result2 = new OAuthRequirements(this);
            result2.canonicalScopes_ = this.canonicalScopes_;
            this.onBuilt();
            return result2;
        }
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof OAuthRequirements) {
                return this.mergeFrom((OAuthRequirements)other);
            }
        ...
        public Builder mergeFrom(OAuthRequirements other) {
            if (other == OAuthRequirements.getDefaultInstance()) {
                return this;
            }
            if (!other.getCanonicalScopes().isEmpty()) {
                this.canonicalScopes_ = other.canonicalScopes_;
                this.onChanged();
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (OAuthRequirements)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setCanonicalScopesBytes(ByteString value) {
            ...
            OAuthRequirements.checkByteStringIsUtf8(value);
            this.canonicalScopes_ = value;
            this.onChanged();
            return this;
        }
