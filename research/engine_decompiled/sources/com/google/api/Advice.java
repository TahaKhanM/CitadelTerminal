...
implements AdviceOrBuilder {
    ...
    private static final Parser<Advice> PARSER = new AbstractParser<Advice>(){

        @Override
        public Advice parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Advice(input2, extensionRegistry);
        }
    };
    ...
    private Advice(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + Advice.getDescriptor().hashCode();
        hash = 37 * hash + 2;
    ...
    public static Advice parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Advice parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Advice parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Advice parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Advice parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Advice parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    @Override
    public Builder newBuilderForType() {
        return Advice.newBuilder();
    }
    ...
    implements AdviceOrBuilder {
        ...
        @Override
        public Advice build() {
            Advice result2 = this.buildPartial();
        ...
        public Advice buildPartial() {
            Advice result2 = new Advice(this);
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof Advice) {
                return this.mergeFrom((Advice)other);
            }
        ...
        public Builder mergeFrom(Advice other) {
            if (other == Advice.getDefaultInstance()) {
                return this;
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Advice)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setDescriptionBytes(ByteString value) {
            ...
            Advice.checkByteStringIsUtf8(value);
            this.description_ = value;
            this.onChanged();
            return this;
        }
