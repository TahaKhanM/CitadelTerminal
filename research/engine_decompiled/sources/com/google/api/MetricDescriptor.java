...
implements MetricDescriptorOrBuilder {
    ...
    private static final Parser<MetricDescriptor> PARSER = new AbstractParser<MetricDescriptor>(){

        @Override
        public MetricDescriptor parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new MetricDescriptor(input2, extensionRegistry);
        }
    };
    ...
    private MetricDescriptor(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
        ...
        try {
            ...
            block17: while (!done) {
                ...
                switch (tag) {
                    ...
                    default: {
                        if (this.parseUnknownFieldProto3(input2, unknownFields, extensionRegistry, tag)) continue block17;
                        done = true;
                        continue block17;
                    }
                    case 10: {
                    ...
                    case 24: {
                        int rawValue;
                        this.metricKind_ = rawValue = input2.readEnum();
                        continue block17;
                    }
                    case 32: {
                        int rawValue;
    ...
    public MetricKind getMetricKind() {
        MetricKind result2 = MetricKind.valueOf(this.metricKind_);
        return result2 == null ? MetricKind.UNRECOGNIZED : result2;
    }
    ...
    public void writeTo(CodedOutputStream output) throws IOException {
        ...
        if (!this.getUnitBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 5, this.unit_);
        }
        if (!this.getDescriptionBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 6, this.description_);
        }
        if (!this.getDisplayNameBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 7, this.displayName_);
        }
        if (!this.getTypeBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 8, this.type_);
        }
    ...
    public int getSerializedSize() {
        ...
        if (!this.getUnitBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(5, this.unit_);
        }
        if (!this.getDescriptionBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(6, this.description_);
        }
        if (!this.getDisplayNameBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(7, this.displayName_);
        }
        if (!this.getTypeBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(8, this.type_);
        }
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.metricKind_ == other.metricKind_;
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MetricDescriptor.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public static MetricDescriptor parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static MetricDescriptor parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static MetricDescriptor parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static MetricDescriptor parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static MetricDescriptor parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static MetricDescriptor parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements MetricDescriptorOrBuilder {
        ...
        public MetricDescriptor build() {
            MetricDescriptor result2 = this.buildPartial();
        ...
        public MetricDescriptor buildPartial() {
            MetricDescriptor result2 = new MetricDescriptor(this);
            ...
            result2.metricKind_ = this.metricKind_;
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof MetricDescriptor) {
                return this.mergeFrom((MetricDescriptor)other);
            }
        ...
        public Builder mergeFrom(MetricDescriptor other) {
            if (other == MetricDescriptor.getDefaultInstance()) {
                return this;
            }
            ...
            if (other.metricKind_ != 0) {
                this.setMetricKindValue(other.getMetricKindValue());
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (MetricDescriptor)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setNameBytes(ByteString value) {
            ...
            MetricDescriptor.checkByteStringIsUtf8(value);
            this.name_ = value;
            this.onChanged();
            return this;
        }
        ...
        private RepeatedFieldBuilderV3<LabelDescriptor, LabelDescriptor.Builder, LabelDescriptorOrBuilder> getLabelsFieldBuilder() {
            if (this.labelsBuilder_ == null) {
                this.labelsBuilder_ = new RepeatedFieldBuilderV3(this.labels_, (this.bitField0_ & 4) == 4, this.getParentForChildren(), this.isClean());
                this.labels_ = null;
            }
    ...
    public static enum MetricKind implements ProtocolMessageEnum
    {
        ...
        public static MetricKind valueOf(int value) {
            return MetricKind.forNumber(value);
        }
        ...
        @Override
        public final Descriptors.EnumValueDescriptor getValueDescriptor() {
            return MetricKind.getDescriptor().getValues().get(this.ordinal());
        }

        @Override
        public final Descriptors.EnumDescriptor getDescriptorForType() {
            return MetricKind.getDescriptor();
        }
        ...
        public static MetricKind valueOf(Descriptors.EnumValueDescriptor desc) {
            if (desc.getType() != MetricKind.getDescriptor()) {
                throw new IllegalArgumentException("EnumValueDescriptor is not for this type.");
            }
            if (desc.getIndex() == -1) {
                return UNRECOGNIZED;
