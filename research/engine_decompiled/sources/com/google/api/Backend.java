...
implements BackendOrBuilder {
    ...
    private static final Parser<Backend> PARSER = new AbstractParser<Backend>(){

        @Override
        public Backend parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Backend(input2, extensionRegistry);
        }
    };
    ...
    private Backend(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
        ...
        try {
            ...
            block10: while (!done) {
                ...
                this.rules_.add(input2.readMessage(BackendRule.parser(), extensionRegistry));
            }
        }
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + Backend.getDescriptor().hashCode();
    ...
    public static Backend parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Backend parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Backend parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Backend parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Backend parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Backend parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements BackendOrBuilder {
        ...
        public Backend build() {
            Backend result2 = this.buildPartial();
        ...
        public Backend buildPartial() {
            Backend result2 = new Backend(this);
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof Backend) {
                return this.mergeFrom((Backend)other);
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            Backend parsedMessage = null;
            try {
                parsedMessage = (Backend)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
                parsedMessage = (Backend)e.getUnfinishedMessage();
        ...
        public BackendRule.Builder addRulesBuilder() {
            return this.getRulesFieldBuilder().addBuilder(BackendRule.getDefaultInstance());
        }

        public BackendRule.Builder addRulesBuilder(int index) {
            return this.getRulesFieldBuilder().addBuilder(index, BackendRule.getDefaultInstance());
        }
