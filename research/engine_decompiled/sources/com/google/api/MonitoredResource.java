...
implements MonitoredResourceOrBuilder {
    ...
    private static final Parser<MonitoredResource> PARSER = new AbstractParser<MonitoredResource>(){

        @Override
        public MonitoredResource parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new MonitoredResource(input2, extensionRegistry);
        }
    };
    ...
    private MonitoredResource(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MonitoredResource.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public static MonitoredResource parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static MonitoredResource parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static MonitoredResource parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static MonitoredResource parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static MonitoredResource parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static MonitoredResource parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements MonitoredResourceOrBuilder {
        ...
        public MonitoredResource build() {
            MonitoredResource result2 = this.buildPartial();
        ...
        public MonitoredResource buildPartial() {
            MonitoredResource result2 = new MonitoredResource(this);
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof MonitoredResource) {
                return this.mergeFrom((MonitoredResource)other);
            }
        ...
        public Builder mergeFrom(MonitoredResource other) {
            if (other == MonitoredResource.getDefaultInstance()) {
                return this;
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (MonitoredResource)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setTypeBytes(ByteString value) {
            ...
            MonitoredResource.checkByteStringIsUtf8(value);
            this.type_ = value;
            this.onChanged();
            return this;
        }
