...
extends CharMatcher.NamedFastMatcher {
    ...
    private SmallCharMatcher(char[] table, long filter2, boolean containsZero, String description) {
        super(description);
        this.table = table;
        this.filter = filter2;
    ...
    static CharMatcher from(BitSet chars, String description) {
        ...
        return new SmallCharMatcher(table, filter2, containsZero, description);
    }
