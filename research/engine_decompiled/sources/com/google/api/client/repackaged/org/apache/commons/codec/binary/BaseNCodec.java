...
BinaryDecoder {
    ...
    protected void ensureBufferSize(int size2) {
        if (this.buffer == null || this.buffer.length < this.pos + size2) {
            this.resizeBuffer();
        }
    }
    ...
    public byte[] decode(byte[] pArray) {
        ...
        byte[] result2 = new byte[this.pos];
        this.readResults(result2, 0, result2.length);
        return result2;
    }
