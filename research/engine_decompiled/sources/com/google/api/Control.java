...
implements ControlOrBuilder {
    ...
    private static final Parser<Control> PARSER = new AbstractParser<Control>(){

        @Override
        public Control parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Control(input2, extensionRegistry);
        }
    };
    ...
    private Control(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public void writeTo(CodedOutputStream output) throws IOException {
        if (!this.getEnvironmentBytes().isEmpty()) {
            GeneratedMessageV3.writeString(output, 1, this.environment_);
        }
    ...
    public int getSerializedSize() {
        ...
        size2 = 0;
        if (!this.getEnvironmentBytes().isEmpty()) {
            size2 += GeneratedMessageV3.computeStringSize(1, this.environment_);
        }
    ...
    public boolean equals(Object obj) {
        ...
        result2 = result2 && this.getEnvironment().equals(other.getEnvironment());
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + Control.getDescriptor().hashCode();
        hash = 37 * hash + 1;
        hash = 53 * hash + this.getEnvironment().hashCode();
    ...
    public static Control parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Control parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Control parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Control parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Control parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Control parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements ControlOrBuilder {
        ...
        public Control build() {
            Control result2 = this.buildPartial();
        ...
        public Control buildPartial() {
            Control result2 = new Control(this);
            result2.environment_ = this.environment_;
            this.onBuilt();
            return result2;
        }
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof Control) {
                return this.mergeFrom((Control)other);
            }
        ...
        public Builder mergeFrom(Control other) {
            if (other == Control.getDefaultInstance()) {
                return this;
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Control)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setEnvironmentBytes(ByteString value) {
            ...
            Control.checkByteStringIsUtf8(value);
            this.environment_ = value;
            this.onChanged();
            return this;
        }
