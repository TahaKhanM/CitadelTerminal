...
implements ContextOrBuilder {
    ...
    private static final Parser<Context> PARSER = new AbstractParser<Context>(){

        @Override
        public Context parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new Context(input2, extensionRegistry);
        }
    };
    ...
    private Context(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
        ...
        try {
            ...
            block10: while (!done) {
                ...
                this.rules_.add(input2.readMessage(ContextRule.parser(), extensionRegistry));
            }
        }
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + Context.getDescriptor().hashCode();
    ...
    public static Context parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Context parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Context parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static Context parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static Context parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static Context parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements ContextOrBuilder {
        ...
        public Context build() {
            Context result2 = this.buildPartial();
        ...
        public Context buildPartial() {
            Context result2 = new Context(this);
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof Context) {
                return this.mergeFrom((Context)other);
            }
        ...
        public Builder mergeFrom(Context other) {
            if (other == Context.getDefaultInstance()) {
                return this;
            }
            if (this.rulesBuilder_ == null) {
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (Context)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public ContextRule.Builder addRulesBuilder() {
            return this.getRulesFieldBuilder().addBuilder(ContextRule.getDefaultInstance());
        }

        public ContextRule.Builder addRulesBuilder(int index) {
            return this.getRulesFieldBuilder().addBuilder(index, ContextRule.getDefaultInstance());
        }
