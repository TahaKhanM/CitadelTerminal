...
implements GetOperationRequestOrBuilder {
    ...
    private static final Parser<GetOperationRequest> PARSER = new AbstractParser<GetOperationRequest>(){

        @Override
        public GetOperationRequest parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new GetOperationRequest(input2, extensionRegistry);
        }
    };
    ...
    private GetOperationRequest(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + GetOperationRequest.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public static GetOperationRequest parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static GetOperationRequest parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static GetOperationRequest parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static GetOperationRequest parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static GetOperationRequest parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static GetOperationRequest parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }
    ...
    implements GetOperationRequestOrBuilder {
        ...
        public GetOperationRequest build() {
            GetOperationRequest result2 = this.buildPartial();
        ...
        public GetOperationRequest buildPartial() {
            GetOperationRequest result2 = new GetOperationRequest(this);
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof GetOperationRequest) {
                return this.mergeFrom((GetOperationRequest)other);
            }
        ...
        public Builder mergeFrom(GetOperationRequest other) {
            if (other == GetOperationRequest.getDefaultInstance()) {
                return this;
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            try {
                parsedMessage = (GetOperationRequest)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
        ...
        public Builder setNameBytes(ByteString value) {
            ...
            GetOperationRequest.checkByteStringIsUtf8(value);
            this.name_ = value;
            this.onChanged();
            return this;
        }
