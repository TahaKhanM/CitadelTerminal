...
implements CancelOperationRequestOrBuilder {
    ...
    private static final Parser<CancelOperationRequest> PARSER = new AbstractParser<CancelOperationRequest>(){

        @Override
        public CancelOperationRequest parsePartialFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return new CancelOperationRequest(input2, extensionRegistry);
        }
    };
    ...
    private CancelOperationRequest(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + CancelOperationRequest.getDescriptor().hashCode();
        hash = 37 * hash + 1;
    ...
    public static CancelOperationRequest parseFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static CancelOperationRequest parseFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    public static CancelOperationRequest parseDelimitedFrom(InputStream input2) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2);
    }

    public static CancelOperationRequest parseDelimitedFrom(InputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input2, extensionRegistry);
    }

    public static CancelOperationRequest parseFrom(CodedInputStream input2) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2);
    }

    public static CancelOperationRequest parseFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
        return GeneratedMessageV3.parseWithIOException(PARSER, input2, extensionRegistry);
    }

    @Override
    public Builder newBuilderForType() {
        return CancelOperationRequest.newBuilder();
    }
    ...
    implements CancelOperationRequestOrBuilder {
        ...
        public CancelOperationRequest build() {
            CancelOperationRequest result2 = this.buildPartial();
        ...
        public CancelOperationRequest buildPartial() {
            CancelOperationRequest result2 = new CancelOperationRequest(this);
        ...
        public Builder mergeFrom(Message other) {
            if (other instanceof CancelOperationRequest) {
                return this.mergeFrom((CancelOperationRequest)other);
            }
            super.mergeFrom(other);
            return this;
        }

        public Builder mergeFrom(CancelOperationRequest other) {
            if (other == CancelOperationRequest.getDefaultInstance()) {
                return this;
            }
        ...
        public Builder mergeFrom(CodedInputStream input2, ExtensionRegistryLite extensionRegistry) throws IOException {
            CancelOperationRequest parsedMessage = null;
            try {
                parsedMessage = (CancelOperationRequest)PARSER.parsePartialFrom(input2, extensionRegistry);
            }
            catch (InvalidProtocolBufferException e) {
                parsedMessage = (CancelOperationRequest)e.getUnfinishedMessage();
        ...
        public Builder setNameBytes(ByteString value) {
            ...
            CancelOperationRequest.checkByteStringIsUtf8(value);
            this.name_ = value;
            this.onChanged();
            return this;
        }
