...
public final class JsonStringEncoder {
    ...
    public char[] quoteAsString(String input2) {
        ...
        block0: while (inPtr < inputLen) {
            ...
            int n = length = (escCode = escCodes[d = input2.charAt(inPtr++)]) < 0 ? this._appendNumericEscape(d, this._quoteBuffer) : this._appendNamedEscape(escCode, this._quoteBuffer);
    ...
    public byte[] quoteAsUTF8(String text) {
        ...
        block0: while (inputPtr < inputEnd) {
            ...
            if ((ch = text.charAt(inputPtr++)) <= 127) {
                ...
                outputPtr = this._appendByteEscape(ch, escape2, byteBuilder, outputPtr);
