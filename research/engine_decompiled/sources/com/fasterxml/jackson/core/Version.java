...
Serializable {
    ...
    public int compareTo(Version other) {
        ...
        int diff2 = this._groupId.compareTo(other._groupId);
        if (diff2 == 0 && (diff2 = this._artifactId.compareTo(other._artifactId)) == 0 && (diff2 = this._majorVersion - other._majorVersion) == 0 && (diff2 = this._minorVersion - other._minorVersion) == 0) {
            diff2 = this._patchLevel - other._patchLevel;
        }
        return diff2;
    }
}
