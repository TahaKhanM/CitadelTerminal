...
extends GlobalDisplayEvent {
    ...
    public GlobalAttack(Object source, Coords srcLocation, Coords targetLocation, float damage, int typeID, String srcID, String targetID, int srcPID) {
        super(source);
    ...
    public Object[] inPerspective(int playerPerspective) {
        Object[] ret = new Object[]{MapHelper.convertUserEncodePerspective(this.srcLocation.x, this.srcLocation.y, playerPerspective), MapHelper.convertUserEncodePerspective(this.targetLocation.x, this.targetLocation.y, playerPerspective), Float.valueOf(this.damage), this.typeID, this.srcID, this.targetID, GlobalAttack.samePlayerToPlayerID(this.srcPID == playerPerspective)};
        return ret;
    }
}
