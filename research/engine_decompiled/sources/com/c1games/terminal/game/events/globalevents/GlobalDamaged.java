...
extends GlobalDisplayEvent {
    ...
    public GlobalDamaged(Object source, Coords srcLocation, float damage, int typeID, String srcID, int srcPID) {
        super(source);
    ...
    public Object[] inPerspective(int playerPerspective) {
        Object[] ret = new Object[]{MapHelper.convertUserEncodePerspective(this.srcLocation.x, this.srcLocation.y, playerPerspective), Float.valueOf(this.damage), this.typeID, this.srcID, GlobalDamaged.samePlayerToPlayerID(this.srcPID == playerPerspective)};
        return ret;
    }
}
