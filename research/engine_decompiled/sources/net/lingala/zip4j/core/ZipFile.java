...
public class ZipFile {
    ...
    public void extractAll(String destPath, UnzipParameters unzipParameters) throws ZipException {
        ...
        Unzip unzip2 = new Unzip(this.zipModel);
        unzip2.extractAll(unzipParameters, destPath, this.progressMonitor, this.runInThread);
    }
    ...
    public ZipInputStream getInputStream(FileHeader fileHeader) throws ZipException {
        ...
        Unzip unzip2 = new Unzip(this.zipModel);
        return unzip2.getInputStream(fileHeader);
    }
