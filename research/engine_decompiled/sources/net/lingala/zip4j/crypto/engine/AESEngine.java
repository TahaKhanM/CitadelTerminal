...
public class AESEngine {
    ...
    private final void stateIn(byte[] bytes2, int off) {
        int index = off;
        this.C0 = bytes2[index++] & 0xFF;
        this.C0 |= (bytes2[index++] & 0xFF) << 8;
        this.C0 |= (bytes2[index++] & 0xFF) << 16;
        this.C0 |= bytes2[index++] << 24;
        this.C1 = bytes2[index++] & 0xFF;
        this.C1 |= (bytes2[index++] & 0xFF) << 8;
        this.C1 |= (bytes2[index++] & 0xFF) << 16;
        this.C1 |= bytes2[index++] << 24;
        this.C2 = bytes2[index++] & 0xFF;
        this.C2 |= (bytes2[index++] & 0xFF) << 8;
        this.C2 |= (bytes2[index++] & 0xFF) << 16;
        this.C2 |= bytes2[index++] << 24;
        this.C3 = bytes2[index++] & 0xFF;
        this.C3 |= (bytes2[index++] & 0xFF) << 8;
        this.C3 |= (bytes2[index++] & 0xFF) << 16;
        this.C3 |= bytes2[index++] << 24;
    }

    private final void stateOut(byte[] bytes2, int off) {
        int index = off;
        bytes2[index++] = (byte)this.C0;
        bytes2[index++] = (byte)(this.C0 >> 8);
        bytes2[index++] = (byte)(this.C0 >> 16);
        bytes2[index++] = (byte)(this.C0 >> 24);
        bytes2[index++] = (byte)this.C1;
        bytes2[index++] = (byte)(this.C1 >> 8);
        bytes2[index++] = (byte)(this.C1 >> 16);
        bytes2[index++] = (byte)(this.C1 >> 24);
        bytes2[index++] = (byte)this.C2;
        bytes2[index++] = (byte)(this.C2 >> 8);
        bytes2[index++] = (byte)(this.C2 >> 16);
        bytes2[index++] = (byte)(this.C2 >> 24);
        bytes2[index++] = (byte)this.C3;
        bytes2[index++] = (byte)(this.C3 >> 8);
        bytes2[index++] = (byte)(this.C3 >> 16);
        bytes2[index++] = (byte)(this.C3 >> 24);
    }
