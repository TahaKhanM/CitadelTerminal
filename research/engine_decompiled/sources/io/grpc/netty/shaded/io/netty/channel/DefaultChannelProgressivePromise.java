...
ChannelFlushPromiseNotifier.FlushCheckpoint {
    ...
    @Override
    public ChannelProgressivePromise setSuccess(Void result2) {
    ...
    @Override
    public ChannelProgressivePromise setProgress(long progress, long total2) {
        super.setProgress(progress, total2);
        return this;
    }
