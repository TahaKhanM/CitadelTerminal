        ...
        block16: while (true) {
            switch (this.state) {
                ...
                case READ_DATA_FRAME: {
                    ...
                    boolean last2 = this.length == 0 && SpdyFrameDecoder.hasFlag(this.flags, (byte)1);
                    this.delegate.readDataFrame(this.streamId, last2, data);
                    continue block16;
                }
                case READ_SYN_STREAM_FRAME: {
                    ...
                    boolean last2 = SpdyFrameDecoder.hasFlag(this.flags, (byte)1);
                ...
                case READ_SYN_REPLY_FRAME: {
                    ...
                    this.state = State.READ_HEADER_BLOCK;
                    this.delegate.readSynReplyFrame(this.streamId, last2);
                    continue block16;
                }
                ...
                case READ_SETTINGS_FRAME: {
                    ...
                    boolean clear2 = SpdyFrameDecoder.hasFlag(this.flags, (byte)1);
                    ...
                    this.delegate.readSettingsFrame(clear2);
                    continue block16;
                }
                case READ_SETTING: {
                ...
                case READ_HEADERS_FRAME: {
                    ...
                    this.state = State.READ_HEADER_BLOCK;
                    this.delegate.readHeadersFrame(this.streamId, last2);
                    continue block16;
                }
