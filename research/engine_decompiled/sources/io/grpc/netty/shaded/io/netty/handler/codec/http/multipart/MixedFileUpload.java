...
implements FileUpload {
    ...
    public MixedFileUpload(String name, String filename, String contentType, String contentTransferEncoding, Charset charset, long size2, long limitSize) {
        this.limitSize = limitSize;
        this.fileUpload = size2 > this.limitSize ? new DiskFileUpload(name, filename, contentType, contentTransferEncoding, charset, size2) : new MemoryFileUpload(name, filename, contentType, contentTransferEncoding, charset, size2);
    ...
    public void addContent(ByteBuf buffer, boolean last2) throws IOException {
        ...
        this.fileUpload.addContent(buffer, last2);
    }
