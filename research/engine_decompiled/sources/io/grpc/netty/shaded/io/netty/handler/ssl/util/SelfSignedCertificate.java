...
public final class SelfSignedCertificate {
    ...
    public SelfSignedCertificate(String fqdn, SecureRandom random, int bits2) throws CertificateException {
        this(fqdn, random, bits2, DEFAULT_NOT_BEFORE, DEFAULT_NOT_AFTER);
    }

    public SelfSignedCertificate(String fqdn, SecureRandom random, int bits2, Date notBefore, Date notAfter) throws CertificateException {
        String[] paths;
        KeyPair keypair;
        try {
            KeyPairGenerator keyGen = KeyPairGenerator.getInstance("RSA");
            keyGen.initialize(bits2, random);
