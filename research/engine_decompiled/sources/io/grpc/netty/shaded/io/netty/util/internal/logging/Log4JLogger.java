...
import io.grpc.netty.shaded.io.netty.util.internal.logging.FormattingTuple;
...
extends AbstractInternalLogger {
    ...
    public void trace(String format2, Object arg) {
        if (this.isTraceEnabled()) {
            FormattingTuple ft = MessageFormatter.format(format2, arg);
    ...
    public void trace(String format2, Object argA, Object argB) {
        if (this.isTraceEnabled()) {
            FormattingTuple ft = MessageFormatter.format(format2, argA, argB);
            this.logger.log(FQCN, (Priority)(this.traceCapable ? Level.TRACE : Level.DEBUG), (Object)ft.getMessage(), ft.getThrowable());
        }
    }
    ...
    public void trace(String format2, Object ... arguments) {
        if (this.isTraceEnabled()) {
            FormattingTuple ft = MessageFormatter.arrayFormat(format2, arguments);
            this.logger.log(FQCN, (Priority)(this.traceCapable ? Level.TRACE : Level.DEBUG), (Object)ft.getMessage(), ft.getThrowable());
        }
    }
    ...
    public void info(String format2, Object ... argArray) {
        if (this.logger.isInfoEnabled()) {
            FormattingTuple ft = MessageFormatter.arrayFormat(format2, argArray);
            this.logger.log(FQCN, (Priority)Level.INFO, (Object)ft.getMessage(), ft.getThrowable());
        }
    }
