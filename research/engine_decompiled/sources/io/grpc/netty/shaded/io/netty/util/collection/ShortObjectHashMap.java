...
implements ShortObjectMap<V> {
    ...
    implements Map.Entry<Short, V> {
        ...
        public V setValue(V value) {
            ...
            ((ShortObjectHashMap)ShortObjectHashMap.this).values[this.entryIndex] = ShortObjectHashMap.toInternal(value);
            return prevValue;
        }
    ...
    extends AbstractSet<Short> {
        ...
        public boolean retainAll(Collection<?> retainedKeys) {
            ...
            Iterator iter2 = ShortObjectHashMap.this.entries().iterator();
            while (iter2.hasNext()) {
                ShortObjectMap.PrimitiveEntry entry = iter2.next();
