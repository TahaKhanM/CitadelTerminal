...
extends ChannelInboundHandlerAdapter {
    ...
    public final void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
        ...
        if (buf != null) {
            ...
            if (readable > 0) {
                ByteBuf bytes2 = buf.readBytes(readable);
                buf.release();
                ctx.fireChannelRead(bytes2);
            } else {
                buf.release();
            }
            this.numReads = 0;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        try {
            ...
            try {
                ...
                ByteToMessageDecoder.fireChannelRead(ctx, out, size2);
                out.recycle();
                throw throwable;
            }
        }
        ...
        int size3 = out.size();
        this.decodeWasNull = !out.insertSinceRecycled();
        ByteToMessageDecoder.fireChannelRead(ctx, out, size3);
        out.recycle();
        return;
    }
