...
extends SingleThreadEventLoop {
    ...
    static {
        ...
        DISABLE_KEYSET_OPTIMIZATION = SystemPropertyUtil.getBoolean("io.grpc.netty.shaded.io.netty.noKeySetOptimization", false);
        ...
        if ((selectorAutoRebuildThreshold = SystemPropertyUtil.getInt("io.grpc.netty.shaded.io.netty.selectorAutoRebuildThreshold", 512)) < 3) {
