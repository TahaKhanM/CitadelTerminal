...
implements ChannelGroup {
    ...
    public boolean add(Channel channel) {
        boolean added;
        ConcurrentMap<ChannelId, Channel> map2 = channel instanceof ServerChannel ? this.serverChannels : this.nonServerChannels;
        boolean bl = added = map2.putIfAbsent(channel.id(), channel) == null;
        if (added) {
