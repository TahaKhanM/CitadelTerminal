...
Comparable<CharSequence> {
    ...
    public AsciiString(byte[] value, int start, int length, boolean copy2) {
        if (copy2) {
    ...
    public AsciiString(ByteBuffer value, int start, int length, boolean copy2) {
    ...
    public boolean regionMatches(int thisStart, CharSequence string2, int start, int length) {
        if (string2 == null) {
            throw new NullPointerException("string");
        }
        if (start < 0 || string2.length() - start < length) {
            return false;
        }
        int thisLen = this.length();
    ...
    public boolean regionMatches(boolean ignoreCase, int thisStart, CharSequence string2, int start, int length) {
        if (!ignoreCase) {
        ...
        if (start < 0 || length > string2.length() - start) {
            return false;
        }
    ...
    private static boolean regionMatchesCharSequences(CharSequence cs, int csStart, CharSequence string2, int start, int length, CharEqualityComparator charEqualityComparator) {
    ...
    public static boolean regionMatches(CharSequence cs, boolean ignoreCase, int csStart, CharSequence string2, int start, int length) {
        if (cs == null || string2 == null) {
            return false;
        }
        if (cs instanceof String && string2 instanceof String) {
            return ((String)cs).regionMatches(ignoreCase, csStart, (String)string2, start, length);
        }
        if (cs instanceof AsciiString) {
            return ((AsciiString)cs).regionMatches(ignoreCase, csStart, string2, start, length);
        }
        return AsciiString.regionMatchesCharSequences(cs, csStart, string2, start, length, ignoreCase ? GeneralCaseInsensitiveCharEqualityComparator.INSTANCE : DefaultCharEqualityComparator.INSTANCE);
    }

    public static boolean regionMatchesAscii(CharSequence cs, boolean ignoreCase, int csStart, CharSequence string2, int start, int length) {
        if (cs == null || string2 == null) {
            return false;
        }
        if (!ignoreCase && cs instanceof String && string2 instanceof String) {
            return ((String)cs).regionMatches(false, csStart, (String)string2, start, length);
        }
        if (cs instanceof AsciiString) {
            return ((AsciiString)cs).regionMatches(ignoreCase, csStart, string2, start, length);
        }
        return AsciiString.regionMatchesCharSequences(cs, csStart, string2, start, length, ignoreCase ? AsciiCaseInsensitiveCharEqualityComparator.INSTANCE : DefaultCharEqualityComparator.INSTANCE);
    }
