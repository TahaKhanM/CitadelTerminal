...
implements ChannelId {
    ...
    static {
        ...
        int processId = -1;
        String customProcessId = SystemPropertyUtil.get("io.grpc.netty.shaded.io.netty.processId");
        ...
        byte[] machineId = null;
        String customMachineId = SystemPropertyUtil.get("io.grpc.netty.shaded.io.netty.machineId");
