...
public final class ByteCollections {
    ...
    public static <V> ByteObjectMap<V> unmodifiableMap(ByteObjectMap<V> map2) {
    ...
    implements ByteObjectMap<V> {
        ...
        UnmodifiableMap(ByteObjectMap<V> map2) {
            this.map = map2;
        }
        ...
        implements Iterator<ByteObjectMap.PrimitiveEntry<V>> {
            ...
            IteratorImpl(Iterator<ByteObjectMap.PrimitiveEntry<V>> iter2) {
                this.iter = iter2;
            }
