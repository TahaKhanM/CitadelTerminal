...
implements ChunkedInput<WebSocketFrame> {
    ...
    public WebSocketChunkedInput(ChunkedInput<ByteBuf> input2) {
        this(input2, 0);
    }

    public WebSocketChunkedInput(ChunkedInput<ByteBuf> input2, int rsv) {
        this.input = ObjectUtil.checkNotNull(input2, "input");
        this.rsv = rsv;
    }
