...
extends MessageToByteEncoder<ByteBuf> {
    ...
    protected void encode(ChannelHandlerContext ctx, ByteBuf in, ByteBuf out) throws Exception {
        ...
        try {
            ...
            ((ByteBufOutputStream)bbOut).writeByte(this.properties);
            ((ByteBufOutputStream)bbOut).writeInt(this.littleEndianDictionarySize);
            ((ByteBufOutputStream)bbOut).writeLong(Long.reverseBytes(length));
