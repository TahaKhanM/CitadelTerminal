...
import io.grpc.netty.shaded.io.netty.channel.socket.oio.DefaultOioServerSocketChannelConfig;
import io.grpc.netty.shaded.io.netty.channel.socket.oio.OioServerSocketChannelConfig;
...
implements ServerSocketChannel {
    ...
    protected int doReadMessages(List<Object> buf) throws Exception {
        ...
        try {
            Socket s2 = this.socket.accept();
            try {
                buf.add(new OioSocketChannel((Channel)this, s2));
                return 1;
            }
            catch (Throwable t) {
