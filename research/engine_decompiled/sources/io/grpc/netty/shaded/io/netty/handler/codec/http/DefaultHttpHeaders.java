...
extends HttpHeaders {
    ...
    protected DefaultHttpHeaders(boolean validate2, DefaultHeaders.NameValidator<CharSequence> nameValidator) {
        this(new DefaultHeadersImpl<CharSequence, CharSequence>(AsciiString.CASE_INSENSITIVE_HASHER, DefaultHttpHeaders.valueConverter(validate2), nameValidator));
    }
    ...
    static ValueConverter<CharSequence> valueConverter(boolean validate2) {
        return validate2 ? HeaderValueConverterAndValidator.INSTANCE : HeaderValueConverter.INSTANCE;
    }
