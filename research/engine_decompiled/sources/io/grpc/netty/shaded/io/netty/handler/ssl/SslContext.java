...
import io.grpc.netty.shaded.io.netty.handler.ssl.JdkSslClientContext;
import io.grpc.netty.shaded.io.netty.handler.ssl.JdkSslServerContext;
import io.grpc.netty.shaded.io.netty.handler.ssl.OpenSsl;
import io.grpc.netty.shaded.io.netty.handler.ssl.OpenSslClientContext;
import io.grpc.netty.shaded.io.netty.handler.ssl.OpenSslServerContext;
import io.grpc.netty.shaded.io.netty.handler.ssl.PemReader;
import io.grpc.netty.shaded.io.netty.handler.ssl.ReferenceCountedOpenSslClientContext;
import io.grpc.netty.shaded.io.netty.handler.ssl.ReferenceCountedOpenSslServerContext;
...
public abstract class SslContext {
    ...
    static KeyManagerFactory buildKeyManagerFactory(X509Certificate[] certChain, PrivateKey key, String keyPassword, KeyManagerFactory kmf) throws UnrecoverableKeyException, KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException {
        return SslContext.buildKeyManagerFactory(certChain, KeyManagerFactory.getDefaultAlgorithm(), key, keyPassword, kmf);
    }
