...
import io.grpc.netty.shaded.io.netty.handler.codec.http.HttpHeadersEncoder;
...
extends MessageToMessageEncoder<Object> {
    ...
    protected void encodeHeaders(HttpHeaders headers, ByteBuf buf) {
        Iterator<Map.Entry<CharSequence, CharSequence>> iter2 = headers.iteratorCharSequence();
        while (iter2.hasNext()) {
            Map.Entry<CharSequence, CharSequence> header = iter2.next();
