...
import io.grpc.netty.shaded.io.netty.channel.DelegatingChannelPromiseNotifier;
...
public abstract class AbstractCoalescingBufferQueue {
    ...
    protected final ByteBuf copyAndCompose(ByteBufAllocator alloc, ByteBuf cumulation, ByteBuf next2) {
        ByteBuf newCumulation = alloc.ioBuffer(cumulation.readableBytes() + next2.readableBytes());
        try {
