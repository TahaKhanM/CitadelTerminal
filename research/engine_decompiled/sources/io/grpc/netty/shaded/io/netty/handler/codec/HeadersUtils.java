...
public final class HeadersUtils {
    ...
    public static <K, V> String toString(Class<?> headersClass, Iterator<Map.Entry<K, V>> headersIt, int size2) {
        String simpleName = headersClass.getSimpleName();
        if (size2 == 0) {
            return simpleName + "[]";
        }
        StringBuilder sb = new StringBuilder(simpleName.length() + 2 + size2 * 20).append(simpleName).append('[');
    ...
    implements Iterator<String> {
        ...
        StringIterator(Iterator<T> iter2) {
            this.iter = iter2;
        }
        ...
        @Override
        public String next() {
            T next2 = this.iter.next();
            return next2 != null ? next2.toString() : null;
        }
    ...
    implements Iterator<Map.Entry<String, String>> {
        ...
        StringEntryIterator(Iterator<Map.Entry<CharSequence, CharSequence>> iter2) {
            this.iter = iter2;
        }
