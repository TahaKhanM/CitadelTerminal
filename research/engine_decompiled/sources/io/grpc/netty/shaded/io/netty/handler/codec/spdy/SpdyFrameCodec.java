...
ChannelOutboundHandler {
    ...
    @Override
    public void readDataFrame(int streamId, boolean last2, ByteBuf data) {
        this.read = true;
        DefaultSpdyDataFrame spdyDataFrame = new DefaultSpdyDataFrame(streamId, data);
        spdyDataFrame.setLast(last2);
        this.ctx.fireChannelRead(spdyDataFrame);
    }

    @Override
    public void readSynStreamFrame(int streamId, int associatedToStreamId, byte priority, boolean last2, boolean unidirectional) {
    ...
    @Override
    public void readHeadersFrame(int streamId, boolean last2) {
        this.spdyHeadersFrame = new DefaultSpdyHeadersFrame(streamId, this.validateHeaders);
        this.spdyHeadersFrame.setLast(last2);
    }
