...
import io.grpc.netty.shaded.io.netty.buffer.ByteBufAllocatorMetric;
...
implements ByteBufAllocatorMetricProvider {
    ...
    extends UnpooledHeapByteBuf {
        ...
        byte[] allocateArray(int initialCapacity) {
            byte[] bytes2 = super.allocateArray(initialCapacity);
            ((UnpooledByteBufAllocator)this.alloc()).incrementHeap(bytes2.length);
            return bytes2;
        }
