...
import io.grpc.netty.shaded.io.netty.channel.DefaultMessageSizeEstimator;
...
implements ChannelConfig {
    ...
    protected Map<ChannelOption<?>, Object> getOptions(Map<ChannelOption<?>, Object> result2, ChannelOption<?> ... options) {
        if (result2 == null) {
            result2 = new IdentityHashMap();
        }
        for (ChannelOption<?> o : options) {
            result2.put(o, this.getOption(o));
        }
        return result2;
    }
