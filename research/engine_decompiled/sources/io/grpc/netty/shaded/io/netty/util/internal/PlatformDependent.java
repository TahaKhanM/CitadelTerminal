...
import io.grpc.netty.shaded.io.netty.util.internal.shaded.org.jctools.queues.atomic.MpscGrowableAtomicArrayQueue;
...
public final class PlatformDependent {
    ...
    public static byte[] allocateUninitializedArray(int size2) {
        return UNINITIALIZED_ARRAY_ALLOCATION_THRESHOLD < 0 || UNINITIALIZED_ARRAY_ALLOCATION_THRESHOLD > size2 ? new byte[size2] : PlatformDependent0.allocateUninitializedArray(size2);
    }
    ...
    public static long allocateMemory(long size2) {
        return PlatformDependent0.allocateMemory(size2);
    }
    ...
    public static <K, V> ConcurrentMap<K, V> newConcurrentHashMap(Map<? extends K, ? extends V> map2) {
    ...
    public static ByteBuffer directBuffer(long memoryAddress, int size2) {
        if (PlatformDependent0.hasDirectBufferNoCleanerConstructor()) {
            return PlatformDependent0.newDirectBuffer(memoryAddress, size2);
        }
    ...
    private static long getLongSafe(byte[] bytes2, int offset) {
        if (BIG_ENDIAN_NATIVE_ORDER) {
            return (long)bytes2[offset] << 56 | ((long)bytes2[offset + 1] & 0xFFL) << 48 | ((long)bytes2[offset + 2] & 0xFFL) << 40 | ((long)bytes2[offset + 3] & 0xFFL) << 32 | ((long)bytes2[offset + 4] & 0xFFL) << 24 | ((long)bytes2[offset + 5] & 0xFFL) << 16 | ((long)bytes2[offset + 6] & 0xFFL) << 8 | (long)bytes2[offset + 7] & 0xFFL;
        }
        return (long)bytes2[offset] & 0xFFL | ((long)bytes2[offset + 1] & 0xFFL) << 8 | ((long)bytes2[offset + 2] & 0xFFL) << 16 | ((long)bytes2[offset + 3] & 0xFFL) << 24 | ((long)bytes2[offset + 4] & 0xFFL) << 32 | ((long)bytes2[offset + 5] & 0xFFL) << 40 | ((long)bytes2[offset + 6] & 0xFFL) << 48 | (long)bytes2[offset + 7] << 56;
    }

    private static int getIntSafe(byte[] bytes2, int offset) {
        if (BIG_ENDIAN_NATIVE_ORDER) {
            return bytes2[offset] << 24 | (bytes2[offset + 1] & 0xFF) << 16 | (bytes2[offset + 2] & 0xFF) << 8 | bytes2[offset + 3] & 0xFF;
        }
        return bytes2[offset] & 0xFF | (bytes2[offset + 1] & 0xFF) << 8 | (bytes2[offset + 2] & 0xFF) << 16 | bytes2[offset + 3] << 24;
    }

    private static short getShortSafe(byte[] bytes2, int offset) {
        if (BIG_ENDIAN_NATIVE_ORDER) {
            return (short)(bytes2[offset] << 8 | bytes2[offset + 1] & 0xFF);
        }
        return (short)(bytes2[offset] & 0xFF | bytes2[offset + 1] << 8);
    }
    ...
    public static void setMemory(byte[] dst, int dstIndex, long bytes2, byte value) {
        PlatformDependent0.setMemory(dst, BYTE_ARRAY_BASE_OFFSET + (long)dstIndex, bytes2, value);
    }

    public static void setMemory(long address, long bytes2, byte value) {
        PlatformDependent0.setMemory(address, bytes2, value);
    }
    ...
    public static boolean isZero(byte[] bytes2, int startPos, int length) {
        return !PlatformDependent.hasUnsafe() || !PlatformDependent0.unalignedAccess() ? PlatformDependent.isZeroSafe(bytes2, startPos, length) : PlatformDependent0.isZero(bytes2, startPos, length);
    }
    ...
    public static int hashCodeAscii(byte[] bytes2, int startPos, int length) {
        return !PlatformDependent.hasUnsafe() || !PlatformDependent0.unalignedAccess() ? PlatformDependent.hashCodeAsciiSafe(bytes2, startPos, length) : PlatformDependent0.hashCodeAscii(bytes2, startPos, length);
    }

    public static int hashCodeAscii(CharSequence bytes2) {
        int hash = -1028477387;
        int remainingBytes = bytes2.length() & 7;
        switch (bytes2.length()) {
            ...
            case 30: 
            case 31: {
                hash = PlatformDependent.hashCodeAsciiCompute(bytes2, bytes2.length() - 24, PlatformDependent.hashCodeAsciiCompute(bytes2, bytes2.length() - 16, PlatformDependent.hashCodeAsciiCompute(bytes2, bytes2.length() - 8, hash)));
                break;
            }
            case 16: 
            case 17: 
            ...
            case 22: 
            case 23: {
                hash = PlatformDependent.hashCodeAsciiCompute(bytes2, bytes2.length() - 16, PlatformDependent.hashCodeAsciiCompute(bytes2, bytes2.length() - 8, hash));
                break;
            }
            case 8: 
            case 9: 
            ...
            case 14: 
            case 15: {
                hash = PlatformDependent.hashCodeAsciiCompute(bytes2, bytes2.length() - 8, hash);
                break;
            }
            case 0: 
            case 1: 
            ...
            default: {
                for (int i = bytes2.length() - 8; i >= remainingBytes; i -= 8) {
                    hash = PlatformDependent.hashCodeAsciiCompute(bytes2, i, hash);
                }
            }
        }
        switch (remainingBytes) {
            case 7: {
                return ((hash * -862048943 + PlatformDependent.hashCodeAsciiSanitizeByte(bytes2.charAt(0))) * 461845907 + PlatformDependent.hashCodeAsciiSanitizeShort(bytes2, 1)) * -862048943 + PlatformDependent.hashCodeAsciiSanitizeInt(bytes2, 3);
            }
            case 6: {
                return (hash * -862048943 + PlatformDependent.hashCodeAsciiSanitizeShort(bytes2, 0)) * 461845907 + PlatformDependent.hashCodeAsciiSanitizeInt(bytes2, 2);
            }
            case 5: {
                return (hash * -862048943 + PlatformDependent.hashCodeAsciiSanitizeByte(bytes2.charAt(0))) * 461845907 + PlatformDependent.hashCodeAsciiSanitizeInt(bytes2, 1);
            }
            case 4: {
                return hash * -862048943 + PlatformDependent.hashCodeAsciiSanitizeInt(bytes2, 0);
            }
            case 3: {
                return (hash * -862048943 + PlatformDependent.hashCodeAsciiSanitizeByte(bytes2.charAt(0))) * 461845907 + PlatformDependent.hashCodeAsciiSanitizeShort(bytes2, 1);
            }
            case 2: {
                return hash * -862048943 + PlatformDependent.hashCodeAsciiSanitizeShort(bytes2, 0);
            }
            case 1: {
                return hash * -862048943 + PlatformDependent.hashCodeAsciiSanitizeByte(bytes2.charAt(0));
            }
        }
        return hash;
    }
    ...
    private static File tmpdir0() {
        File f;
        try {
            f = PlatformDependent.toDirectory(SystemPropertyUtil.get("io.grpc.netty.shaded.io.netty.tmpdir"));
            if (f != null) {
    ...
    private static int bitMode0() {
        int bitMode = SystemPropertyUtil.getInt("io.grpc.netty.shaded.io.netty.bitMode", 0);
        if (bitMode > 0) {
    ...
    private static boolean isZeroSafe(byte[] bytes2, int startPos, int length) {
        int end = startPos + length;
        while (startPos < end) {
            if (bytes2[startPos] != 0) {
                return false;
            }
            ++startPos;
        }
    ...
    static int hashCodeAsciiSafe(byte[] bytes2, int startPos, int length) {
        int hash = -1028477387;
        int remainingBytes = length & 7;
        int end = startPos + remainingBytes;
        for (int i = startPos - 8 + length; i >= end; i -= 8) {
            hash = PlatformDependent0.hashCodeAsciiCompute(PlatformDependent.getLongSafe(bytes2, i), hash);
        }
        switch (remainingBytes) {
            case 7: {
                return ((hash * -862048943 + PlatformDependent0.hashCodeAsciiSanitize(bytes2[startPos])) * 461845907 + PlatformDependent0.hashCodeAsciiSanitize(PlatformDependent.getShortSafe(bytes2, startPos + 1))) * -862048943 + PlatformDependent0.hashCodeAsciiSanitize(PlatformDependent.getIntSafe(bytes2, startPos + 3));
            }
            case 6: {
                return (hash * -862048943 + PlatformDependent0.hashCodeAsciiSanitize(PlatformDependent.getShortSafe(bytes2, startPos))) * 461845907 + PlatformDependent0.hashCodeAsciiSanitize(PlatformDependent.getIntSafe(bytes2, startPos + 2));
            }
            case 5: {
                return (hash * -862048943 + PlatformDependent0.hashCodeAsciiSanitize(bytes2[startPos])) * 461845907 + PlatformDependent0.hashCodeAsciiSanitize(PlatformDependent.getIntSafe(bytes2, startPos + 1));
            }
            case 4: {
                return hash * -862048943 + PlatformDependent0.hashCodeAsciiSanitize(PlatformDependent.getIntSafe(bytes2, startPos));
            }
            case 3: {
                return (hash * -862048943 + PlatformDependent0.hashCodeAsciiSanitize(bytes2[startPos])) * 461845907 + PlatformDependent0.hashCodeAsciiSanitize(PlatformDependent.getShortSafe(bytes2, startPos + 1));
            }
            case 2: {
                return hash * -862048943 + PlatformDependent0.hashCodeAsciiSanitize(PlatformDependent.getShortSafe(bytes2, startPos));
            }
            case 1: {
                return hash * -862048943 + PlatformDependent0.hashCodeAsciiSanitize(bytes2[startPos]);
            }
        }
        return hash;
    }
    ...
    static {
        ...
        DIRECT_BUFFER_PREFERRED = UNSAFE_UNAVAILABILITY_CAUSE == null && !SystemPropertyUtil.getBoolean("io.grpc.netty.shaded.io.netty.noPreferDirect", false);
        ...
        if ((maxDirectMemory = SystemPropertyUtil.getLong("io.grpc.netty.shaded.io.netty.maxDirectMemory", -1L)) == 0L || !PlatformDependent.hasUnsafe() || !PlatformDependent0.hasDirectBufferNoCleanerConstructor()) {
        ...
        int tryAllocateUninitializedArray = SystemPropertyUtil.getInt("io.grpc.netty.shaded.io.netty.uninitializedArrayAllocationThreshold", 1024);
