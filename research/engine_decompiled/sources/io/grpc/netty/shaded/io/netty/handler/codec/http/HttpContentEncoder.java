...
import io.grpc.netty.shaded.io.netty.handler.codec.http.ComposedLastHttpContent;
...
import io.grpc.netty.shaded.io.netty.handler.codec.http.HttpContentDecoder;
    ...
    protected void encode(ChannelHandlerContext ctx, HttpObject msg, List<Object> out) throws Exception {
        ...
        switch (this.state) {
            case AWAIT_HEADERS: {
                ...
                Result result2 = this.beginEncode(res, acceptEncoding.toString());
                if (result2 == null) {
                    if (isFull) {
                        out.add(ReferenceCountUtil.retain(res));
                        break;
                ...
                this.encoder = result2.contentEncoder();
                res.headers().set((CharSequence)HttpHeaderNames.CONTENT_ENCODING, (Object)result2.targetContentEncoding());
                if (isFull) {
