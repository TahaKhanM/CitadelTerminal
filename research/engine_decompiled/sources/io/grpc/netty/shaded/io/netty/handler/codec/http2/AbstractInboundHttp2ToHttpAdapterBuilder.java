...
public abstract class AbstractInboundHttp2ToHttpAdapterBuilder<T extends InboundHttp2ToHttpAdapter, B extends AbstractInboundHttp2ToHttpAdapterBuilder<T, B>> {
    ...
    protected B validateHttpHeaders(boolean validate2) {
        this.validateHttpHeaders = validate2;
        return this.self();
    }
    ...
    protected B propagateSettings(boolean propagate2) {
        this.propagateSettings = propagate2;
        return this.self();
    }
