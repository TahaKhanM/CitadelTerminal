...
public final class IntCollections {
    ...
    public static <V> IntObjectMap<V> unmodifiableMap(IntObjectMap<V> map2) {
    ...
    implements IntObjectMap<V> {
        ...
        UnmodifiableMap(IntObjectMap<V> map2) {
            this.map = map2;
        }
        ...
        implements Iterator<IntObjectMap.PrimitiveEntry<V>> {
            ...
            IteratorImpl(Iterator<IntObjectMap.PrimitiveEntry<V>> iter2) {
                this.iter = iter2;
            }
