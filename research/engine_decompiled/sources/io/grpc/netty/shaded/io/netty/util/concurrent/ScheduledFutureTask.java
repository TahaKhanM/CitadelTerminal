...
PriorityQueueNode {
    ...
    ScheduledFutureTask(AbstractScheduledEventExecutor executor, Runnable runnable, V result2, long nanoTime) {
        this(executor, ScheduledFutureTask.toCallable(runnable, result2), nanoTime);
    }
