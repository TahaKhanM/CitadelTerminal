...
import io.grpc.netty.shaded.io.netty.util.internal.shaded.org.jctools.queues.atomic.MpscAtomicArrayQueueL3Pad;
...
extends MpscAtomicArrayQueueL3Pad<E> {
    ...
    public int fill(MessagePassingQueue.Supplier<E> s2, int limit) {
        ...
        for (int i = 0; i < actualLimit; ++i) {
            ...
            MpscAtomicArrayQueue.soElement(buffer, offset, s2.get());
        }
        return actualLimit;
    }
