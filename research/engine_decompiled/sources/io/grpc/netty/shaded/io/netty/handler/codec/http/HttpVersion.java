...
implements Comparable<HttpVersion> {
    ...
    private HttpVersion(String protocolName, int majorVersion, int minorVersion, boolean keepAliveDefault, boolean bytes2) {
        ...
        this.keepAliveDefault = keepAliveDefault;
        this.bytes = (byte[])(bytes2 ? this.text.getBytes(CharsetUtil.US_ASCII) : null);
    }
