...
public final class ShortCollections {
    ...
    public static <V> ShortObjectMap<V> unmodifiableMap(ShortObjectMap<V> map2) {
        return new UnmodifiableMap<V>(map2);
    }
    ...
    implements ShortObjectMap<V> {
        ...
        UnmodifiableMap(ShortObjectMap<V> map2) {
            this.map = map2;
        }
        ...
        implements Iterator<ShortObjectMap.PrimitiveEntry<V>> {
            ...
            IteratorImpl(Iterator<ShortObjectMap.PrimitiveEntry<V>> iter2) {
                this.iter = iter2;
            }
