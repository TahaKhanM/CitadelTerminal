...
ChannelFutureListener {
    ...
    public void operationComplete(ChannelFuture future) throws Exception {
        ...
        if (future.isSuccess()) {
            Void result2 = (Void)future.get();
            PromiseNotificationUtil.trySuccess(this.delegate, result2, internalLogger);
    ...
    public ChannelPromise setSuccess(Void result2) {
        this.delegate.setSuccess(result2);
        return this;
    }
    ...
    public boolean trySuccess(Void result2) {
        return this.delegate.trySuccess(result2);
    }
