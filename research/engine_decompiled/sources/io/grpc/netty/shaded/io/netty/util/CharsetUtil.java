...
public final class CharsetUtil {
    ...
    public static CharsetEncoder encoder(Charset charset) {
        ObjectUtil.checkNotNull(charset, "charset");
        Map<Charset, CharsetEncoder> map2 = InternalThreadLocalMap.get().charsetEncoderCache();
        CharsetEncoder e = map2.get(charset);
        if (e != null) {
    ...
    public static CharsetDecoder decoder(Charset charset) {
        ObjectUtil.checkNotNull(charset, "charset");
        Map<Charset, CharsetDecoder> map2 = InternalThreadLocalMap.get().charsetDecoderCache();
        CharsetDecoder d = map2.get(charset);
        if (d != null) {
