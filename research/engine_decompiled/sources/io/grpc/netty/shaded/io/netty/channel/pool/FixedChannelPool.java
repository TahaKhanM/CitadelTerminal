...
import io.grpc.netty.shaded.io.netty.channel.pool.ChannelHealthChecker;
import io.grpc.netty.shaded.io.netty.channel.pool.ChannelPoolHandler;
import io.grpc.netty.shaded.io.netty.channel.pool.SimpleChannelPool;
...
extends SimpleChannelPool {
    ...
    static final IllegalStateException POOL_CLOSED_ON_RELEASE_EXCEPTION = ThrowableUtil.unknownStackTrace(new IllegalStateException("FixedChannelPool was closed"), FixedChannelPool.class, "release(...)");
    static final IllegalStateException POOL_CLOSED_ON_ACQUIRE_EXCEPTION = ThrowableUtil.unknownStackTrace(new IllegalStateException("FixedChannelPool was closed"), FixedChannelPool.class, "acquire0(...)");
