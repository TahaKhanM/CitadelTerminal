...
import io.grpc.netty.shaded.io.netty.handler.codec.spdy.DefaultSpdyHeaders;
import io.grpc.netty.shaded.io.netty.handler.codec.spdy.DefaultSpdyStreamFrame;
...
implements SpdyHeadersFrame {
    ...
    public DefaultSpdyHeadersFrame(int streamId, boolean validate2) {
        super(streamId);
        this.headers = new DefaultSpdyHeaders(validate2);
    }
    ...
    @Override
    public SpdyHeadersFrame setLast(boolean last2) {
        super.setLast(last2);
        return this;
    }
