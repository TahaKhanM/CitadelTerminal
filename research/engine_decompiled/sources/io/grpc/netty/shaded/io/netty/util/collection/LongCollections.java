...
public final class LongCollections {
    ...
    public static <V> LongObjectMap<V> unmodifiableMap(LongObjectMap<V> map2) {
    ...
    implements LongObjectMap<V> {
        ...
        UnmodifiableMap(LongObjectMap<V> map2) {
            this.map = map2;
        }
        ...
        implements Iterator<LongObjectMap.PrimitiveEntry<V>> {
            ...
            IteratorImpl(Iterator<LongObjectMap.PrimitiveEntry<V>> iter2) {
                this.iter = iter2;
            }
