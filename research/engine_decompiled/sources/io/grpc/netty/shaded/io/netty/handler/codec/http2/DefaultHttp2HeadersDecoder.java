...
Http2HeadersDecoder.Configuration {
    ...
    public void maxHeaderTableSize(long max2) throws Http2Exception {
        this.hpackDecoder.setMaxHeaderTableSize(max2);
    }
    ...
    @Override
    public void maxHeaderListSize(long max2, long goAwayMax) throws Http2Exception {
        this.hpackDecoder.setMaxHeaderListSize(max2, goAwayMax);
    }
