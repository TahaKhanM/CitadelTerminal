...
public final class Http2CodecUtil {
    ...
    public static void verifyPadding(int padding2) {
        if (padding2 < 0 || padding2 > 256) {
            throw new IllegalArgumentException(String.format("Invalid padding '%d'. Padding must be between 0 and %d (inclusive).", padding2, 256));
        }
    }
