...
extends DefaultHttpHeaders {
    public CombinedHttpHeaders(boolean validate2) {
        super(new CombinedHttpHeadersImpl(AsciiString.CASE_INSENSITIVE_HASHER, CombinedHttpHeaders.valueConverter(validate2), CombinedHttpHeaders.nameValidator(validate2)));
    }
