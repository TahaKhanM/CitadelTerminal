...
implements CharObjectMap<V> {
    ...
    implements Map.Entry<Character, V> {
        ...
        public V setValue(V value) {
            ...
            ((CharObjectHashMap)CharObjectHashMap.this).values[this.entryIndex] = CharObjectHashMap.toInternal(value);
            return prevValue;
        }
    ...
    extends AbstractSet<Character> {
        ...
        public boolean retainAll(Collection<?> retainedKeys) {
            ...
            Iterator iter2 = CharObjectHashMap.this.entries().iterator();
            while (iter2.hasNext()) {
                CharObjectMap.PrimitiveEntry entry = iter2.next();
