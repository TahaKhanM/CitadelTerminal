...
deterministic **action phase** resolves all combat. You win by dropping the opponent's 40 HP to 0 or by holding more HP at turn 100. The "Citadel" ruleset differs from base Terminal in ways that
...
| `.agents/skills/` | **13 custom Claude Code skills** I built for the workflow (`/run-match`, `/bestof`, `/tournament`, `/analyze-replay`, …) |
